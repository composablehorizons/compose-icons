...
val MaterialSymbols.Rounded.Layers_clear: ImageVector
    get() {
        ...
        _Layers_clear = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-12f, 9f, -27f, 8f)
                reflectiveQuadToRelative(-26f, -12f)
                quadToRelative(-13f, -13f, -11.5f, -30.5f)
                reflectiveQuadTo(623f, 427f)
                lineToRelative(87f, -67f)
                ...
                reflectiveQuadToRelative(-26f, -12f)
                quadToRelative(-13f, -13f, -11.5f, -30.5f)
                reflectiveQuadTo(365f, 169f)
                lineToRelative(66f, -51f)
