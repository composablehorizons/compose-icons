...
val MaterialSymbols.Rounded.Android_cell_5_bar_plus: ImageVector
    get() {
        ...
        _Android_cell_5_bar_plus = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(440f, -268f)
                quadToRelative(-25f, -20f, -55.5f, -31f)
                reflectiveQuadTo(800f, 490f)
                ...
                quadToRelative(-51f, 20f, -83.5f, 63.5f)
                reflectiveQuadTo(610f, 667f)
                close()
            }
        }.build()
