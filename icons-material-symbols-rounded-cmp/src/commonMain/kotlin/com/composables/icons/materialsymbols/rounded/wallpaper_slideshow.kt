...
val MaterialSymbols.Rounded.Wallpaper_slideshow: ImageVector
    get() {
        ...
        _Wallpaper_slideshow = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(0f, 17f, -11.5f, 28.5f)
                reflectiveQuadTo(280f, 375f)
                quadToRelative(-17f, 0f, -28.5f, -11.5f)
                reflectiveQuadTo(240f, 335f)
                verticalLineToRelative(-175f)
                close()
                ...
                verticalLineToRelative(-145f)
                quadToRelative(0f, -17f, 11.5f, -28.5f)
                reflectiveQuadTo(840f, 455f)
                quadToRelative(17f, 0f, 28.5f, 11.5f)
                reflectiveQuadTo(880f, 495f)
                verticalLineToRelative(145f)
                quadToRelative(0f, 33f, -23.5f, 56.5f)
