...
val MaterialSymbols.Rounded.Wifi_notification: ImageVector
    get() {
        ...
        _Wifi_notification = ImageVector.Builder(
            ...
            path(
                ...
                verticalLineToRelative(28f)
                quadToRelative(15f, 7f, 19.5f, 20.5f)
                reflectiveQuadTo(559f, 215f)
                quadToRelative(-5f, 13f, -17.5f, 22f)
                reflectiveQuadToRelative(-31.5f, 5f)
                quadToRelative(-9f, -1f, -15.5f, -1.5f)
