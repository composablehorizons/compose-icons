...
val MaterialSymbols.Rounded.Snowmobile: ImageVector
    get() {
        ...
        _Snowmobile = ImageVector.Builder(
            ...
            path(
                ...
                lineTo(80f, 720f)
                close()
                moveToRelative(332f, -160f)
                horizontalLineToRelative(331f)
                quadToRelative(27f, 0f, 42f, -6.5f)
                reflectiveQuadToRelative(15f, -23.5f)
                lineTo(621f, 364f)
                lineTo(463f, 483f)
                lineToRelative(-337f, -37f)
                lineToRelative(-12f, 24f)
                lineToRelative(298f, 90f)
                close()
                moveToRelative(45f, -98f)
                close()
                moveToRelative(493f, 258f)
