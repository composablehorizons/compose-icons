...
val MaterialSymbols.Rounded.Mic_double: ImageVector
    get() {
        ...
        _Mic_double = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(-340f, 78f)
                quadToRelative(-43f, -8f, -71.5f, -41f)
                ...
                quadToRelative(0f, 20f, 5f, 40f)
                reflectiveQuadToRelative(12f, 40f)
                close()
