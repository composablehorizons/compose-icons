...
val MaterialSymbols.Rounded.Sentiment_calm: ImageVector
    get() {
        ...
        _Sentiment_calm = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(340f, 480f)
                quadToRelative(32f, 0f, 57.5f, -20f)
                reflectiveQuadToRelative(39.5f, -49f)
                ...
                quadToRelative(-13f, 3f, -17.5f, 15.5f)
                reflectiveQuadTo(244f, 411f)
                quadToRelative(12f, 30f, 38f, 49.5f)
                reflectiveQuadToRelative(58f, 19.5f)
                close()
