...
val MaterialSymbols.Rounded.Brightness_3: ImageVector
    get() {
        ...
        _Brightness_3 = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(507f, 764f)
                quadToRelative(80f, -42f, 126.5f, -117.5f)
                reflectiveQuadTo(680f, 483f)
                quadToRelative(0f, -92f, -46.5f, -168.5f)
                reflectiveQuadTo(507f, 196f)
                quadToRelative(45f, 62f, 69f, 135f)
                reflectiveQuadToRelative(24f, 152f)
                quadToRelative(0f, 75f, -24f, 147f)
                reflectiveQuadToRelative(-69f, 134f)
                close()
                moveToRelative(123f, -581f)
