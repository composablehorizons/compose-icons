...
val MaterialSymbols.Rounded.Snowshoeing: ImageVector
    get() {
        ...
        _Snowshoeing = ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(-77f, -99f)
                quadToRelative(-8f, -10f, -6.5f, -22f)
                reflectiveQuadToRelative(11.5f, -20f)
                quadToRelative(10f, -8f, 22.5f, -6.5f)
                reflectiveQuadTo(226f, 726f)
                lineToRelative(27f, 35f)
                ...
                quadToRelative(22f, 33f, 55f, 58.5f)
                reflectiveQuadToRelative(77f, 34.5f)
                quadToRelative(17f, 4f, 28.5f, 15.5f)
                reflectiveQuadTo(800f, 480f)
                quadToRelative(0f, 17f, -11.5f, 28f)
                reflectiveQuadToRelative(-27.5f, 9f)
                quadToRelative(-54f, -8f, -101f, -34f)
                reflectiveQuadToRelative(-80f, -64f)
                ...
                reflectiveQuadTo(510f, 860f)
                horizontalLineToRelative(50f)
                verticalLineToRelative(-181f)
                lineToRelative(-84f, -80f)
                lineToRelative(-32f, 115f)
                quadToRelative(-2f, 7f, -6f, 12.5f)
                reflectiveQuadToRelative(-10f, 9.5f)
                lineToRelative(-125f, 89f)
