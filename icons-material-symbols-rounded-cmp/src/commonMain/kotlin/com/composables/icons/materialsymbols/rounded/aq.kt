...
val MaterialSymbols.Rounded.Aq: ImageVector
    get() {
        ...
        _Aq = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(6f, 9f, 3.5f, 19f)
                reflectiveQuadTo(784f, 691f)
                quadToRelative(-9f, 6f, -19f, 4f)
                reflectiveQuadToRelative(-16f, -11f)
                lineToRelative(-12f, -17f)
                ...
                lineToRelative(-28f, -41f)
                quadToRelative(-6f, -9f, -3.5f, -19f)
                reflectiveQuadToRelative(11.5f, -16f)
                quadToRelative(9f, -6f, 19f, -4f)
                reflectiveQuadToRelative(16f, 11f)
