...
val MaterialSymbols.Rounded.Speed_1_7x: ImageVector
    get() {
        ...
        _Speed_1_7x = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(690f, 297f)
                lineToRelative(70f, 116f)
                lineToRelative(70f, -116f)
                quadToRelative(5f, -8f, 12.5f, -12.5f)
                reflectiveQuadTo(859f, 280f)
                quadToRelative(20f, 0f, 30.5f, 17.5f)
                reflectiveQuadTo(889f, 332f)
                lineToRelative(-89f, 148f)
                lineToRelative(89f, 148f)
                quadToRelative(11f, 17f, 0.5f, 34.5f)
                reflectiveQuadTo(859f, 680f)
                quadToRelative(-9f, 0f, -16.5f, -4.5f)
                reflectiveQuadTo(830f, 663f)
                lineToRelative(-70f, -116f)
                close()
                moveTo(450f, 680f)
