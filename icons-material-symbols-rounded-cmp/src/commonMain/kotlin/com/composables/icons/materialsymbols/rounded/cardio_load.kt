...
val MaterialSymbols.Rounded.Cardio_load: ImageVector
    get() {
        ...
        _Cardio_load = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(171f, 400f)
                horizontalLineToRelative(618f)
                quadToRelative(6f, -16f, 9f, -31f)
                reflectiveQuadToRelative(3f, -30f)
                quadToRelative(0f, -60f, -41.5f, -99.5f)
                reflectiveQuadTo(661f, 200f)
                quadToRelative(-42f, 0f, -78f, 22f)
                reflectiveQuadToRelative(-65f, 59f)
                quadToRelative(-7f, 9f, -17f, 14f)
                reflectiveQuadToRelative(-21f, 5f)
                quadToRelative(-11f, 0f, -21f, -5f)
                reflectiveQuadToRelative(-17f, -14f)
                quadToRelative(-29f, -37f, -65f, -59f)
                reflectiveQuadToRelative(-78f, -22f)
                quadToRelative(-57f, 0f, -98.5f, 39.5f)
                reflectiveQuadTo(159f, 339f)
                quadToRelative(0f, 15f, 3f, 30f)
                reflectiveQuadToRelative(9f, 31f)
                close()
                moveToRelative(102f, 140f)
