...
val MaterialSymbols.Rounded.Directions_boat: ImageVector
    get() {
        ...
        _Directions_boat = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(30f, 0f, 56f, -16.5f)
                reflectiveQuadToRelative(46f, -38.5f)
                quadToRelative(24f, -26f, 59f, -25.5f)
                reflectiveQuadToRelative(58f, 26.5f)
                ...
                quadToRelative(13f, -8f, 24f, -17f)
                reflectiveQuadToRelative(22f, -20f)
                quadToRelative(25f, -26f, 60.5f, -26.5f)
                reflectiveQuadTo(380f, 626f)
                quadToRelative(14f, 15f, 30f, 28.5f)
                reflectiveQuadToRelative(36f, 20.5f)
                quadToRelative(8f, 3f, 16.5f, 4f)
                reflectiveQuadToRelative(17.5f, 1f)
                close()
                moveToRelative(-1f, -138f)
                close()
            }
        }.build()
