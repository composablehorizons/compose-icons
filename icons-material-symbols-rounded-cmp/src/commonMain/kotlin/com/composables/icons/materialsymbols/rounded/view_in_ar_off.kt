...
val MaterialSymbols.Rounded.View_in_ar_off: ImageVector
    get() {
        ...
        _View_in_ar_off = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(392f, -442f)
                close()
                moveToRelative(-72f, 42f)
                close()
                moveToRelative(269f, 155f)
                lineTo(348f, 234f)
                ...
                reflectiveQuadToRelative(-40f, -11f)
                close()
                moveToRelative(83f, -370f)
                close()
                moveToRelative(-83f, 94f)
                close()
                moveToRelative(141f, -36f)
                close()
                moveToRelative(-61f, 53f)
                close()
                moveTo(406f, 292f)
                lineToRelative(117f, 117f)
                lineToRelative(115f, -68f)
                lineToRelative(-158f, -91f)
                lineToRelative(-74f, 42f)
                close()
                moveToRelative(34f, 395f)
