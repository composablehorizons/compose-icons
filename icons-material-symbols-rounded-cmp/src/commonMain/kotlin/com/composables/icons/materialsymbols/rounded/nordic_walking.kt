...
val MaterialSymbols.Rounded.Nordic_walking: ImageVector
    get() {
        ...
        _Nordic_walking = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(168f, 884f)
                lineToRelative(67f, -301f)
                quadToRelative(2f, -11f, 10f, -17f)
                reflectiveQuadToRelative(19f, -6f)
                quadToRelative(14f, 0f, 23f, 11f)
                reflectiveQuadToRelative(6f, 25f)
                lineTo(226f, 897f)
                quadToRelative(-2f, 11f, -10f, 17f)
                reflectiveQuadToRelative(-19f, 6f)
                quadToRelative(-14f, 0f, -23f, -11f)
