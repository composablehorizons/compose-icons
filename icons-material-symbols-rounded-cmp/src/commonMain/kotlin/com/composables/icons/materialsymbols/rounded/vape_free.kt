...
val MaterialSymbols.Rounded.Vape_free: ImageVector
    get() {
        ...
        _Vape_free = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadToRelative(-14f, -6f)
                close()
                moveToRelative(160f, -482f)
                quadToRelative(13f, 0f, 21.5f, 8.5f)
                reflectiveQuadTo(610f, 228f)
                quadToRelative(0f, 13f, -8.5f, 21.5f)
                reflectiveQuadTo(580f, 258f)
