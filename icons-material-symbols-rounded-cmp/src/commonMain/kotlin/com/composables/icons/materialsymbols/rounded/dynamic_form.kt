...
val MaterialSymbols.Rounded.Dynamic_form: ImageVector
    get() {
        ...
        _Dynamic_form = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(22f, 0f, 33f, 18.5f)
                reflectiveQuadToRelative(3f, 38.5f)
                lineTo(718f, 786f)
                quadToRelative(-3f, 8f, -9f, 11f)
                reflectiveQuadToRelative(-13f, 1f)
                quadToRelative(-7f, -2f, -11.5f, -7f)
