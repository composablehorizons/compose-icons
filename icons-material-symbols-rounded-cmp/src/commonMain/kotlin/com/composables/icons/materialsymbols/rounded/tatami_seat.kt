...
val MaterialSymbols.Rounded.Tatami_seat: ImageVector
    get() {
        ...
        _Tatami_seat = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(33f, -2f, 55f, -27.5f)
                reflectiveQuadToRelative(20f, -58.5f)
                lineToRelative(-9f, -119f)
                quadToRelative(-2f, -33f, -27f, -55f)
                reflectiveQuadToRelative(-58f, -20f)
                lineToRelative(19f, 280f)
                close()
                moveToRelative(316f, 280f)
                close()
                moveTo(215f, 338f)
                close()
            }
