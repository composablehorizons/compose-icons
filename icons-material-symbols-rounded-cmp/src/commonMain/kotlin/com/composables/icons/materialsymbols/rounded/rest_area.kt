...
val MaterialSymbols.Rounded.Rest_area: ImageVector
    get() {
        ...
        _Rest_area = ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(97f, -82f)
                quadToRelative(23f, -20f, 53f, -19f)
                reflectiveQuadToRelative(53f, 21f)
                lineToRelative(76f, 70f)
                lineToRelative(107f, -107f)
                quadToRelative(22f, -22f, 53f, -23.5f)
                reflectiveQuadToRelative(55f, 18.5f)
                lineToRelative(146f, 122f)
                verticalLineToRelative(-234f)
