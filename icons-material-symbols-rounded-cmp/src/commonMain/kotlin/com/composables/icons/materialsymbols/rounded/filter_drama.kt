...
val MaterialSymbols.Rounded.Filter_drama: ImageVector
    get() {
        ...
        _Filter_drama = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(68f, 11f, 117f, 58.5f)
                reflectiveQuadTo(476f, 536f)
                quadToRelative(4f, 17f, -8.5f, 30.5f)
                reflectiveQuadTo(435f, 580f)
                quadToRelative(-14f, 0f, -24.5f, -9.5f)
                reflectiveQuadTo(396f, 546f)
                quadToRelative(-11f, -45f, -49f, -75.5f)
