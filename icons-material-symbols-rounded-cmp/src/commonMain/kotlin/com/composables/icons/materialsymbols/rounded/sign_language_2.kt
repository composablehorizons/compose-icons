...
val MaterialSymbols.Rounded.Sign_language_2: ImageVector
    get() {
        ...
        _Sign_language_2 = ImageVector.Builder(
            ...
            path(
                ...
                horizontalLineTo(647f)
                quadToRelative(-11f, 0f, -20.5f, 5.5f)
                reflectiveQuadTo(612f, 260f)
                lineToRelative(-35f, 61f)
                quadToRelative(45f, 6f, 74f, 40f)
                reflectiveQuadToRelative(29f, 79f)
                quadToRelative(0f, 51f, -37f, 85.5f)
                ...
                quadToRelative(-34f, 0f, -51.5f, -27.5f)
                reflectiveQuadTo(488f, 318f)
                lineToRelative(55f, -98f)
                quadToRelative(16f, -28f, 44f, -44f)
                ...
                reflectiveQuadToRelative(-29f, -79f)
                quadToRelative(0f, -51f, 37f, -85.5f)
                reflectiveQuadToRelative(89f, -34.5f)
                horizontalLineToRelative(14f)
                quadToRelative(17f, 0f, 28.5f, 11.5f)
