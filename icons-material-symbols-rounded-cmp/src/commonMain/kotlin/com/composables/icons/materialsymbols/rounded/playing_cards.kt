...
val MaterialSymbols.Rounded.Playing_cards: ImageVector
    get() {
        ...
        _Playing_cards = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(615f, 565f)
                lineToRelative(31f, -112f)
                quadToRelative(4f, -12f, -0.5f, -24f)
                reflectiveQuadTo(630f, 409f)
                lineToRelative(-95f, -65f)
                quadToRelative(-8f, -6f, -17.5f, -2.5f)
                reflectiveQuadTo(505f, 355f)
                lineToRelative(-31f, 112f)
                quadToRelative(-4f, 12f, 0.5f, 24f)
                reflectiveQuadToRelative(15.5f, 20f)
                lineToRelative(95f, 65f)
                quadToRelative(8f, 6f, 17.5f, 2.5f)
                reflectiveQuadTo(615f, 565f)
                close()
                moveTo(160f, 753f)
