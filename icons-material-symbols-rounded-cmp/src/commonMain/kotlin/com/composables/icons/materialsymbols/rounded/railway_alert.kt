...
val MaterialSymbols.Rounded.Railway_alert: ImageVector
    get() {
        ...
        _Railway_alert = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(441f, 42f)
                quadToRelative(19f, 2f, 27.5f, 15.5f)
                reflectiveQuadTo(475f, 86f)
                quadToRelative(-2f, 15f, -13.5f, 26f)
                reflectiveQuadToRelative(-32.5f, 9f)
                quadToRelative(-8f, -1f, -14.5f, -1f)
                horizontalLineTo(400f)
                quadToRelative(-39f, 0f, -78f, 9.5f)
                reflectiveQuadTo(249f, 160f)
