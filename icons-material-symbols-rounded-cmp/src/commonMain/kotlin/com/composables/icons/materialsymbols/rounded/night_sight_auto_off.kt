...
val MaterialSymbols.Rounded.Night_sight_auto_off: ImageVector
    get() {
        ...
        _Night_sight_auto_off = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(-61f, -258f)
                close()
                moveToRelative(277f, -222f)
