...
val MaterialSymbols.Rounded.Ar_on_you: ImageVector
    get() {
        if (_Ar_on_you != null) return _Ar_on_you!!
        
        _Ar_on_you = ImageVector.Builder(
            name = "ar_on_you",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            ...
            path(
                ...
                quadToRelative(38f, 0f, 70.5f, -18f)
                reflectiveQuadToRelative(52.5f, -49f)
                quadToRelative(6f, -11f, -0.5f, -22f)
                reflectiveQuadTo(583f, 520f)
                horizontalLineTo(377f)
                quadToRelative(-13f, 0f, -19.5f, 11f)
                reflectiveQuadToRelative(-0.5f, 22f)
                quadToRelative(20f, 31f, 52.5f, 49f)
                reflectiveQuadToRelative(70.5f, 18f)
                close()
            }
        }.build()
...
private var _Ar_on_you: ImageVector? = null
