...
val publishArtifactId = "icons-material-symbols-rounded-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesMaterial Symbols rounded"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.materialsymbols.rounded"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Symbols rounded")
        description.set("Compose Icons Material Symbols rounded for Compose Multiplatform.")
        url.set(projectUrl)
