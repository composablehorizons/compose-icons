...
val MaterialSymbols.Sharp.Cannabis: ImageVector
    get() {
        ...
        _Cannabis = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(-56f, -296f)
                quadToRelative(-11f, -38f, -28.5f, -72.5f)
                reflectiveQuadTo(310f, 450f)
                quadToRelative(-28f, -28f, -62.5f, -45.5f)
                reflectiveQuadTo(175f, 376f)
                quadToRelative(11f, 38f, 28.5f, 72.5f)
                reflectiveQuadTo(249f, 511f)
                ...
                close()
                moveToRelative(96f, 36f)
                quadToRelative(38f, -10f, 72.5f, -27.5f)
                reflectiveQuadTo(710f, 511f)
                quadToRelative(28f, -28f, 45.5f, -62.5f)
                reflectiveQuadTo(784f, 376f)
                quadToRelative(-38f, 11f, -72.5f, 28.5f)
                reflectiveQuadTo(649f, 450f)
                quadToRelative(-28f, 27f, -45.5f, 61.5f)
                reflectiveQuadTo(576f, 584f)
                close()
                moveToRelative(124f, 116f)
                quadToRelative(21f, 0f, 41f, -5.5f)
                reflectiveQuadToRelative(39f, -14.5f)
                quadToRelative(-19f, -8f, -39f, -14f)
                reflectiveQuadToRelative(-41f, -6f)
                ...
                moveTo(384f, 584f)
                close()
                moveToRelative(-44f, 96f)
                close()
                moveToRelative(140f, -132f)
                close()
                moveToRelative(96f, 36f)
                close()
                moveToRelative(43f, 96f)
                close()
            }
        }.build()
