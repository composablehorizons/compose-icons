...
val MaterialSymbols.Sharp.Tools_wrench: ImageVector
    get() {
        ...
        _Tools_wrench = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(19.275f, 19.775f)
                lineToRelative(0.7f, -0.7f)
                lineToRelative(-7.95f, -7.975f)
                quadToRelative(0.45f, -0.575f, 0.713f, -1.288f)
                ...
                quadToRelative(1.313f, 1.3f, 3.188f, 1.3f)
                quadToRelative(0.8f, 0f, 1.525f, -0.263f)
                quadToRelative(0.725f, -0.262f, 1.3f, -0.737f)
                close()
                moveToRelative(0.05f, 2.875f)
