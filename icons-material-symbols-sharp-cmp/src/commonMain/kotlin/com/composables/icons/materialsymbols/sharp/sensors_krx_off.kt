...
val MaterialSymbols.Sharp.Sensors_krx_off: ImageVector
    get() {
        ...
        _Sensors_krx_off = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(2f, -10f, 3.5f, -19.5f)
                reflectiveQuadTo(640f, 480f)
                quadToRelative(0f, -66f, -47f, -113f)
                reflectiveQuadToRelative(-113f, -47f)
                quadToRelative(-10f, 0f, -19.5f, 1.5f)
                reflectiveQuadTo(441f, 325f)
                lineToRelative(-62f, -62f)
                ...
                close()
                moveToRelative(-334f, -58f)
                quadToRelative(11f, 0f, 21.5f, -1.5f)
                reflectiveQuadTo(522f, 634f)
                lineTo(326f, 438f)
                quadToRelative(-3f, 10f, -4.5f, 20.5f)
