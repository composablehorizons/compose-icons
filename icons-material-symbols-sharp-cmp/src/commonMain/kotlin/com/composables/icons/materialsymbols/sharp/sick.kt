...
val MaterialSymbols.Sharp.Sick: ImageVector
    get() {
        ...
        _Sick = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(87f, 404f)
                quadToRelative(26f, -140f, 135.5f, -232f)
                reflectiveQuadTo(480f, 80f)
                quadToRelative(74f, 0f, 139.5f, 24f)
                reflectiveQuadTo(737f, 172f)
                quadToRelative(-14f, 26f, -22.5f, 44.5f)
                reflectiveQuadTo(703f, 251f)
                quadToRelative(-44f, -42f, -101f, -66.5f)
                reflectiveQuadTo(480f, 160f)
                quadToRelative(-101f, 0f, -181f, 56.5f)
                reflectiveQuadTo(183f, 361f)
                quadToRelative(-27f, -1f, -52.5f, 10f)
                reflectiveQuadTo(87f, 404f)
                close()
                moveTo(480f, 880f)
                quadToRelative(-148f, 0f, -257.5f, -92f)
                reflectiveQuadTo(87f, 556f)
                quadToRelative(17f, 22f, 42.5f, 33.5f)
                reflectiveQuadTo(183f, 600f)
                quadToRelative(36f, 88f, 116f, 144f)
                reflectiveQuadToRelative(181f, 56f)
                quadToRelative(133f, 0f, 226.5f, -93.5f)
                reflectiveQuadTo(800f, 480f)
                quadToRelative(0f, -17f, -1.5f, -34f)
                reflectiveQuadToRelative(-5.5f, -34f)
                quadToRelative(11f, 4f, 22.5f, 6f)
                reflectiveQuadToRelative(24.5f, 2f)
