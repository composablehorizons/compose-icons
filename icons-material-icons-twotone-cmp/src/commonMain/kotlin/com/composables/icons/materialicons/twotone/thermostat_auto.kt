...
val MaterialIcons.Twotone.Thermostat_auto: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        reflectiveCurveTo(7f, 5.45f, 7f, 6f)
                        verticalLineToRelative(7f)
                        lineToRelative(-0.8f, 0.6f)
                        curveTo(5.45f, 14.16f, 5f, 15.06f, 5f, 16f)
                        horizontalLineToRelative(6f)
                        curveTo(11f, 15.06f, 10.55f, 14.17f, 9.8f, 13.6f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
