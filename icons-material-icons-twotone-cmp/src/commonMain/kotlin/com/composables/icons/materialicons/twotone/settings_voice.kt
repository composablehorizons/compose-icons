...
val MaterialIcons.Twotone.Settings_voice: ImageVector
    get() {
        ...
        _Settings_voice = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(12f, 11f)
                curveToRelative(0.56f, 0f, 0.99f, -0.44f, 0.99f, -1f)
                lineTo(13f, 4f)
            ...
            path(
                ...
                reflectiveCurveToRelative(1f, 0.45f, 1f, 1f)
                verticalLineToRelative(6f)
                curveToRelative(0f, 0.56f, -0.44f, 1f, -1f, 1f)
                ...
                reflectiveCurveTo(6.7f, 13f, 6.7f, 10f)
                horizontalLineTo(5f)
