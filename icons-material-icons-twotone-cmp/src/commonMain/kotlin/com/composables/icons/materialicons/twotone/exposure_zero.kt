...
val MaterialIcons.Twotone.Exposure_zero: ImageVector
    get() {
        ...
        _Exposure_zero = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveCurveTo(12.63f, 5f, 12f, 5f)
                curveToRelative(-0.62f, 0f, -1.19f, 0.1f, -1.69f, 0.29f)
                ...
                curveToRelative(0.63f, 0f, 1.19f, -0.1f, 1.7f, -0.3f)
                curveToRelative(0.51f, -0.2f, 0.94f, -0.51f, 1.3f, -0.95f)
                curveToRelative(0.35f, -0.43f, 0.63f, -1f, 0.83f, -1.7f)
                curveToRelative(0.2f, -0.7f, 0.3f, -1.55f, 0.3f, -2.55f)
                horizontalLineToRelative(0.01f)
                verticalLineToRelative(-2.04f)
                curveToRelative(0f, -1.01f, -0.1f, -1.85f, -0.3f, -2.55f)
                curveToRelative(-0.2f, -0.7f, -0.48f, -1.26f, -0.84f, -1.69f)
                close()
                moveToRelative(-0.97f, 6.58f)
                curveToRelative(0f, 0.63f, -0.04f, 1.17f, -0.13f, 1.62f)
                ...
                curveToRelative(-0.33f, 0f, -0.62f, -0.06f, -0.87f, -0.19f)
                ...
                curveToRelative(0f, -0.64f, 0.04f, -1.18f, 0.13f, -1.62f)
