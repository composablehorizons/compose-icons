...
val MaterialIcons.Twotone.No_accounts: ImageVector
    get() {
        ...
        _No_accounts = ImageVector.Builder(
            ...
            group {
                ...
                path(
                    ...
                    moveTo(7.35f, 18.5f)
                    curveTo(8.66f, 19.44f, 10.26f, 20f, 12f, 20f)
                    reflectiveCurveToRelative(3.34f, -0.56f, 4.65f, -1.5f)
                    curveTo(15.34f, 17.56f, 13.74f, 17f, 12f, 17f)
                    reflectiveCurveTo(8.66f, 17.56f, 7.35f, 18.5f)
                    close()
                    moveTo(15.18f, 10.94f)
                    lineToRelative(-4.62f, -4.62f)
                    curveTo(11f, 6.12f, 11.48f, 6f, 12f, 6f)
