...
val MaterialIcons.Twotone.Bus_alert: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        reflectiveCurveTo(14.33f, 17f, 13.5f, 17f)
                        reflectiveCurveTo(12f, 16.33f, 12f, 15.5f)
                        reflectiveCurveTo(12.67f, 14f, 13.5f, 14f)
                        close()
                        moveTo(6.5f, 14f)
                    ...
                    path(
                        ...
                        curveTo(7.4f, 4.91f, 5.25f, 5.29f, 4.43f, 6f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
