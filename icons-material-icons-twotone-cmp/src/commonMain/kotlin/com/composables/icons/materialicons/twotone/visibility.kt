...
val MaterialIcons.Twotone.Visibility: ImageVector
    get() {
        ...
        _Visibility = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(4.83f, 14.87f, 8.21f, 17f, 12f, 17f)
                reflectiveCurveToRelative(7.17f, -2.13f, 8.82f, -5.5f)
                curveTo(19.17f, 8.13f, 15.79f, 6f, 12f, 6f)
                close()
                moveToRelative(0f, 10f)
                curveToRelative(-2.48f, 0f, -4.5f, -2.02f, -4.5f, -4.5f)
                reflectiveCurveTo(9.52f, 7f, 12f, 7f)
                reflectiveCurveToRelative(4.5f, 2.02f, 4.5f, 4.5f)
                reflectiveCurveTo(14.48f, 16f, 12f, 16f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
