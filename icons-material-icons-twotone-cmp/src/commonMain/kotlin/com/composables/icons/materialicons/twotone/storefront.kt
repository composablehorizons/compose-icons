...
val MaterialIcons.Twotone.Storefront: ImageVector
    get() {
            ...
            group {
                ...
                group {
                    path(
                        ...
                        curveTo(4.43f, 10.71f, 4.73f, 11f, 5.23f, 11f)
                        curveTo(5.84f, 11f, 6.36f, 10.51f, 6.44f, 9.86f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        moveTo(9.71f, 11f)
                        curveTo(10.45f, 11f, 11f, 10.41f, 11f, 9.69f)
                        verticalLineTo(5f)
                        horizontalLineTo(9.04f)
                        lineTo(8.49f, 9.52f)
                        curveToRelative(-0.05f, 0.39f, 0.07f, 0.78f, 0.33f, 1.07f)
                        curveTo(9.05f, 10.85f, 9.37f, 11f, 9.71f, 11f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        moveTo(14.22f, 11f)
                        curveToRelative(0.41f, 0f, 0.72f, -0.15f, 0.96f, -0.41f)
                        curveToRelative(0.25f, -0.29f, 0.37f, -0.68f, 0.33f, -1.07f)
                        lineTo(14.96f, 5f)
                        horizontalLineTo(13f)
                        verticalLineToRelative(4.69f)
                        curveTo(13f, 10.41f, 13.55f, 11f, 14.22f, 11f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                    ...
                    path(
                        ...
                        curveTo(4.73f, 11f, 4.43f, 10.71f, 4.29f, 10.53f)
                        close()
                        moveTo(19f, 19f)
                        horizontalLineTo(5f)
