...
val MaterialIcons.Twotone.Flood: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        moveTo(8.66f, 15.5f)
                        curveToRelative(1.01f, 0f, 1.3f, -0.65f, 2.42f, -0.9f)
                        lineToRelative(-0.91f, -3.39f)
                        lineToRelative(3.86f, -1.04f)
                        lineToRelative(1.42f, 5.31f)
                        curveToRelative(1.03f, -0.07f, 1.3f, -0.85f, 2.85f, -0.96f)
                        lineTo(16.16f, 6.5f)
                        lineToRelative(-5.74f, -2.09f)
                        lineTo(6.5f, 9.09f)
                        lineToRelative(1.7f, 6.36f)
                        curveTo(8.33f, 15.48f, 8.48f, 15.5f, 8.66f, 15.5f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                    ...
                    path(
                        ...
                        curveToRelative(-0.18f, 0f, -0.33f, -0.02f, -0.45f, -0.05f)
                        lineTo(6.5f, 9.09f)
                        lineTo(10.42f, 4.41f)
                        close()
                    }
