...
val MaterialIcons.Twotone.Engineering: ImageVector
    get() {
            ...
            group {
                group {
                    ...
                    path(
                        ...
                        moveTo(7.5f, 6f)
                        curveTo(7.78f, 6f, 8f, 5.78f, 8f, 5.5f)
                        verticalLineTo(4.14f)
                        curveTo(7.64f, 4.23f, 7.31f, 4.37f, 7f, 4.55f)
                        verticalLineTo(5.5f)
                        curveTo(7f, 5.78f, 7.22f, 6f, 7.5f, 6f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        moveTo(10.5f, 6f)
                        curveTo(10.78f, 6f, 11f, 5.78f, 11f, 5.5f)
                        verticalLineTo(4.55f)
                        curveToRelative(-0.31f, -0.18f, -0.64f, -0.32f, -1f, -0.41f)
                        verticalLineTo(5.5f)
                        curveTo(10f, 5.78f, 10.22f, 6f, 10.5f, 6f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        curveTo(14.8f, 18.29f, 11.7f, 17f, 9f, 17f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                    ...
                    path(
                        ...
                        reflectiveCurveTo(17.99f, 13.39f, 17.5f, 13.39f)
                        close()
                    }
                }
            }
