...
val MaterialIcons.Twotone.Directions_bike: ImageVector
    get() {
        ...
        _Directions_bike = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveCurveTo(6.9f, 20.5f, 5f, 20.5f)
                reflectiveCurveTo(1.5f, 18.9f, 1.5f, 17f)
                reflectiveCurveToRelative(1.6f, -3.5f, 3.5f, -3.5f)
                close()
                moveToRelative(2.8f, -2.3f)
                lineTo(11f, 14f)
