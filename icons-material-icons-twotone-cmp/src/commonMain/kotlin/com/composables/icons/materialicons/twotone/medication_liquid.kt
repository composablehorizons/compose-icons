...
val MaterialIcons.Twotone.Medication_liquid: ImageVector
    get() {
            ...
            group {
                group {
                    ...
                    path(
                        ...
                        moveTo(21f, 10f)
                        arcTo(1f, 2f, 0f, false, true, 20f, 12f)
                        arcTo(1f, 2f, 0f, false, true, 19f, 10f)
                        arcTo(1f, 2f, 0f, false, true, 21f, 10f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
