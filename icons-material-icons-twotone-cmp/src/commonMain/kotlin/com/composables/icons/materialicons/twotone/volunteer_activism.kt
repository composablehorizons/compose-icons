...
val MaterialIcons.Twotone.Volunteer_activism: ImageVector
    get() {
            ...
            group {
                group {
                    ...
                    path(
                        ...
                        curveTo(20f, 4.56f, 19.44f, 4f, 18.7f, 4f)
                        curveToRelative(-0.44f, 0f, -0.89f, 0.21f, -1.18f, 0.55f)
                        lineTo(16f, 6.34f)
                        lineToRelative(-1.52f, -1.79f)
                        curveTo(14.19f, 4.21f, 13.74f, 4f, 13.3f, 4f)
                        curveTo(12.56f, 4f, 12f, 4.56f, 12f, 5.3f)
                        curveTo(12f, 6.41f, 14.04f, 8.47f, 16f, 10.29f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        curveTo(19.74f, 18.23f, 19.39f, 18f, 19f, 18f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        curveTo(15.35f, 2.49f, 14.34f, 2f, 13.3f, 2f)
