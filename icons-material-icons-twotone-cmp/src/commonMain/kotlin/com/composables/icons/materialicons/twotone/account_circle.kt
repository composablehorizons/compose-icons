...
val MaterialIcons.Twotone.Account_circle: ImageVector
    get() {
        ...
        _Account_circle = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(19.38f, 15.49f, 20f, 13.82f, 20f, 12f)
                curveToRelative(0f, -4.41f, -3.59f, -8f, -8f, -8f)
                close()
                moveToRelative(0f, 9f)
                curveToRelative(-1.94f, 0f, -3.5f, -1.56f, -3.5f, -3.5f)
                reflectiveCurveTo(10.06f, 6f, 12f, 6f)
                reflectiveCurveToRelative(3.5f, 1.56f, 3.5f, 3.5f)
                reflectiveCurveTo(13.94f, 13f, 12f, 13f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
