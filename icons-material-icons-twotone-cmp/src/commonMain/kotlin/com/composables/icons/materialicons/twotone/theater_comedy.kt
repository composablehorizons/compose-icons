...
val MaterialIcons.Twotone.Theater_comedy: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        curveToRelative(0.69f, 0.55f, 1.55f, 0.9f, 2.5f, 0.9f)
                        ...
                        reflectiveCurveTo(18.45f, 5.5f, 19f, 5.5f)
                        close()
                        moveTo(14f, 6.5f)
                    ...
                    path(
                        ...
                        moveTo(16.99f, 9f)
                        curveToRelative(-1.35f, 0f, -2.44f, 0.8f, -2.49f, 1.81f)
                    ...
                    path(
                        ...
                        horizontalLineTo(3f)
                        verticalLineToRelative(5f)
                        curveTo(3f, 18.21f, 4.79f, 20f, 7f, 20f)
                        close()
                        moveTo(7f, 17.88f)
                        curveToRelative(-1.38f, 0f, -2.5f, -0.84f, -2.5f, -1.88f)
