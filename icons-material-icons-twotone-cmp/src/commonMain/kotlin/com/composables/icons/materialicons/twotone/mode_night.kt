...
val MaterialIcons.Twotone.Mode_night: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        moveTo(9.5f, 4f)
                        curveTo(9.16f, 4f, 8.82f, 4.02f, 8.49f, 4.07f)
                        curveTo(10.4f, 6.23f, 11.5f, 9.05f, 11.5f, 12f)
                        reflectiveCurveToRelative(-1.1f, 5.77f, -3.01f, 7.93f)
                        curveTo(8.82f, 19.98f, 9.16f, 20f, 9.5f, 20f)
                        curveToRelative(4.41f, 0f, 8f, -3.59f, 8f, -8f)
                        reflectiveCurveTo(13.91f, 4f, 9.5f, 4f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        curveToRelative(4.41f, 0f, 8f, 3.59f, 8f, 8f)
                        reflectiveCurveTo(13.91f, 20f, 9.5f, 20f)
                        close()
                    }
                }
            }
