...
val MaterialIcons.Twotone.Thunderstorm: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        curveTo(15.63f, 5.44f, 13.94f, 4f, 12f, 4f)
                        curveToRelative(-1.44f, 0f, -2.77f, 0.78f, -3.48f, 2.04f)
                        lineTo(8.03f, 6.91f)
                        lineTo(7.04f, 7.04f)
                        curveTo(5.31f, 7.27f, 4f, 8.76f, 4f, 10.5f)
                        curveTo(4f, 12.43f, 5.57f, 14f, 7.5f, 14f)
                        horizontalLineToRelative(10f)
                        curveToRelative(1.38f, 0f, 2.5f, -1.12f, 2.5f, -2.5f)
                        curveTo(20f, 10.22f, 19.01f, 9.13f, 17.73f, 9.01f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
