...
val MaterialIcons.Twotone.Attribution: ImageVector
    get() {
        ...
        _Attribution = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveCurveTo(12.83f, 8f, 12f, 8f)
                reflectiveCurveToRelative(-1.5f, -0.67f, -1.5f, -1.5f)
                reflectiveCurveTo(11.17f, 5f, 12f, 5f)
                close()
                moveToRelative(2.75f, 9.5f)
                ...
                curveToRelative(0f, -0.92f, 1.84f, -1.38f, 2.75f, -1.38f)
