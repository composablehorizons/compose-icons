...
val MaterialIcons.Twotone.Do_disturb_off: ImageVector
    get() {
        ...
        _Do_disturb_off = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(12f, 4f)
                curveToRelative(-1.41f, 0f, -2.73f, 0.37f, -3.88f, 1.01f)
                lineToRelative(6f, 5.99f)
                horizontalLineTo(17f)
                verticalLineToRelative(2f)
                horizontalLineToRelative(-0.88f)
                lineTo(19f, 15.88f)
                curveToRelative(0.63f, -1.15f, 1f, -2.47f, 1f, -3.88f)
                curveToRelative(0f, -4.41f, -3.59f, -8f, -8f, -8f)
                close()
                moveToRelative(0f, 16f)
                curveToRelative(1.56f, 0f, 3f, -0.45f, 4.23f, -1.23f)
                lineTo(10.46f, 13f)
                horizontalLineTo(7f)
                verticalLineToRelative(-2f)
