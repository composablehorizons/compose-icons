...
val MaterialIcons.Twotone.Electric_car: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        reflectiveCurveTo(15f, 11.33f, 15f, 10.5f)
                        curveTo(15f, 9.67f, 15.67f, 9f, 16.5f, 9f)
                        close()
                        moveTo(7.5f, 9f)
                        curveTo(8.33f, 9f, 9f, 9.67f, 9f, 10.5f)
                        curveTo(9f, 11.33f, 8.33f, 12f, 7.5f, 12f)
                        reflectiveCurveTo(6f, 11.33f, 6f, 10.5f)
                        curveTo(6f, 9.67f, 6.67f, 9f, 7.5f, 9f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
