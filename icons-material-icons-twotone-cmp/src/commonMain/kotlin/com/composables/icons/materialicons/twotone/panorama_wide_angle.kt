...
val MaterialIcons.Twotone.Panorama_wide_angle: ImageVector
    get() {
        ...
        _Panorama_wide_angle = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(4.24f, 8.42f, 4f, 10.22f, 4f, 12f)
                ...
                curveToRelative(0f, -1.78f, -0.24f, -3.58f, -0.71f, -5.36f)
                curveTo(16.71f, 6.2f, 14.45f, 6f, 12f, 6f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
