...
val MaterialIcons.Twotone.Sentiment_satisfied_alt: ImageVector
    get() {
        if (_Sentiment_satisfied_alt != null) return _Sentiment_satisfied_alt!!
        
        _Sentiment_satisfied_alt = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveCurveToRelative(2.76f, -0.81f, 3.45f, -2f)
                horizontalLineToRelative(1.67f)
        ...
        return _Sentiment_satisfied_alt!!
    }

private var _Sentiment_satisfied_alt: ImageVector? = null
