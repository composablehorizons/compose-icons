...
val MaterialIcons.Twotone.Restore_page: ImageVector
    get() {
        ...
        _Restore_page = ImageVector.Builder(
            ...
            path(
                ...
                horizontalLineTo(6f)
                close()
                moveToRelative(10.72f, 9f)
                curveToRelative(0f, 2.48f, -2.02f, 4.5f, -4.5f, 4.5f)
                curveToRelative(-1.84f, 0f, -3.43f, -1.12f, -4.12f, -2.7f)
                ...
                curveToRelative(-1.21f, 0f, -2.27f, 0.7f, -2.79f, 1.71f)
                lineTo(10.88f, 13f)
                horizontalLineToRelative(-3.6f)
                verticalLineTo(9.4f)
                lineToRelative(1.17f, 1.17f)
                curveToRelative(0.8f, -1.24f, 2.19f, -2.07f, 3.78f, -2.07f)
                curveToRelative(2.48f, 0f, 4.49f, 2.02f, 4.49f, 4.5f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
