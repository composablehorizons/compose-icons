...
val MaterialIcons.Twotone.Nights_stay: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        curveToRelative(0f, 0.68f, -0.19f, 1.31f, -0.48f, 1.87f)
                        curveToRelative(0.48f, 0.09f, 0.97f, 0.14f, 1.48f, 0.14f)
                        curveToRelative(1.48f, 0f, 2.9f, -0.41f, 4.13f, -1.15f)
                        ...
                        curveTo(5.66f, 12f, 7.18f, 12.83f, 8.1f, 14.15f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
