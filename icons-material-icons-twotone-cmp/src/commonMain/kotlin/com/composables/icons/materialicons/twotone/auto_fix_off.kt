...
val MaterialIcons.Twotone.Auto_fix_off: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        moveTo(4.416894f, 18.173737f)
                        lineTo(9.882775f, 12.707853f)
                        lineTo(11.296975f, 14.122053f)
                        lineTo(5.831094f, 19.587936f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
