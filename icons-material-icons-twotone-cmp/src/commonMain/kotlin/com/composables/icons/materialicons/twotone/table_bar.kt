...
val MaterialIcons.Twotone.Table_bar: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        moveTo(19.72f, 7.5f)
                        arcTo(7.72f, 1.5f, 0f, false, true, 12f, 9f)
                        arcTo(7.72f, 1.5f, 0f, false, true, 4.28f, 7.5f)
                        arcTo(7.72f, 1.5f, 0f, false, true, 19.72f, 7.5f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        close()
                        moveTo(12f, 9f)
                        curveTo(7.95f, 9f, 5.26f, 8.14f, 4.28f, 7.5f)
                        curveTo(5.26f, 6.86f, 7.95f, 6f, 12f, 6f)
                        reflectiveCurveToRelative(6.74f, 0.86f, 7.72f, 1.5f)
                        curveTo(18.74f, 8.14f, 16.05f, 9f, 12f, 9f)
                        close()
                    }
                }
            }
