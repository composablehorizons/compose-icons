...
val MaterialIcons.Twotone.Device_unknown: ImageVector
    get() {
        ...
        _Device_unknown = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(12f, 6.72f)
                curveToRelative(1.96f, 0f, 3.5f, 1.51f, 3.5f, 3.47f)
                curveToRelative(0f, 2.26f, -2.62f, 2.49f, -2.62f, 4.45f)
                horizontalLineToRelative(-1.76f)
                curveToRelative(0f, -2.88f, 2.63f, -2.7f, 2.63f, -4.45f)
                curveToRelative(0f, -0.93f, -0.82f, -1.75f, -1.75f, -1.75f)
                reflectiveCurveToRelative(-1.75f, 0.82f, -1.75f, 1.75f)
                horizontalLineTo(8.5f)
                curveToRelative(0f, -1.95f, 1.54f, -3.47f, 3.5f, -3.47f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
