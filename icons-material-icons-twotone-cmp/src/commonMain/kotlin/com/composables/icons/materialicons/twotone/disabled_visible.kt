...
val MaterialIcons.Twotone.Disabled_visible: ImageVector
    get() {
        ...
        _Disabled_visible = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(13.24f, 19.02f, 15.05f, 20f, 17f, 20f)
                reflectiveCurveToRelative(3.76f, -0.98f, 4.75f, -2.5f)
                curveTo(20.76f, 15.98f, 18.95f, 15f, 17f, 15f)
                close()
                moveTo(17f, 19f)
                curveToRelative(-0.83f, 0f, -1.5f, -0.67f, -1.5f, -1.5f)
                curveToRelative(0f, -0.83f, 0.67f, -1.5f, 1.5f, -1.5f)
                reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f)
                curveTo(18.5f, 18.33f, 17.83f, 19f, 17f, 19f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
