...
val MaterialIcons.Twotone.Timelapse: ImageVector
    get() {
        ...
        _Timelapse = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveCurveToRelative(-3.58f, -8f, -8f, -8f)
                close()
                moveToRelative(4.25f, 12.24f)
                curveToRelative(-2.35f, 2.34f, -6.15f, 2.34f, -8.49f, 0f)
                lineTo(12f, 11.99f)
                verticalLineToRelative(-6f)
                curveToRelative(1.54f, 0f, 3.07f, 0.59f, 4.24f, 1.76f)
