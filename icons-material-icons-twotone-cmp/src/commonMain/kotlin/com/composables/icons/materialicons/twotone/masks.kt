...
val MaterialIcons.Twotone.Masks: ImageVector
    get() {
        ...
        _Masks = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(14.34f, 8.78f)
                curveTo(13.52f, 8.33f, 12.93f, 8f, 12f, 8f)
                curveToRelative(-0.93f, 0f, -1.52f, 0.33f, -2.34f, 0.77f)
                curveTo(8.95f, 9.16f, 8.12f, 9.62f, 7f, 9.85f)
            ...
            path(
                ...
                curveTo(10.48f, 8.33f, 11.07f, 8f, 12f, 8f)
                curveToRelative(0.93f, 0f, 1.52f, 0.33f, 2.34f, 0.78f)
                curveToRelative(0.71f, 0.39f, 1.54f, 0.84f, 2.66f, 1.08f)
                verticalLineToRelative(1.65f)
                curveToRelative(0f, 2.76f, -2.24f, 5f, -5f, 5f)
                reflectiveCurveTo(7f, 14.26f, 7f, 11.5f)
                close()
                moveTo(20.5f, 9f)
