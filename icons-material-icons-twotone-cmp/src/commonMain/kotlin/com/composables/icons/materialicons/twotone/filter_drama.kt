...
val MaterialIcons.Twotone.Filter_drama: ImageVector
    get() {
        ...
        _Filter_drama = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(17.5f, 8.47f, 15.03f, 6f, 12f, 6f)
                curveToRelative(-1.8f, 0f, -3.39f, 0.88f, -4.4f, 2.22f)
            ...
            path(
                ...
                reflectiveCurveToRelative(4f, 1.79f, 4f, 4f)
                horizontalLineToRelative(2f)
                curveToRelative(0f, -2.76f, -1.86f, -5.08f, -4.4f, -5.78f)
                curveTo(8.61f, 6.88f, 10.2f, 6f, 12f, 6f)
