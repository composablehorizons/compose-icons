...
val MaterialIcons.Twotone.Favorite: ImageVector
    get() {
        ...
        _Favorite = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(16.5f, 5f)
                curveToRelative(-1.54f, 0f, -3.04f, 0.99f, -3.56f, 2.36f)
                horizontalLineToRelative(-1.87f)
                curveTo(10.54f, 5.99f, 9.04f, 5f, 7.5f, 5f)
                ...
                curveToRelative(0f, -2f, -1.5f, -3.5f, -3.5f, -3.5f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
