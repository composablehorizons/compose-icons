...
val MaterialIcons.Twotone.Local_pizza: ImageVector
    get() {
        ...
        _Local_pizza = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(16.68f, 4.85f, 14.38f, 4f, 12f, 4f)
                reflectiveCurveToRelative(-4.68f, 0.85f, -6.49f, 2.36f)
                close()
                moveTo(9f, 8.5f)
                curveToRelative(-0.83f, 0f, -1.5f, -0.67f, -1.5f, -1.5f)
                reflectiveCurveTo(8.17f, 5.5f, 9f, 5.5f)
                reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f)
                reflectiveCurveTo(9.82f, 8.5f, 9f, 8.5f)
                close()
