...
val MaterialIcons.Twotone.Auto_stories: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        curveTo(4.14f, 16.21f, 5.31f, 16f, 6.5f, 16f)
                        curveToRelative(1.19f, 0f, 2.36f, 0.21f, 3.5f, 0.62f)
                        verticalLineTo(6.72f)
                        curveTo(8.89f, 6.25f, 7.7f, 6f, 6.5f, 6f)
                        curveTo(5.28f, 6f, 4.11f, 6.24f, 3f, 6.71f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
