...
val MaterialIcons.Twotone.Exposure_plus_2: ImageVector
    get() {
        if (_Exposure_plus_2 != null) return _Exposure_plus_2!!
        
        _Exposure_plus_2 = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(0f, -0.53f, -0.09f, -1.02f, -0.27f, -1.46f)
                ...
                curveToRelative(-0.69f, 0f, -1.31f, 0.11f, -1.85f, 0.32f)
                curveToRelative(-0.54f, 0.21f, -1f, 0.51f, -1.36f, 0.88f)
                ...
                curveToRelative(0.31f, 0f, 0.58f, 0.05f, 0.81f, 0.15f)
                ...
                curveToRelative(0f, 0.22f, -0.03f, 0.43f, -0.08f, 0.65f)
        ...
        return _Exposure_plus_2!!
    }

private var _Exposure_plus_2: ImageVector? = null
