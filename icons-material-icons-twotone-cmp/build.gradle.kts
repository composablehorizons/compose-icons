...
val publishArtifactId = "icons-material-icons-twotone-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesMaterial Icons twotone"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.materialicons.twotone"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Icons twotone")
        description.set("Compose Icons Material Icons twotone for Compose Multiplatform.")
        url.set(projectUrl)
