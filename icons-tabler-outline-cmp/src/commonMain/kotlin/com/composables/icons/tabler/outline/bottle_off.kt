...
val Tabler.Outline.BottleOff: ImageVector
    get() {
        ...
        _BottleOff = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(8.093f, 8.093f, 0f, false, true, 1.5f, 4.694f)
                ...
                arcToRelative(8.09f, 8.09f, 0f, false, true, 1.35f, -4.474f)
                moveToRelative(1.336f, -2.63f)
                arcToRelative(7.822f, 7.822f, 0f, false, false, 0.314f, -2.196f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
                ...
                moveTo(7f, 14.803f)
                arcToRelative(2.4f, 2.4f, 0f, false, false, 1f, -0.803f)
                arcToRelative(2.4f, 2.4f, 0f, false, true, 2f, -1f)
                arcToRelative(2.4f, 2.4f, 0f, false, true, 2f, 1f)
                arcToRelative(2.4f, 2.4f, 0f, false, false, 2f, 1f)
                arcToRelative(2.4f, 2.4f, 0f, false, false, 0.866f, -0.142f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
