...
val Tabler.Outline.ScubaDivingTank: ImageVector
    get() {
        ...
        _ScubaDivingTank = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(12.5f, 4f)
                arcTo(0.5f, 0.5f, 0f, false, true, 12f, 4.5f)
                arcTo(0.5f, 0.5f, 0f, false, true, 11.5f, 4f)
                arcTo(0.5f, 0.5f, 0f, false, true, 12.5f, 4f)
                close()
            }
        }.build()
