...
val Tabler.Outline.DropletCode: ImageVector
    get() {
        ...
        _DropletCode = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(6.586f, 6.586f, 0f, false, false, -0.843f, -2.27f)
                ...
                arcToRelative(7.123f, 7.123f, 0f, false, false, 3.99f, 1.561f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
