...
val Tabler.Outline.WorldStar: ImageVector
    get() {
        ...
        _WorldStar = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(21f, 12f)
                arcToRelative(9f, 9f, 0f, true, false, -9.968f, 8.948f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
            ...
            path(
                ...
                moveTo(11.5f, 3f)
                arcToRelative(17.001f, 17.001f, 0f, false, false, -1.886f, 13.802f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
                ...
                moveTo(12.5f, 3f)
                arcToRelative(16.982f, 16.982f, 0f, false, true, 2.549f, 8.01f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
