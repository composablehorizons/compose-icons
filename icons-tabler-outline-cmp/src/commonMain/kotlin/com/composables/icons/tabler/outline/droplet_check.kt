...
val Tabler.Outline.DropletCheck: ImageVector
    get() {
        ...
        _DropletCheck = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(6.568f, 6.568f, 0f, false, false, -0.903f, -2.717f)
                ...
                arcToRelative(7.125f, 7.125f, 0f, false, false, 4.04f, 1.565f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
