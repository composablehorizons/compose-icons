...
val Tabler.Outline.MapPinStar: ImageVector
    get() {
        ...
        _MapPinStar = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(15f, 11f)
                arcToRelative(3f, 3f, 0f, true, false, -3.908f, 2.86f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
                ...
                arcToRelative(2f, 2f, 0f, false, true, -0.472f, -0.35f)
                lineToRelative(-4.244f, -4.243f)
                arcToRelative(8f, 8f, 0f, true, true, 13.646f, -6.079f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
