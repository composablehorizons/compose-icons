...
val Tabler.Outline.DropletCancel: ImageVector
    get() {
        ...
        _DropletCancel = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(6.659f, 6.659f, 0f, false, false, -0.542f, -1.137f)
                ...
                arcToRelative(7.154f, 7.154f, 0f, false, false, 4.826f, 1.572f)
            }
            path(
                fill = SolidColor(Color.Transparent),
                stroke = SolidColor(Color(0xFF000000)),
