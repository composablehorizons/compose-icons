...
val Tabler.Outline.CashBanknoteHeart: ImageVector
    get() {
        ...
        _CashBanknoteHeart = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(3.001f, 3.001f, 0f, true, false, -4.29f, 3.514f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
            ...
            path(
                ...
                arcToRelative(2.24f, 2.24f, 0f, false, false, -3.129f, -0.006f)
                lineToRelative(-0.224f, 0.22f)
                lineToRelative(-0.223f, -0.22f)
                arcToRelative(2.24f, 2.24f, 0f, false, false, -3.128f, -0.006f)
