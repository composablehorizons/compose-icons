...
val Tabler.Outline.BrandWaze: ImageVector
    get() {
        ...
        _BrandWaze = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(6.66f, 17.52f)
                arcToRelative(7f, 7f, 0f, false, true, -3.66f, -4.52f)
                ...
                arcToRelative(8.08f, 8.08f, 0f, false, true, -3.39f, 6.62f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
                ...
                moveTo(10f, 18.69f)
                arcToRelative(17.29f, 17.29f, 0f, false, false, 3.33f, 0.3f)
