...
val Tabler.Outline.SettingsHeart: ImageVector
    get() {
        ...
        _SettingsHeart = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(1.668f, 1.668f, 0f, false, true, -0.906f, -1.145f)
            ...
            path(
                ...
                arcToRelative(3.001f, 3.001f, 0f, true, false, -4.31f, 3.474f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
