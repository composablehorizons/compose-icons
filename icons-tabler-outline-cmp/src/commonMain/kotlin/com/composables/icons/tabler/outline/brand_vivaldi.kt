...
val Tabler.Outline.BrandVivaldi: ImageVector
    get() {
        ...
        _BrandVivaldi = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(2.47f, 2.47f, 0f, false, true, -0.06f, -2.45f)
                arcToRelative(2.493f, 2.493f, 0f, false, true, 2.085f, -1.307f)
                curveToRelative(0.951f, -0.065f, 1.85f, 0.438f, 2.287f, 1.281f)
                curveToRelative(0.697f, 1.19f, 2.043f, 3.83f, 2.55f, 4.682f)
                arcToRelative(3.919f, 3.919f, 0f, false, false, 3.282f, 2.017f)
                ...
                arcToRelative(2.484f, 2.484f, 0f, false, true, 1.814f, 2.062f)
