...
val Tabler.Outline.HandFingerLeft: ImageVector
    get() {
        ...
        _HandFingerLeft = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(6f, 6f, 0f, false, false, -2.7f, -5.012f)
                lineToRelative(-0.3f, -0.196f)
                quadToRelative(-0.718f, -0.468f, -5.728f, -3.286f)
                arcToRelative(1.5f, 1.5f, 0f, false, false, -2.022f, 0.536f)
                arcToRelative(1.87f, 1.87f, 0f, false, false, 0.28f, 2.28f)
