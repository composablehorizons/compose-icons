...
val Tabler.Outline.DropletHeart: ImageVector
    get() {
        ...
        _DropletHeart = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(6.734f, 6.734f, 0f, false, false, -0.224f, -0.405f)
                ...
                arcToRelative(7.117f, 7.117f, 0f, false, false, 3.824f, 1.548f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
