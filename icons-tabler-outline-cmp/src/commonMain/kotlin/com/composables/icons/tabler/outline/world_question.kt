...
val Tabler.Outline.WorldQuestion: ImageVector
    get() {
        ...
        _WorldQuestion = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(9f, 9f, 0f, true, false, -5.673f, 9.043f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
            ...
            path(
                ...
                moveTo(12.5f, 3f)
                arcToRelative(16.988f, 16.988f, 0f, false, true, 2.57f, 9.518f)
                moveToRelative(-1.056f, 5.403f)
                arcToRelative(17f, 17f, 0f, false, true, -1.514f, 3.079f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
