...
val Tabler.Outline.DropletCog: ImageVector
    get() {
        if (_DropletCog != null) return _DropletCog!!
        ...
        _DropletCog = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(6.702f, 6.702f, 0f, false, false, -0.357f, -0.683f)
                ...
                arcToRelative(7.144f, 7.144f, 0f, false, false, 4.518f, 1.58f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
