...
android {
    namespace = "com.composables.icons.materialsymbols.roundedfilled"
    compileSdk = 36
    defaultConfig {
...
val publishArtifactId = "icons-material-symbols-rounded-filled-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Symbols rounded-filled Android")
        description.set("Compose Icons Material Symbols rounded-filled for Android.")
        url.set(projectUrl)
