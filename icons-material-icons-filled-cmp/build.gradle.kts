...
val publishArtifactId = "icons-material-icons-filled-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesMaterial Icons filled"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.materialicons.filled"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Icons filled")
        description.set("Compose Icons Material Icons filled for Compose Multiplatform.")
        url.set(projectUrl)
