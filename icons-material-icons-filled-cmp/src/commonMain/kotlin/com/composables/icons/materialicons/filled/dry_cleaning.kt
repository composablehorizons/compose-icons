...
val MaterialIcons.Filled.Dry_cleaning: ImageVector
    get() {
        ...
        _Dry_cleaning = ImageVector.Builder(
            ...
            group {
                path(
                    ...
                    curveTo(5.19f, 14f, 5f, 13.81f, 5f, 13.57f)
                    curveToRelative(0f, -0.17f, 0.1f, -0.32f, 0.25f, -0.38f)
                    lineToRelative(6.75f, -3f)
                    lineToRelative(6.75f, 3f)
                    curveTo(18.9f, 13.26f, 19f, 13.41f, 19f, 13.58f)
                    curveTo(19f, 13.81f, 18.81f, 14f, 18.58f, 14f)
                    close()
                }
            }
        }.build()
