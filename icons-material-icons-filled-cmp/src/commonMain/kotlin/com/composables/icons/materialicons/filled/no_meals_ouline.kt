...
val MaterialIcons.Filled.No_meals_ouline: ImageVector
    get() {
        if (_No_meals_ouline != null) return _No_meals_ouline!!
        
        _No_meals_ouline = ImageVector.Builder(
        ...
        return _No_meals_ouline!!
    }

private var _No_meals_ouline: ImageVector? = null
