...
val MaterialIcons.Filled.Tire_repair: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        curveTo(18.11f, 6.47f, 18f, 6.72f, 18f, 7f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        curveTo(24f, 4.24f, 21.76f, 2f, 19f, 2f)
                        close()
                        moveTo(6f, 19.5f)
                        ...
                        reflectiveCurveTo(20.66f, 10f, 19f, 10f)
                        close()
                    }
                }
            }
