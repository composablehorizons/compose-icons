...
val MaterialIcons.Filled.Accessible_forward: ImageVector
    get() {
        ...
        _Accessible_forward = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(19f, 4.54f)
                arcTo(2f, 2f, 0f, false, true, 17f, 6.54f)
                arcTo(2f, 2f, 0f, false, true, 15f, 4.54f)
                arcTo(2f, 2f, 0f, false, true, 19f, 4.54f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
                ...
                curveTo(17.42f, 8.5f, 16.44f, 7f, 14.96f, 7f)
