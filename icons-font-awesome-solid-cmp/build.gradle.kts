...
val publishArtifactId = "icons-font-awesome-solid-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesFont Awesome solid"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.fontawesome.solid"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Font Awesome solid")
        description.set("Compose Icons Font Awesome solid for Compose Multiplatform.")
        url.set(projectUrl)
