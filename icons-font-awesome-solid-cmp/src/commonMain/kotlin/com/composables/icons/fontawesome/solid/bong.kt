...
val FontAwesome.Solid.Bong: ImageVector
    get() {
        ...
        _Bong = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(302.5f, 512f)
                curveToRelative(23.18f, 0f, 44.43f, -12.58f, 56f, -32.66f)
                curveTo(374.69f, 451.26f, 384f, 418.75f, 384f, 384f)
                curveToRelative(0f, -36.12f, -10.08f, -69.81f, -27.44f, -98.62f)
                lineTo(400f, 241.94f)
                ...
                curveTo(320f, 7.17f, 312.82f, -0.01f, 303.97f, 0f)
                lineTo(80.03f, 0.26f)
                curveToRelative(-8.82f, 0.01f, -15.97f, 7.16f, -15.98f, 15.98f)
                ...
                curveTo(38.67f, 251.1f, 0f, 312.97f, 0f, 384f)
                curveToRelative(0f, 34.75f, 9.31f, 67.27f, 25.5f, 95.34f)
                curveTo(37.08f, 499.42f, 58.33f, 512f, 81.5f, 512f)
                horizontalLineToRelative(221f)
                close()
                moveTo(120.06f, 259.43f)
                lineTo(144f, 245.56f)
                verticalLineTo(63.91f)
                lineToRelative(96f, -0.11f)
