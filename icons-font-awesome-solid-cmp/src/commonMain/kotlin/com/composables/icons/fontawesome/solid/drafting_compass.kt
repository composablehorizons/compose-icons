...
val FontAwesome.Solid.DraftingCompass: ImageVector
    get() {
        ...
        _DraftingCompass = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(403.01f, 281.15f, 332.25f, 320f, 256f, 320f)
                curveToRelative(-23.93f, 0f, -47.23f, -4.25f, -69.41f, -11.53f)
                ...
                curveTo(347.39f, 128.03f, 352f, 112.63f, 352f, 96f)
                curveToRelative(0f, -53.02f, -42.98f, -96f, -96f, -96f)
                reflectiveCurveToRelative(-96f, 42.98f, -96f, 96f)
                curveToRelative(0f, 16.63f, 4.61f, 32.03f, 12.05f, 45.66f)
                lineToRelative(-68.3f, 118.31f)
                curveToRelative(-12.55f, -11.61f, -23.96f, -24.59f, -33.68f, -39f)
                ...
                curveTo(186.13f, 377.28f, 220.62f, 384f, 256f, 384f)
                curveToRelative(99.05f, 0f, 190.88f, -51.01f, 243.5f, -134.14f)
                close()
                moveTo(256f, 64f)
