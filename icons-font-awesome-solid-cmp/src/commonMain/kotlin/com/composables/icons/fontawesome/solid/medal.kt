...
val FontAwesome.Solid.Medal: ImageVector
    get() {
        ...
        _Medal = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(31.997f, 31.997f, 0f, false, false, 127.18f, 0f)
                horizontalLineTo(16.03f)
                curveTo(3.08f, 0f, -4.5f, 14.57f, 2.92f, 25.18f)
                lineToRelative(111.27f, 158.96f)
                curveToRelative(29.72f, -27.77f, 67.52f, -46.83f, 109.56f, -53.39f)
                close()
                moveTo(495.97f, 0f)
                horizontalLineTo(384.82f)
                curveToRelative(-11.24f, 0f, -21.66f, 5.9f, -27.44f, 15.54f)
                lineToRelative(-69.13f, 115.21f)
                curveToRelative(42.04f, 6.56f, 79.84f, 25.62f, 109.56f, 53.38f)
                lineTo(509.08f, 25.18f)
                curveTo(516.5f, 14.57f, 508.92f, 0f, 495.97f, 0f)
                close()
                moveTo(256f, 160f)
                curveToRelative(-97.2f, 0f, -176f, 78.8f, -176f, 176f)
                reflectiveCurveToRelative(78.8f, 176f, 176f, 176f)
                reflectiveCurveToRelative(176f, -78.8f, 176f, -176f)
                reflectiveCurveToRelative(-78.8f, -176f, -176f, -176f)
                close()
                moveToRelative(92.52f, 157.26f)
                ...
                curveToRelative(4.11f, 0f, 8.22f, 2.14f, 10.33f, 6.39f)
                lineToRelative(23.43f, 47.52f)
                lineToRelative(52.43f, 7.64f)
