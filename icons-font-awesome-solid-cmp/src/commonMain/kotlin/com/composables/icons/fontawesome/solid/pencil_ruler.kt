...
val FontAwesome.Solid.PencilRuler: ImageVector
    get() {
        ...
        _PencilRuler = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(7.919f, 7.919f, 0f, false, true, -11.21f, 0f)
                lineToRelative(-11.21f, -11.21f)
                curveToRelative(-3.1f, -3.1f, -3.1f, -8.12f, 0f, -11.21f)
                lineToRelative(61.68f, -61.68f)
                lineToRelative(-33.64f, -33.65f)
                curveTo(131.47f, -3.1f, 111.39f, -3.1f, 99f, 9.29f)
                lineTo(9.29f, 99f)
                curveToRelative(-12.38f, 12.39f, -12.39f, 32.47f, 0f, 44.86f)
                lineToRelative(100.17f, 100.18f)
                close()
                moveToRelative(388.47f, -116.8f)
                curveToRelative(18.76f, -18.76f, 18.75f, -49.17f, 0f, -67.93f)
                lineToRelative(-45.25f, -45.25f)
                curveToRelative(-18.76f, -18.76f, -49.18f, -18.76f, -67.95f, 0f)
                lineToRelative(-46.02f, 46.01f)
                lineToRelative(113.2f, 113.2f)
                lineToRelative(46.02f, -46.03f)
                close()
                moveTo(316.08f, 82.71f)
                lineToRelative(-297f, 296.96f)
                ...
                close()
                moveToRelative(186.63f, 285.43f)
                lineToRelative(-33.64f, -33.64f)
                lineToRelative(-61.68f, 61.68f)
                curveToRelative(-3.1f, 3.1f, -8.12f, 3.1f, -11.21f, 0f)
                lineToRelative(-11.21f, -11.21f)
                curveToRelative(-3.09f, -3.1f, -3.09f, -8.12f, 0f, -11.21f)
                lineToRelative(61.68f, -61.68f)
                lineToRelative(-44.14f, -44.14f)
                lineTo(267.93f, 402.5f)
                lineToRelative(100.21f, 100.2f)
                curveToRelative(12.39f, 12.39f, 32.47f, 12.39f, 44.86f, 0f)
                lineToRelative(89.71f, -89.7f)
                curveToRelative(12.39f, -12.39f, 12.39f, -32.47f, 0f, -44.86f)
                close()
            }
        }.build()
