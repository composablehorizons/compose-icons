...
val FontAwesome.Solid.Frog: ImageVector
    get() {
        if (_Frog != null) return _Frog!!
        ...
        _Frog = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(439.67f, 60.23f, 407.19f, 32f, 368f, 32f)
                curveToRelative(-39.23f, 0f, -71.72f, 28.29f, -78.54f, 65.54f)
                curveTo(126.75f, 112.96f, -0.5f, 250.12f, 0f, 416.98f)
                curveTo(0.11f, 451.9f, 29.08f, 480f, 64f, 480f)
                ...
                curveToRelative(36.84f, -27.66f, 88.28f, -27.62f, 125.13f, 0f)
                ...
                arcTo(58.16f, 58.16f, 0f, false, false, 576f, 189.94f)
                curveToRelative(0f, -21.4f, -11.72f, -40.95f, -30.48f, -51.23f)
