...
val FontAwesome.Solid.CartArrowDown: ImageVector
    get() {
        if (_CartArrowDown != null) return _CartArrowDown!!
        ...
        _CartArrowDown = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(504.717f, 320f)
                horizontalLineTo(211.572f)
                lineToRelative(6.545f, 32f)
                horizontalLineToRelative(268.418f)
                curveToRelative(15.401f, 0f, 26.816f, 14.301f, 23.403f, 29.319f)
                lineToRelative(-5.517f, 24.276f)
                curveTo(523.112f, 414.668f, 536f, 433.828f, 536f, 456f)
                curveToRelative(0f, 31.202f, -25.519f, 56.444f, -56.824f, 55.994f)
                ...
                curveTo(241.553f, 426.165f, 248f, 440.326f, 248f, 456f)
                curveToRelative(0f, 31.813f, -26.528f, 57.431f, -58.67f, 55.938f)
                ...
                curveTo(10.745f, 64f, 0f, 53.255f, 0f, 40f)
                verticalLineTo(24f)
                curveTo(0f, 10.745f, 10.745f, 0f, 24f, 0f)
                horizontalLineToRelative(102.529f)
                curveToRelative(11.401f, 0f, 21.228f, 8.021f, 23.513f, 19.19f)
                lineTo(159.208f, 64f)
                horizontalLineTo(551.99f)
                curveToRelative(15.401f, 0f, 26.816f, 14.301f, 23.403f, 29.319f)
                lineToRelative(-47.273f, 208f)
                curveTo(525.637f, 312.246f, 515.923f, 320f, 504.717f, 320f)
                close()
                moveTo(403.029f, 192f)
