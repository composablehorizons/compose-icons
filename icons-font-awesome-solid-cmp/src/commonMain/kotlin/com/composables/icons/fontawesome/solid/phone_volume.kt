...
val FontAwesome.Solid.PhoneVolume: ImageVector
    get() {
        if (_PhoneVolume != null) return _PhoneVolume!!
        ...
        _PhoneVolume = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(-129.874f, -129.874f, -129.681f, -340.252f, 0f, -469.933f)
                curveToRelative(5.698f, -5.698f, 14.527f, -6.632f, 21.263f, -2.422f)
                lineToRelative(64.817f, 40.513f)
                arcToRelative(17.187f, 17.187f, 0f, false, true, 6.849f, 20.958f)
                lineToRelative(-32.408f, 81.021f)
                arcToRelative(17.188f, 17.188f, 0f, false, true, -17.669f, 10.719f)
                lineToRelative(-55.81f, -5.58f)
                curveToRelative(-21.051f, 58.261f, -20.612f, 122.471f, 0f, 179.515f)
                lineToRelative(55.811f, -5.581f)
                arcToRelative(17.188f, 17.188f, 0f, false, true, 17.669f, 10.719f)
                lineToRelative(32.408f, 81.022f)
                arcToRelative(17.188f, 17.188f, 0f, false, true, -6.849f, 20.958f)
                lineToRelative(-64.817f, 40.513f)
                arcToRelative(17.19f, 17.19f, 0f, false, true, -21.264f, -2.422f)
                close()
                moveTo(247.126f, 95.473f)
                curveToRelative(11.832f, 20.047f, 11.832f, 45.008f, 0f, 65.055f)
                ...
                arcToRelative(32.063f, 32.063f, 0f, false, false, 0f, -29.945f)
                curveToRelative(-2.533f, -4.788f, -1.65f, -10.662f, 2.261f, -14.41f)
                lineToRelative(5.975f, -5.726f)
                curveToRelative(5.61f, -5.378f, 14.768f, -4.112f, 18.718f, 2.581f)
                close()
                moveToRelative(91.787f, -91.187f)
                curveToRelative(60.14f, 71.604f, 60.092f, 175.882f, 0f, 247.428f)
                ...
                curveToRelative(49.687f, -59.538f, 49.646f, -145.933f, 0f, -205.422f)
                curveToRelative(-4.047f, -4.85f, -3.631f, -12.008f, 0.93f, -16.379f)
                lineToRelative(5.798f, -5.557f)
                curveToRelative(5.022f, -4.813f, 13.078f, -4.394f, 17.552f, 0.933f)
                close()
                moveToRelative(-45.972f, 44.941f)
                curveToRelative(36.05f, 46.322f, 36.108f, 111.149f, 0f, 157.546f)
                ...
                curveToRelative(26.536f, -34.564f, 26.534f, -82.572f, 0f, -117.134f)
