...
val FontAwesome.Brands.Dribbble: ImageVector
    get() {
        ...
        _Dribbble = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(256f, 8f)
                curveTo(119.252f, 8f, 8f, 119.252f, 8f, 256f)
                reflectiveCurveToRelative(111.252f, 248f, 248f, 248f)
                reflectiveCurveToRelative(248f, -111.252f, 248f, -248f)
                reflectiveCurveTo(392.748f, 8f, 256f, 8f)
                close()
                moveToRelative(163.97f, 114.366f)
                ...
                curveToRelative(0f, -2.166f, 0.043f, -4.322f, 0.108f, -6.473f)
                ...
                close()
                moveToRelative(81.807f, 167.113f)
