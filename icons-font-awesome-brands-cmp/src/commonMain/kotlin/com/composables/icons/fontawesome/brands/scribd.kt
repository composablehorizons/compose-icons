...
val FontAwesome.Brands.Scribd: ImageVector
    get() {
        if (_Scribd != null) return _Scribd!!
        ...
        _Scribd = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(42.3f, 252.7f)
                curveToRelative(-16.1f, -19f, -24.7f, -45.9f, -24.8f, -79.9f)
                curveToRelative(0f, -100.4f, 75.2f, -153.1f, 167.2f, -153.1f)
                curveToRelative(98.6f, -1.6f, 156.8f, 49f, 184.3f, 70.6f)
                lineToRelative(-50.5f, 72.1f)
                lineToRelative(-37.3f, -24.6f)
                lineToRelative(26.9f, -38.6f)
                curveToRelative(-36.5f, -24f, -79.4f, -36.5f, -123f, -35.8f)
                curveToRelative(-50.7f, -0.8f, -111.7f, 27.2f, -111.7f, 76.2f)
                curveToRelative(0f, 18.7f, 11.2f, 20.7f, 28.6f, 15.6f)
                curveToRelative(23.3f, -5.3f, 41.9f, 0.6f, 55.8f, 14f)
                curveToRelative(26.4f, 24.3f, 23.2f, 67.6f, -0.7f, 91.9f)
                curveToRelative(-29.2f, 29.5f, -85.2f, 27.3f, -114.8f, -8.4f)
                close()
                moveToRelative(317.7f, 5.9f)
                curveToRelative(-15.5f, -18.8f, -38.9f, -29.4f, -63.2f, -28.6f)
                curveToRelative(-38.1f, -2f, -71.1f, 28f, -70.5f, 67.2f)
                curveToRelative(-0.7f, 16.8f, 6f, 33f, 18.4f, 44.3f)
                curveToRelative(14.1f, 13.9f, 33f, 19.7f, 56.3f, 14.4f)
                curveToRelative(17.4f, -5.1f, 28.6f, -3.1f, 28.6f, 15.6f)
                curveToRelative(0f, 4.3f, -0.5f, 8.5f, -1.4f, 12.7f)
                ...
                curveToRelative(51.4f, 0f, 94.4f, -10.5f, 133.6f, -44.1f)
