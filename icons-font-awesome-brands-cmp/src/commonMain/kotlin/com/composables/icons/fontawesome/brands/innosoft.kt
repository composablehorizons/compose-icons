...
val FontAwesome.Brands.Innosoft: ImageVector
    get() {
        if (_Innosoft != null) return _Innosoft!!
        ...
        _Innosoft = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(27.379f, 27.379f, 0f, false, false, -13.866f, -23.337f)
                arcToRelative(26.42f, 26.42f, 0f, false, false, -26.211f, 0.133f)
                lineTo(73.943f, 314.647f)
                verticalLineTo(176.261f)
                arcToRelative(11.955f, 11.955f, 0f, false, true, 6.047f, -10.34f)
                lineTo(218.066f, 86.208f)
                arcToRelative(12.153f, 12.153f, 0f, false, true, 11.922f, 0.025f)
                ...
                lineToRelative(0f, 191.5f)
                curveToRelative(0.17f, 10.135f, 5.08f, 18.672f, 13.474f, 23.428f)
                arcToRelative(27.037f, 27.037f, 0f, false, false, 26.736f, -0.045f)
                lineTo(374.057f, 197.376f)
                verticalLineTo(335.657f)
                arcToRelative(11.976f, 11.976f, 0f, false, true, -5.92f, 10.368f)
                lineTo(230.025f, 425.77f)
                arcToRelative(12.175f, 12.175f, 0f, false, true, -11.937f, 0.062f)
                lineToRelative(-32.723f, -18.9f)
                lineToRelative(150.051f, -86.627f)
                verticalLineToRelative(-56f)
                lineTo(88.367f, 406.932f)
                lineToRelative(118.794f, 68.583f)
                arcToRelative(33.88f, 33.88f, 0f, false, false, 34.25f, -0.327f)
