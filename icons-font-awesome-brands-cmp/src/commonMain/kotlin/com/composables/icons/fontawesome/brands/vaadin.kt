...
val FontAwesome.Brands.Vaadin: ImageVector
    get() {
        if (_Vaadin != null) return _Vaadin!!
        ...
        _Vaadin = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(20.7f, 0f, 32.1f, -7.8f, 32.1f, -21.6f)
                verticalLineTo(54.1f)
                curveToRelative(0f, -12.2f, 9.3f, -22.1f, 21.5f, -22.1f)
                reflectiveCurveTo(448f, 41.9f, 448f, 54.1f)
                verticalLineToRelative(36.5f)
                curveToRelative(0f, 42.9f, -21.5f, 62f, -66.8f, 62f)
                horizontalLineTo(280.7f)
                curveToRelative(-30.1f, 0f, -33f, 14.7f, -33f, 27.1f)
                ...
                curveToRelative(0f, -12.3f, -3f, -27.1f, -33f, -27.1f)
                horizontalLineTo(66.8f)
                curveToRelative(-45.3f, 0f, -66.8f, -19.1f, -66.8f, -62f)
                verticalLineTo(54.1f)
                curveTo(0f, 41.9f, 9.4f, 32f, 21.6f, 32f)
                reflectiveCurveToRelative(21.5f, 9.9f, 21.5f, 22.1f)
                verticalLineToRelative(12.3f)
                curveTo(43.1f, 80.2f, 54.5f, 88f, 75.2f, 88f)
                horizontalLineToRelative(98.6f)
                curveToRelative(44.8f, 0f, 48.3f, 35.1f, 49.8f, 52.7f)
                horizontalLineToRelative(0.9f)
                close()
                moveTo(224f, 456f)
                curveToRelative(11.5f, 0f, 21.4f, -7f, 25.7f, -16.3f)
                curveToRelative(1.1f, -1.8f, 97.1f, -169.6f, 98.2f, -171.4f)
                curveToRelative(11.9f, -19.6f, -3.2f, -44.3f, -27.2f, -44.3f)
                curveToRelative(-13.9f, 0f, -23.3f, 6.4f, -29.8f, 20.3f)
                lineTo(224f, 362f)
                lineToRelative(-66.9f, -117.7f)
                curveToRelative(-6.4f, -13.9f, -15.9f, -20.3f, -29.8f, -20.3f)
                curveToRelative(-24f, 0f, -39.1f, 24.6f, -27.2f, 44.3f)
