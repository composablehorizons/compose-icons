...
val FontAwesome.Brands.Invision: ImageVector
    get() {
        if (_Invision != null) return _Invision!!
        ...
        _Invision = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(18.2f, 32f, 0f, 50.2f, 0f, 72.6f)
                verticalLineToRelative(366.8f)
                curveTo(0f, 461.8f, 18.2f, 480f, 40.6f, 480f)
                horizontalLineToRelative(366.8f)
                curveToRelative(22.4f, 0f, 40.6f, -18.2f, 40.6f, -40.6f)
                verticalLineTo(72.6f)
                curveToRelative(0f, -22.4f, -18.2f, -40.6f, -40.6f, -40.6f)
                close()
                moveTo(176.1f, 145.6f)
                curveToRelative(0.4f, 23.4f, -22.4f, 27.3f, -26.6f, 27.4f)
                curveToRelative(-14.9f, 0f, -27.1f, -12f, -27.1f, -27f)
                curveToRelative(0.1f, -35.2f, 53.1f, -35.5f, 53.7f, -0.4f)
                close()
                moveTo(332.8f, 377f)
                curveToRelative(-65.6f, 0f, -34.1f, -74f, -25f, -106.6f)
                curveToRelative(14.1f, -46.4f, -45.2f, -59f, -59.9f, 0.7f)
                ...
                curveToRelative(0.1f, -14.3f, 0.9f, -14f, 23f, -104.1f)
                ...
                curveToRelative(0f, 20.9f, 40.9f, 13.5f, 57.4f, -23.2f)
                lineToRelative(19.8f, -79.4f)
                horizontalLineToRelative(-32.3f)
                lineToRelative(9.7f, -35.6f)
                horizontalLineToRelative(68.8f)
                lineToRelative(-8.9f, 40.5f)
                curveToRelative(40.5f, -75.5f, 127.9f, -47.8f, 101.8f, 38f)
                curveToRelative(-14.2f, 51.1f, -14.6f, 50.7f, -14.9f, 58.8f)
                curveToRelative(0f, 15.5f, 17.5f, 22.6f, 31.8f, -16.9f)
                lineTo(386f, 325f)
                curveToRelative(-10.5f, 36.7f, -29.4f, 52f, -53.2f, 52f)
                close()
            }
        }.build()
