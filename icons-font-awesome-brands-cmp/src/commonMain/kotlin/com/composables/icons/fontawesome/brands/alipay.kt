...
val FontAwesome.Brands.Alipay: ImageVector
    get() {
        ...
        _Alipay = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(31.41f, 32f, 0f, 63.41f, 0f, 102.26f)
                verticalLineToRelative(307.48f)
                curveTo(0f, 448.59f, 31.41f, 480f, 70.26f, 480f)
                horizontalLineToRelative(307.48f)
                curveToRelative(38.52f, 0f, 69.76f, -31.08f, 70.26f, -69.6f)
                curveToRelative(-45.96f, -25.62f, -110.59f, -60.34f, -171.6f, -88.44f)
                curveToRelative(-32.07f, 43.97f, -84.14f, 81f, -148.62f, 81f)
                curveToRelative(-70.59f, 0f, -93.73f, -45.3f, -97.04f, -76.37f)
                curveToRelative(-3.97f, -39.01f, 14.88f, -81.5f, 99.52f, -81.5f)
                curveToRelative(35.38f, 0f, 79.35f, 10.25f, 127.13f, 24.96f)
                ...
                curveTo(447.83f, 63.57f, 416.43f, 32f, 377.74f, 32f)
                close()
                moveTo(47.28f, 322.95f)
                curveToRelative(0.99f, 20.17f, 10.25f, 53.73f, 69.93f, 53.73f)
                curveToRelative(52.07f, 0f, 92.58f, -39.68f, 117.87f, -72.9f)
                curveToRelative(-44.63f, -18.68f, -84.48f, -31.41f, -109.44f, -31.41f)
                curveToRelative(-67.45f, 0f, -79.35f, 33.06f, -78.36f, 50.58f)
                close()
            }
        }.build()
