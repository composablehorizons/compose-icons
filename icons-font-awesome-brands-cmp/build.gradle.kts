...
val publishArtifactId = "icons-font-awesome-brands-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesFont Awesome brands"
            isStatic = true
        }
    }
    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                api(project(":icons-font-awesome-cmp"))
            }
        }
    }
}
...
android {
    namespace = "com.composables.icons.fontawesome.brands"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Font Awesome brands")
        description.set("Compose Icons Font Awesome brands for Compose Multiplatform.")
        url.set(projectUrl)
