...
val publishArtifactId = "icons-heroicons-cmp"
...
android {
    namespace = "com.composables.icons.heroicons"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Heroicons")
        description.set("Compose Icons Heroicons for Compose Multiplatform.")
        url.set(projectUrl)
