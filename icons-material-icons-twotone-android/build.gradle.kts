...
val publishArtifactId = "icons-material-icons-twotone-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Icons twotone Android")
        description.set("Compose Icons Material Icons twotone for Android.")
        url.set(projectUrl)
