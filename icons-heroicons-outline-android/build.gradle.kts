...
android {
    namespace = "com.composables.icons.heroicons.outline"
    compileSdk = 36
    defaultConfig {
...
val publishArtifactId = "icons-heroicons-outline-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Heroicons outline Android")
        description.set("Compose Icons Heroicons outline for Android.")
        url.set(projectUrl)
