...
val publishArtifactId = "icons-material-icons-outlined-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesMaterial Icons outlined"
            isStatic = true
        }
    }
    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                api(project(":icons-material-icons-cmp"))
            }
        }
    }
}
...
android {
    namespace = "com.composables.icons.materialicons.outlined"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Icons outlined")
        description.set("Compose Icons Material Icons outlined for Compose Multiplatform.")
        url.set(projectUrl)
