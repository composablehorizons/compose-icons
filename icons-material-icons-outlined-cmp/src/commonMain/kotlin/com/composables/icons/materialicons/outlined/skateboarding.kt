...
val MaterialIcons.Outlined.Skateboarding: ImageVector
    get() {
        ...
        _Skateboarding = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(4.21f, 19.11f, 3.99f, 19f, 3.75f, 19f)
                curveTo(3.31f, 19f, 3f, 19.36f, 3f, 19.75f)
                curveToRelative(0f, 0.15f, 0.05f, 0.31f, 0.15f, 0.45f)
                curveToRelative(0.82f, 1.1f, 2.13f, 1.8f, 3.6f, 1.8f)
                horizontalLineToRelative(9.5f)
                curveToRelative(1.47f, 0f, 2.78f, -0.7f, 3.6f, -1.8f)
                curveToRelative(0.1f, -0.14f, 0.15f, -0.3f, 0.15f, -0.45f)
                curveTo(20f, 19.36f, 19.68f, 19f, 19.24f, 19f)
                close()
                moveTo(14f, 20.5f)
                horizontalLineTo(8.6f)
                lineToRelative(2.9f, -3.5f)
                lineToRelative(-1f, -3.3f)
