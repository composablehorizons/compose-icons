...
val MaterialIcons.Outlined.Miscellaneous_services: ImageVector
    get() {
        if (_Miscellaneous_services != null) return _Miscellaneous_services!!
        
        _Miscellaneous_services = ImageVector.Builder(
            ...
            group {
                group {
                    path(
                        ...
                        curveTo(10.53f, 2.13f, 10.38f, 2f, 10.21f, 2f)
                        horizontalLineToRelative(-2.8f)
                        curveTo(7.24f, 2f, 7.09f, 2.13f, 7.06f, 2.3f)
                        lineTo(6.8f, 4.15f)
                        curveTo(6.38f, 4.33f, 5.98f, 4.56f, 5.62f, 4.84f)
                        lineToRelative(-1.74f, -0.7f)
                        curveToRelative(-0.16f, -0.06f, -0.34f, 0f, -0.43f, 0.15f)
                        lineToRelative(-1.4f, 2.42f)
                        curveTo(1.96f, 6.86f, 2f, 7.05f, 2.13f, 7.16f)
                        lineToRelative(1.48f, 1.16f)
                        curveTo(3.58f, 8.54f, 3.56f, 8.77f, 3.56f, 9f)
                        reflectiveCurveToRelative(0.02f, 0.46f, 0.05f, 0.69f)
                        lineToRelative(-1.48f, 1.16f)
                        curveTo(2f, 10.96f, 1.96f, 11.15f, 2.05f, 11.3f)
                        lineToRelative(1.4f, 2.42f)
                        curveToRelative(0.09f, 0.15f, 0.27f, 0.21f, 0.43f, 0.15f)
                        lineToRelative(1.74f, -0.7f)
                        curveToRelative(0.36f, 0.28f, 0.75f, 0.51f, 1.18f, 0.69f)
                        lineToRelative(0.26f, 1.85f)
                        curveTo(7.09f, 15.87f, 7.24f, 16f, 7.41f, 16f)
                        horizontalLineToRelative(2.8f)
                        curveToRelative(0.17f, 0f, 0.32f, -0.13f, 0.35f, -0.3f)
                        lineToRelative(0.26f, -1.85f)
                        ...
                        curveTo(10.81f, 10.1f, 9.91f, 11f, 8.81f, 11f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
                        ...
                        curveTo(18.73f, 13.08f, 18.63f, 13f, 18.53f, 13f)
                        horizontalLineToRelative(-1.79f)
                        curveToRelative(-0.11f, 0f, -0.21f, 0.08f, -0.22f, 0.19f)
                        lineToRelative(-0.17f, 1.18f)
                        curveToRelative(-0.27f, 0.12f, -0.53f, 0.26f, -0.76f, 0.44f)
                        lineToRelative(-1.11f, -0.45f)
                        curveToRelative(-0.1f, -0.04f, -0.22f, 0f, -0.28f, 0.1f)
                        lineToRelative(-0.9f, 1.55f)
                        curveToRelative(-0.05f, 0.1f, -0.04f, 0.22f, 0.05f, 0.29f)
                        lineToRelative(0.95f, 0.74f)
                        curveToRelative(-0.02f, 0.14f, -0.03f, 0.29f, -0.03f, 0.44f)
                        curveToRelative(0f, 0.15f, 0.01f, 0.3f, 0.03f, 0.44f)
                        lineToRelative(-0.95f, 0.74f)
                        curveToRelative(-0.08f, 0.07f, -0.11f, 0.19f, -0.05f, 0.29f)
                        lineToRelative(0.9f, 1.55f)
                        curveToRelative(0.05f, 0.1f, 0.17f, 0.13f, 0.28f, 0.1f)
                        ...
                        curveToRelative(0.1f, 0.04f, 0.22f, 0f, 0.28f, -0.1f)
                        lineToRelative(0.9f, -1.55f)
                        curveTo(22.03f, 18.86f, 22f, 18.74f, 21.92f, 18.67f)
                        close()
                        moveTo(17.63f, 18.83f)
                        curveToRelative(-0.74f, 0f, -1.35f, -0.6f, -1.35f, -1.35f)
        ...
        return _Miscellaneous_services!!
    }

private var _Miscellaneous_services: ImageVector? = null
