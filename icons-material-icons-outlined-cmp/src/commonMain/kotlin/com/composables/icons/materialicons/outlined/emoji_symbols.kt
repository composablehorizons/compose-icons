...
val MaterialIcons.Outlined.Emoji_symbols: ImageVector
    get() {
            ...
            group {
                ...
                group {
                    ...
                    path(
                        ...
                        moveTo(12.403649f, 20.18185f)
                        lineTo(20.181747f, 12.403751f)
                        lineTo(21.595947f, 13.817951f)
                        lineTo(13.817849f, 21.59605f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
