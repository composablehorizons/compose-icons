...
val MaterialIcons.Outlined.Timer_3: ImageVector
    get() {
        ...
        _Timer_3 = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(0f, -0.55f, -0.09f, -1.04f, -0.28f, -1.46f)
                ...
                curveToRelative(-0.55f, 0f, -1.06f, 0.08f, -1.52f, 0.24f)
                ...
                curveToRelative(0f, -0.26f, 0.05f, -0.49f, 0.14f, -0.69f)
                ...
                curveToRelative(0.61f, 0f, 1.06f, 0.16f, 1.36f, 0.47f)
                curveToRelative(0.3f, 0.31f, 0.44f, 0.75f, 0.44f, 1.32f)
                curveToRelative(0f, 0.27f, -0.04f, 0.52f, -0.12f, 0.74f)
                ...
                curveToRelative(0.34f, 0f, 0.64f, 0.04f, 0.91f, 0.11f)
                ...
                curveToRelative(0f, 0.62f, -0.18f, 1.09f, -0.53f, 1.42f)
                curveToRelative(-0.35f, 0.33f, -0.84f, 0.49f, -1.45f, 0.49f)
                curveToRelative(-0.29f, 0f, -0.56f, -0.04f, -0.8f, -0.13f)
                ...
                curveToRelative(0f, 0.55f, 0.11f, 1.03f, 0.32f, 1.45f)
                ...
                curveToRelative(0.57f, 0f, 1.09f, -0.08f, 1.58f, -0.23f)
                ...
                curveToRelative(0f, -0.29f, -0.04f, -0.58f, -0.11f, -0.86f)
                curveToRelative(-0.08f, -0.25f, -0.19f, -0.51f, -0.35f, -0.76f)
                close()
                moveToRelative(9.26f, 1.4f)
