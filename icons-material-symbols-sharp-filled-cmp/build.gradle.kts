...
val publishArtifactId = "icons-material-symbols-sharp-filled-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesMaterial Symbols sharp-filled"
            isStatic = true
        }
    }
    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                api(project(":icons-material-symbols-cmp"))
            }
        }
    }
}
...
android {
    namespace = "com.composables.icons.materialsymbols.sharpfilled"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Symbols sharp-filled")
        description.set("Compose Icons Material Symbols sharp-filled for Compose Multiplatform.")
        url.set(projectUrl)
