...
val MaterialSymbols.SharpFilled.Festival: ImageVector
    get() {
        ...
        _Festival = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(80f, 880f)
                quadToRelative(29f, -74f, 38.5f, -152.5f)
                reflectiveQuadTo(130f, 570f)
                quadToRelative(-39f, -15f, -64.5f, -50f)
                reflectiveQuadTo(40f, 440f)
                verticalLineToRelative(-80f)
                quadToRelative(115f, -38f, 234.5f, -116f)
                reflectiveQuadTo(480f, 80f)
                quadToRelative(86f, 86f, 205.5f, 164f)
                reflectiveQuadTo(920f, 360f)
                verticalLineToRelative(80f)
                quadToRelative(0f, 45f, -25.5f, 80f)
                reflectiveQuadTo(830f, 570f)
                quadToRelative(2f, 79f, 11.5f, 157.5f)
                reflectiveQuadTo(880f, 880f)
                horizontalLineTo(80f)
                close()
                moveToRelative(156f, -520f)
                horizontalLineToRelative(488f)
                quadToRelative(-78f, -44f, -140.5f, -90.5f)
                reflectiveQuadTo(480f, 188f)
                quadToRelative(-41f, 35f, -103.5f, 81.5f)
                ...
                quadToRelative(-9f, -5f, -18f, -10.5f)
                reflectiveQuadTo(280f, 538f)
                quadToRelative(-15f, 15f, -32.5f, 24.5f)
                reflectiveQuadTo(210f, 577f)
                ...
                quadToRelative(-26f, -2f, -47.5f, -12.5f)
                ...
                quadToRelative(-8f, 8f, -17f, 13.5f)
