...
val MaterialSymbols.RoundedFilled.Rule_folder: ImageVector
    get() {
        ...
        _Rule_folder = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(153f, -258f)
                lineToRelative(-29f, -29f)
                quadToRelative(-12f, -12f, -28f, -11.5f)
                reflectiveQuadTo(228f, 514f)
                ...
                reflectiveQuadTo(426f, 429f)
                lineTo(313f, 542f)
                close()
                moveToRelative(327f, -63f)
