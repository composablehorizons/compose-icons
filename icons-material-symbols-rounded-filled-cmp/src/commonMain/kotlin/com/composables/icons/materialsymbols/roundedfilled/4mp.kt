...
val MaterialSymbols.RoundedFilled.`4mp`: ImageVector
    get() {
        ...
        _4mp = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(13f, 0f, 21.5f, -8.5f)
                reflectiveQuadTo(600f, 370f)
                quadToRelative(0f, -13f, -8.5f, -21.5f)
                reflectiveQuadTo(570f, 340f)
                horizontalLineToRelative(-10f)
                verticalLineToRelative(-90f)
                quadToRelative(0f, -13f, -8.5f, -21.5f)
                reflectiveQuadTo(530f, 220f)
                quadToRelative(-13f, 0f, -21.5f, 8.5f)
                reflectiveQuadTo(500f, 250f)
                verticalLineToRelative(90f)
