...
val MaterialSymbols.RoundedFilled.Cognition: ImageVector
    get() {
        ...
        _Cognition = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(0f, 19f, 6.5f, 37.5f)
                reflectiveQuadTo(451f, 505f)
                quadToRelative(16f, 14f, 32f, 11.5f)
                reflectiveQuadToRelative(26f, -13.5f)
                quadToRelative(10f, -11f, 11.5f, -26.5f)
                reflectiveQuadTo(508f, 448f)
                ...
                reflectiveQuadToRelative(13.5f, -34f)
                quadToRelative(8f, -15f, 8f, -31.5f)
                reflectiveQuadTo(394f, 280f)
                quadToRelative(-12f, -12f, -29f, -11.5f)
                reflectiveQuadTo(339f, 283f)
                quadToRelative(-20f, 28f, -30f, 60f)
