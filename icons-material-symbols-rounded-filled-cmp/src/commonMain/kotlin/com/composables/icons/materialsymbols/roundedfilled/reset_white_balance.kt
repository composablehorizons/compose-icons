...
val MaterialSymbols.RoundedFilled.Reset_white_balance: ImageVector
    get() {
        ...
        _Reset_white_balance = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(13f, 0f, 21.5f, 8.5f)
                reflectiveQuadTo(840f, 630f)
                quadToRelative(0f, 13f, -8.5f, 21.5f)
                reflectiveQuadTo(810f, 660f)
                horizontalLineToRelative(-60f)
                close()
                ...
                quadToRelative(13f, 0f, 21.5f, 8.5f)
                reflectiveQuadTo(880f, 530f)
                quadToRelative(0f, 13f, -8.5f, 21.5f)
                reflectiveQuadTo(850f, 560f)
                horizontalLineTo(750f)
                close()
                moveTo(480f, 200f)
