...
val MaterialSymbols.RoundedFilled.Fire_truck: ImageVector
    get() {
        ...
        _Fire_truck = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(40f, 230f)
                quadToRelative(0f, -13f, 8.5f, -21.5f)
                reflectiveQuadTo(70f, 200f)
                horizontalLineToRelative(340f)
                quadToRelative(13f, 0f, 21.5f, 8.5f)
                reflectiveQuadTo(440f, 230f)
                quadToRelative(0f, 13f, -8.5f, 21.5f)
                reflectiveQuadTo(410f, 260f)
                ...
                horizontalLineTo(70f)
                quadToRelative(-13f, 0f, -21.5f, -8.5f)
                reflectiveQuadTo(40f, 370f)
                quadToRelative(0f, -13f, 8.5f, -21.5f)
                reflectiveQuadTo(70f, 340f)
                horizontalLineToRelative(10f)
                close()
