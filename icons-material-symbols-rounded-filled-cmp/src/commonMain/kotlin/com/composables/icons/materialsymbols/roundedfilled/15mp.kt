...
val MaterialSymbols.RoundedFilled.`15mp`: ImageVector
    get() {
        if (_15mp != null) return _15mp!!
        
        _15mp = ImageVector.Builder(
            name = "15mp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            ...
            path(
                ...
                horizontalLineToRelative(90f)
                quadToRelative(13f, 0f, 21.5f, -8.5f)
                reflectiveQuadTo(660f, 250f)
                quadToRelative(0f, -13f, -8.5f, -21.5f)
                reflectiveQuadTo(630f, 220f)
...
private var _15mp: ImageVector? = null
