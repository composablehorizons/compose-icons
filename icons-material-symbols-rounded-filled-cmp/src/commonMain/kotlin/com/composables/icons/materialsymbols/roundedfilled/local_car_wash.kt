...
val MaterialSymbols.RoundedFilled.Local_car_wash: ImageVector
    get() {
        ...
        _Local_car_wash = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(0f, -18f, 8f, -32f)
                reflectiveQuadToRelative(37f, -49f)
                quadToRelative(6f, -8f, 15f, -8f)
                reflectiveQuadToRelative(15f, 8f)
                quadToRelative(29f, 35f, 37f, 49f)
