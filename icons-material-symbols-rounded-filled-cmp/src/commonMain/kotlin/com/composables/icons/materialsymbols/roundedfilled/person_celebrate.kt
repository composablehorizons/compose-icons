...
val MaterialSymbols.RoundedFilled.Person_celebrate: ImageVector
    get() {
        ...
        _Person_celebrate = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-51f, -4f, -100f, -11f)
                reflectiveQuadToRelative(-98f, -18f)
                quadToRelative(-17f, -4f, -27f, -19f)
                ...
                reflectiveQuadTo(777f, 531f)
                quadToRelative(18f, -4f, 33f, 4f)
                reflectiveQuadToRelative(20f, 25f)
                quadToRelative(5f, 17f, -5.5f, 32f)
                reflectiveQuadTo(797f, 611f)
