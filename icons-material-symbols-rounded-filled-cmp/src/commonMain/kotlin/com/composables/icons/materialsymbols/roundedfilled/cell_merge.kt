...
val MaterialSymbols.RoundedFilled.Cell_merge: ImageVector
    get() {
        ...
        _Cell_merge = ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(29f, 28f)
                quadToRelative(12f, 12f, 12f, 28.5f)
                reflectiveQuadTo(702f, 605f)
                quadToRelative(-12f, 12f, -28.5f, 12f)
                reflectiveQuadTo(645f, 605f)
                close()
                moveToRelative(-386f, 0f)
                quadToRelative(-12f, -12f, -12.5f, -28.5f)
                reflectiveQuadTo(258f, 548f)
                lineToRelative(29f, -28f)
