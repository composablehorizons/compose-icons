...
val MaterialSymbols.RoundedFilled.Nest_sunblock: ImageVector
    get() {
        ...
        _Nest_sunblock = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(267f, -450f)
                lineToRelative(-29f, 29f)
                quadToRelative(-12f, 12f, -28.5f, 12f)
                reflectiveQuadTo(261f, 339f)
                ...
                quadToRelative(12f, 12f, 12f, 28.5f)
                reflectiveQuadTo(347f, 310f)
                close()
                moveToRelative(-57f, 396f)
                ...
                quadToRelative(-12f, 12f, -28.5f, 12f)
                reflectiveQuadTo(290f, 706f)
                close()
                moveToRelative(270f, -266f)
