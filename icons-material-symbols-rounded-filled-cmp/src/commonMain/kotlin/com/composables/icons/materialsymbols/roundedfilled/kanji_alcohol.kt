...
val MaterialSymbols.RoundedFilled.Kanji_alcohol: ImageVector
    get() {
        ...
        _Kanji_alcohol = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-11f, 13f, -27f, 15f)
                reflectiveQuadToRelative(-29f, -9f)
                lineToRelative(-38f, -30f)
