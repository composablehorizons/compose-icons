...
val MaterialSymbols.RoundedFilled.Android_cell_dual_4_bar_plus: ImageVector
    get() {
        ...
        _Android_cell_dual_4_bar_plus = ImageVector.Builder(
            ...
            path(
                ...
                verticalLineToRelative(-40f)
                quadToRelative(0f, -26f, 19f, -44f)
                reflectiveQuadToRelative(45f, -16f)
                quadToRelative(-2f, 10f, -3f, 19.5f)
                reflectiveQuadToRelative(-1f, 20.5f)
                quadToRelative(0f, 31f, 8.5f, 58.5f)
                reflectiveQuadTo(633f, 790f)
                quadToRelative(-7f, 5f, -15.5f, 7.5f)
