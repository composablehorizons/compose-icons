...
val MaterialSymbols.RoundedFilled.Yoshoku: ImageVector
    get() {
        ...
        _Yoshoku = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(45f, -16f, 95f, -21.5f)
                reflectiveQuadToRelative(99f, -6.5f)
                quadToRelative(20f, 0f, 34.5f, 14.5f)
                reflectiveQuadTo(880f, 90f)
                quadToRelative(-1f, 42f, -4.5f, 85.5f)
                ...
                quadToRelative(9f, 0f, 17.5f, -4.5f)
                reflectiveQuadTo(432f, 702f)
                lineToRelative(100f, -140f)
                ...
                lineToRelative(-35f, -28f)
                quadToRelative(-11f, -8f, -11f, -21.5f)
