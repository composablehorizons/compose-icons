...
val MaterialSymbols.RoundedFilled.Sentiment_frustrated: ImageVector
    get() {
        ...
        _Sentiment_frustrated = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(7f, -338f)
                quadToRelative(8f, -11f, 6f, -23f)
                reflectiveQuadToRelative(-13f, -19f)
                quadToRelative(-11f, -7f, -23f, -4.5f)
                reflectiveQuadTo(347f, 289f)
                quadToRelative(-18f, 23f, -41f, 40f)
                reflectiveQuadToRelative(-49f, 30f)
                quadToRelative(-11f, 6f, -16.5f, 17.5f)
                reflectiveQuadTo(240f, 400f)
                quadToRelative(5f, 12f, 16.5f, 16f)
                reflectiveQuadToRelative(23.5f, -1f)
                quadToRelative(35f, -17f, 64.5f, -39.5f)
                reflectiveQuadTo(397f, 322f)
                close()
                moveToRelative(166f, 0f)
                quadToRelative(23f, 30f, 52f, 52.5f)
                reflectiveQuadToRelative(63f, 39.5f)
                quadToRelative(12f, 6f, 24.5f, 2f)
                reflectiveQuadToRelative(17.5f, -16f)
                quadToRelative(5f, -12f, -0.5f, -24f)
                reflectiveQuadTo(702f, 359f)
                quadToRelative(-26f, -12f, -49f, -29f)
                reflectiveQuadToRelative(-40f, -40f)
                quadToRelative(-8f, -11f, -20f, -14f)
                reflectiveQuadToRelative(-23f, 4f)
                quadToRelative(-11f, 7f, -13f, 19f)
                reflectiveQuadToRelative(6f, 23f)
                close()
                moveTo(480f, 880f)
