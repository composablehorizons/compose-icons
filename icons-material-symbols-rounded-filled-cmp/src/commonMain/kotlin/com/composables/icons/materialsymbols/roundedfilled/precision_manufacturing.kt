...
val MaterialSymbols.RoundedFilled.Precision_manufacturing: ImageVector
    get() {
        ...
        _Precision_manufacturing = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(159f, 780f)
                quadToRelative(0f, -25f, 17.5f, -42.5f)
                reflectiveQuadTo(219f, 720f)
                ...
                quadToRelative(25f, 0f, 42.5f, 17.5f)
                reflectiveQuadTo(679f, 780f)
                quadToRelative(0f, 25f, -17.5f, 42.5f)
                reflectiveQuadTo(619f, 840f)
