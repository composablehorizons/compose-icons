...
val MaterialSymbols.RoundedFilled.Power_settings_new: ImageVector
    get() {
        ...
        _Power_settings_new = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(0f, -69f, 25f, -131f)
                reflectiveQuadToRelative(70f, -112f)
                quadToRelative(12f, -14f, 29.5f, -14.5f)
                reflectiveQuadTo(275f, 235f)
                quadToRelative(11f, 11f, 10f, 27.5f)
                reflectiveQuadTo(273f, 292f)
                quadToRelative(-35f, 38f, -54f, 86f)
                reflectiveQuadToRelative(-19f, 102f)
                quadToRelative(0f, 116f, 82f, 198f)
                reflectiveQuadToRelative(198f, 82f)
                quadToRelative(117f, 0f, 198.5f, -82f)
                reflectiveQuadTo(760f, 480f)
                quadToRelative(0f, -54f, -18.5f, -102f)
                reflectiveQuadTo(688f, 292f)
                quadToRelative(-12f, -13f, -13f, -29.5f)
                reflectiveQuadToRelative(10f, -27.5f)
                quadToRelative(13f, -13f, 31f, -12.5f)
                reflectiveQuadToRelative(30f, 14.5f)
                quadToRelative(45f, 50f, 69.5f, 112f)
