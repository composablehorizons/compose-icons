...
val MaterialSymbols.RoundedFilled.Medical_mask: ImageVector
    get() {
        ...
        _Medical_mask = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(480f, 760f)
                quadToRelative(-64f, 0f, -127f, -5.5f)
                reflectiveQuadTo(227f, 740f)
                quadToRelative(-29f, -5f, -48f, -27.5f)
                ...
                reflectiveQuadToRelative(55f, -23.5f)
                quadToRelative(29f, 0f, 58.5f, 5.5f)
                reflectiveQuadTo(355f, 213f)
                quadToRelative(32f, 3f, 62.5f, 4f)
                reflectiveQuadToRelative(62.5f, 1f)
                quadToRelative(32f, 0f, 62.5f, -1f)
                reflectiveQuadToRelative(62.5f, -4f)
                ...
                quadToRelative(-63f, 10f, -126f, 15f)
                reflectiveQuadToRelative(-126f, 5f)
                close()
