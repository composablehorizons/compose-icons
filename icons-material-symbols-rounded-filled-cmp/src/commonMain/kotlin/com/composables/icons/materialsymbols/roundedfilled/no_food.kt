...
val MaterialSymbols.RoundedFilled.No_food: ImageVector
    get() {
        ...
        _No_food = ImageVector.Builder(
            ...
            path(
                ...
                horizontalLineTo(80f)
                close()
                moveToRelative(767f, -220f)
                quadToRelative(-11f, 4f, -22f, 2f)
                reflectiveQuadToRelative(-20f, -11f)
                lineTo(478f, 364f)
                quadToRelative(-10f, -10f, -15.5f, -21.5f)
                reflectiveQuadTo(455f, 317f)
                lineToRelative(-9f, -72f)
                quadToRelative(-2f, -18f, 9.5f, -31.5f)
                reflectiveQuadTo(485f, 200f)
                ...
                quadToRelative(-2f, 13f, -8.5f, 21.5f)
                reflectiveQuadTo(847f, 700f)
                close()
            }
        }.build()
