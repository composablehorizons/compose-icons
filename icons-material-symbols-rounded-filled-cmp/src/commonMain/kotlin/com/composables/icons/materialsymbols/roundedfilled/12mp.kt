...
val MaterialSymbols.RoundedFilled.`12mp`: ImageVector
    get() {
        if (_12mp != null) return _12mp!!
        
        _12mp = ImageVector.Builder(
            name = "12mp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            ...
            path(
                ...
                quadToRelative(13f, 0f, 21.5f, -8.5f)
                reflectiveQuadTo(660f, 430f)
                quadToRelative(0f, -13f, -8.5f, -21.5f)
                reflectiveQuadTo(630f, 400f)
                horizontalLineToRelative(-90f)
                close()
                moveTo(200f, 840f)
...
private var _12mp: ImageVector? = null
