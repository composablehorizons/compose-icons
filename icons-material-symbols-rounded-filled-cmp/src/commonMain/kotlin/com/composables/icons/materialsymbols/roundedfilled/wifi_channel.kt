...
val MaterialSymbols.RoundedFilled.Wifi_channel: ImageVector
    get() {
        ...
        _Wifi_channel = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(13f, -105f, 31f, -183.5f)
                reflectiveQuadTo(535f, 227f)
                quadToRelative(22f, -54f, 48f, -80.5f)
                reflectiveQuadToRelative(57f, -26.5f)
                ...
                quadToRelative(-11f, 0f, -26f, 16f)
                reflectiveQuadToRelative(-30f, 44f)
                quadToRelative(-15f, 28f, -29f, 63.5f)
                ...
                quadToRelative(23f, -30f, 48f, -45f)
                reflectiveQuadToRelative(52f, -15f)
                quadToRelative(26f, 0f, 51.5f, 15.5f)
                ...
                quadToRelative(-14f, 11f, -27.5f, 43f)
                reflectiveQuadTo(586f, 327f)
                quadToRelative(-13f, 50f, -25f, 114f)
                reflectiveQuadToRelative(-21f, 139f)
                close()
            }
        }.build()
