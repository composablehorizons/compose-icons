...
val MaterialSymbols.RoundedFilled.Screen_lock_rotation: ImageVector
    get() {
        ...
        _Screen_lock_rotation = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(10f, -10f, 21.5f, -14.5f)
                reflectiveQuadTo(450f, 113f)
                quadToRelative(13f, 0f, 24.5f, 4.5f)
                reflectiveQuadTo(496f, 132f)
