...
val MaterialSymbols.RoundedFilled.Partner_exchange: ImageVector
    get() {
        ...
        _Partner_exchange = ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(83.13f, -84f)
                quadToRelative(11.87f, -12f, 28.23f, -12f)
                quadToRelative(16.37f, 0f, 28.64f, 12f)
                lineToRelative(83f, 84f)
                quadToRelative(12f, 12f, 12f, 28f)
                reflectiveQuadToRelative(-12f, 28f)
                lineToRelative(-83.12f, 84f)
                quadToRelative(-11.88f, 12f, -28.24f, 12f)
                quadToRelative(-16.37f, 0f, -28.64f, -12f)
                close()
                moveTo(80f, 800f)
