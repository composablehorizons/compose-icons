...
val MaterialSymbols.RoundedFilled.Directions_bike: ImageVector
    get() {
        ...
        _Directions_bike = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(21f, 21f, 47f, 35.5f)
                reflectiveQuadToRelative(58f, 20.5f)
                ...
                quadToRelative(-49f, -7f, -90f, -28f)
                reflectiveQuadToRelative(-73f, -53f)
