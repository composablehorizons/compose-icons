...
val MaterialSymbols.RoundedFilled.Wifi_calling_bar_3: ImageVector
    get() {
        ...
        _Wifi_calling_bar_3 = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(583f, 323f)
                quadToRelative(-11f, 7f, -23.5f, 6.5f)
                reflectiveQuadTo(539f, 321f)
                ...
                reflectiveQuadTo(821f, 235f)
                quadToRelative(-35f, -27f, -75.5f, -41f)
                reflectiveQuadTo(660f, 180f)
                close()
            }
        }.build()
