...
val MaterialSymbols.RoundedFilled.Detector_co: ImageVector
    get() {
        if (_Detector_co != null) return _Detector_co!!
        
        _Detector_co = ImageVector.Builder(
            name = "detector_co",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            ...
            path(
                ...
                quadToRelative(-25f, 0f, -42.5f, -17.5f)
                reflectiveQuadTo(560f, 780f)
                quadToRelative(0f, -25f, 17.5f, -42.5f)
                reflectiveQuadTo(620f, 720f)
                quadToRelative(25f, 0f, 42.5f, 17.5f)
                reflectiveQuadTo(680f, 780f)
                quadToRelative(0f, 25f, -17.5f, 42.5f)
                reflectiveQuadTo(620f, 840f)
                close()
                moveToRelative(140f, -120f)
                quadToRelative(-25f, 0f, -42.5f, -17.5f)
                reflectiveQuadTo(700f, 660f)
                quadToRelative(0f, -25f, 17.5f, -42.5f)
                ...
                close()
                moveToRelative(136f, -320f)
                quadToRelative(-26f, 0f, -47f, -15.5f)
                reflectiveQuadTo(260f, 344f)
...
private var _Detector_co: ImageVector? = null
