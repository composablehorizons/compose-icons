...
val MaterialSymbols.RoundedFilled.Salinity: ImageVector
    get() {
        if (_Salinity != null) return _Salinity!!
        
        _Salinity = ImageVector.Builder(
            name = "salinity",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            ...
            path(
                ...
                moveTo(290f, 370f)
                quadToRelative(-17f, 0f, -28.5f, -11.5f)
                reflectiveQuadTo(250f, 330f)
                quadToRelative(0f, -17f, 11.5f, -28.5f)
                reflectiveQuadTo(290f, 290f)
                quadToRelative(17f, 0f, 28.5f, 11.5f)
                reflectiveQuadTo(330f, 330f)
                quadToRelative(0f, 17f, -11.5f, 28.5f)
                reflectiveQuadTo(290f, 370f)
                close()
                moveToRelative(380f, 0f)
                quadToRelative(-17f, 0f, -28.5f, -11.5f)
                reflectiveQuadTo(630f, 330f)
                quadToRelative(0f, -17f, 11.5f, -28.5f)
                reflectiveQuadTo(670f, 290f)
                quadToRelative(17f, 0f, 28.5f, 11.5f)
                reflectiveQuadTo(710f, 330f)
                quadToRelative(0f, 17f, -11.5f, 28.5f)
                reflectiveQuadTo(670f, 370f)
                close()
                moveToRelative(-190f, -10f)
                quadToRelative(-17f, 0f, -28.5f, -11.5f)
                ...
                quadToRelative(-126f, 0f, -214f, -80f)
                reflectiveQuadTo(163f, 596f)
                ...
                quadToRelative(-14f, 124f, -102.5f, 204f)
...
private var _Salinity: ImageVector? = null
