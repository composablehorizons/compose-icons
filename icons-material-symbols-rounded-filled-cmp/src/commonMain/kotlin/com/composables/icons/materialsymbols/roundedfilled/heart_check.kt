...
val MaterialSymbols.RoundedFilled.Heart_check: ImageVector
    get() {
        ...
        _Heart_check = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-11f, 10f, -26.5f, 10f)
                reflectiveQuadTo(413f, 817f)
                close()
            }
        }.build()
