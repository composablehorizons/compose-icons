...
val MaterialSymbols.RoundedFilled.Movie_speaker: ImageVector
    get() {
        ...
        _Movie_speaker = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(0f, 22f, -22.5f, 30f)
                reflectiveQuadToRelative(-46.5f, -6f)
                quadToRelative(-13f, -8f, -39f, -17f)
                reflectiveQuadToRelative(-51f, -9f)
                quadToRelative(-37f, 0f, -65.5f, 10f)
                reflectiveQuadTo(606f, 401f)
                lineTo(487f, 520f)
