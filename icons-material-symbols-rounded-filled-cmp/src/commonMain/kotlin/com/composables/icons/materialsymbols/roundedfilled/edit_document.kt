...
val MaterialSymbols.RoundedFilled.Edit_document: ImageVector
    get() {
        ...
        _Edit_document = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(0f, 11f, -6.5f, 19f)
                reflectiveQuadTo(777f, 447f)
                quadToRelative(-16f, 6f, -30.5f, 15.5f)
                reflectiveQuadTo(720f, 484f)
                lineTo(504f, 700f)
