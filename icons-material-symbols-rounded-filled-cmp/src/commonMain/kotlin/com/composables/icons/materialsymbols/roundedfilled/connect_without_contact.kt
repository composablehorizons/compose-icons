...
val MaterialSymbols.RoundedFilled.Connect_without_contact: ImageVector
    get() {
        ...
        _Connect_without_contact = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-39f, -13f, -70f, -39.5f)
                reflectiveQuadTo(521f, 687f)
                quadToRelative(-8f, -15f, 0f, -30f)
                reflectiveQuadToRelative(24f, -22f)
                quadToRelative(14f, -6f, 28f, 1f)
                reflectiveQuadToRelative(22f, 21f)
                quadToRelative(16f, 29f, 44f, 46f)
                ...
                horizontalLineToRelative(120f)
                quadToRelative(33f, 0f, 61f, -17f)
                reflectiveQuadToRelative(44f, -46f)
                quadToRelative(8f, -14f, 22f, -22.5f)
                reflectiveQuadToRelative(29f, -3.5f)
                quadToRelative(17f, 5f, 26f, 19f)
                reflectiveQuadToRelative(3f, 29f)
                quadToRelative(-17f, 41f, -50f, 69f)
                reflectiveQuadToRelative(-75f, 42f)
                verticalLineToRelative(50f)
                quadToRelative(0f, 17f, -11.5f, 28.5f)
