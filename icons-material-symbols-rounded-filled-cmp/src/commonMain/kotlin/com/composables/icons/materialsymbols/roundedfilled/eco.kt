...
val MaterialSymbols.RoundedFilled.Eco: ImageVector
    get() {
        ...
        _Eco = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(70f, -70f, 173.5f, -98f)
                reflectiveQuadTo(675f, 200f)
                quadToRelative(26f, 1f, 48f, 11.5f)
                reflectiveQuadToRelative(39f, 27.5f)
                quadToRelative(17f, 17f, 27f, 39.5f)
                reflectiveQuadToRelative(12f, 48.5f)
                quadToRelative(6f, 180f, -21f, 281f)
                reflectiveQuadToRelative(-96f, 170f)
