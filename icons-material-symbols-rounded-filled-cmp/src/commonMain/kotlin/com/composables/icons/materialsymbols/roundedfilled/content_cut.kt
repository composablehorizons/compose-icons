...
val MaterialSymbols.RoundedFilled.Content_cut: ImageVector
    get() {
        ...
        _Content_cut = ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(438f, 438f)
                quadToRelative(27f, 27f, 12f, 61.5f)
                reflectiveQuadTo(783f, 840f)
                quadToRelative(-11f, 0f, -21.5f, -4.5f)
                reflectiveQuadTo(743f, 823f)
                lineTo(480f, 560f)
                close()
                ...
                reflectiveQuadTo(783f, 120f)
                quadToRelative(38f, 0f, 52.5f, 35f)
                reflectiveQuadTo(823f, 217f)
                lineTo(600f, 440f)
                close()
                moveTo(240f, 320f)
