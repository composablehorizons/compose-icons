...
val MaterialSymbols.RoundedFilled.Ad_group_off: ImageVector
    get() {
        ...
        _Ad_group_off = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(668f, -165f)
                lineTo(387f, 274f)
                quadToRelative(-10f, -10f, -5f, -22f)
                reflectiveQuadToRelative(19f, -12f)
                horizontalLineToRelative(399f)
                verticalLineToRelative(-80f)
                lineToRelative(-479f, -24f)
                quadToRelative(-19f, -1f, -23.5f, -19f)
                reflectiveQuadToRelative(15.5f, -32f)
                quadToRelative(3f, -2f, 7f, -3.5f)
