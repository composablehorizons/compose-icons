...
val MaterialSymbols.RoundedFilled.Eye_tracking: ImageVector
    get() {
        ...
        _Eye_tracking = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(480f, 740f)
                quadToRelative(-106f, 0f, -196f, -56f)
                reflectiveQuadTo(143f, 531f)
                ...
                quadToRelative(51f, -97f, 141f, -153f)
                reflectiveQuadToRelative(196f, -56f)
                quadToRelative(106f, 0f, 196f, 56f)
                reflectiveQuadToRelative(141f, 153f)
                quadToRelative(6f, 12f, 9f, 24.5f)
