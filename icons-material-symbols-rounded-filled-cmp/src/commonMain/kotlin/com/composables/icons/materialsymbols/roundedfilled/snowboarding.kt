...
val MaterialSymbols.RoundedFilled.Snowboarding: ImageVector
    get() {
        ...
        _Snowboarding = ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(-32f, -140f)
                quadToRelative(-4f, -15f, -1f, -30.5f)
                ...
                lineToRelative(121f, 97f)
                quadToRelative(6f, 5f, 9f, 11f)
                reflectiveQuadToRelative(5f, 14f)
                lineToRelative(38f, 233f)
