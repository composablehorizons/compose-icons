...
val MaterialSymbols.RoundedFilled.File_png: ImageVector
    get() {
        ...
        _File_png = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(200f, -16f)
                lineToRelative(32f, 78f)
                quadToRelative(4f, 8f, 11.5f, 13f)
