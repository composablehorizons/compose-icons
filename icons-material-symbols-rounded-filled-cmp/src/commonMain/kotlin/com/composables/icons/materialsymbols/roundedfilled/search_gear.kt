...
val MaterialSymbols.RoundedFilled.Search_gear: ImageVector
    get() {
        ...
        _Search_gear = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(379f, 564f)
                lineToRelative(29f, -9f)
                quadToRelative(13f, -4f, 25.11f, 1f)
                reflectiveQuadTo(452f, 572f)
                lineToRelative(8.73f, 14f)
                quadToRelative(7.27f, 12f, 5.27f, 26f)
                reflectiveQuadToRelative(-13f, 23f)
                lineToRelative(-22f, 19f)
                quadToRelative(2f, 13f, 2f, 26f)
                reflectiveQuadToRelative(-2f, 26f)
                ...
                lineToRelative(-29f, -9f)
                quadToRelative(-11f, 8f, -21.5f, 13.5f)
                reflectiveQuadTo(335f, 820f)
                lineToRelative(-6f, 29f)
                quadToRelative(-3f, 14f, -13.5f, 22.5f)
                reflectiveQuadTo(291f, 880f)
                horizontalLineToRelative(-16f)
                quadToRelative(-14f, 0f, -24.5f, -9f)
                reflectiveQuadTo(237f, 848f)
                lineToRelative(-6f, -28f)
                quadToRelative(-12f, -5f, -22.5f, -10.5f)
                reflectiveQuadTo(187f, 796f)
                close()
            }
        }.build()
