...
val MaterialSymbols.RoundedFilled.Battery_profile: ImageVector
    get() {
        ...
        _Battery_profile = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(646f, 402f)
                quadToRelative(-103f, 13f, -174f, 91f)
                reflectiveQuadToRelative(-71f, 186f)
                quadToRelative(0f, 42f, 11.5f, 81f)
                reflectiveQuadToRelative(34.5f, 73f)
                quadToRelative(10f, 15f, 2.5f, 31f)
                reflectiveQuadTo(425f, 880f)
