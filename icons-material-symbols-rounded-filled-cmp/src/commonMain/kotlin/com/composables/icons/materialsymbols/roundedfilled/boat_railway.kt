...
val MaterialSymbols.RoundedFilled.Boat_railway: ImageVector
    get() {
        ...
        _Boat_railway = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(9f, 5f, 23f, 12f)
                reflectiveQuadToRelative(22f, 10f)
                quadToRelative(16f, 5f, 21.5f, 19.5f)
                reflectiveQuadTo(420f, 834f)
                quadToRelative(-5f, 15f, -19.5f, 22f)
                reflectiveQuadToRelative(-30.5f, 2f)
                quadToRelative(-11f, -5f, -17.5f, -7.5f)
                reflectiveQuadTo(338f, 844f)
                quadToRelative(-41f, 17f, -83f, 25f)
                reflectiveQuadToRelative(-94f, 10f)
                close()
                moveToRelative(219f, -719f)
                verticalLineToRelative(-40f)
                ...
                lineToRelative(161f, -43f)
                quadToRelative(16f, -5f, 30f, 4f)
                reflectiveQuadToRelative(19f, 25f)
                lineToRelative(8f, 30f)
                quadToRelative(3f, 12f, 0.5f, 23.5f)
                reflectiveQuadTo(488f, 414f)
                quadToRelative(-23f, 29f, -35.5f, 66f)
                reflectiveQuadTo(440f, 559f)
                verticalLineToRelative(117f)
                quadToRelative(0f, 14f, -11.5f, 21.5f)
                reflectiveQuadTo(405f, 699f)
                quadToRelative(-33f, -18f, -54f, -38.5f)
                lineTo(330f, 640f)
                quadToRelative(-19f, 18f, -40.5f, 32.5f)
                reflectiveQuadTo(245f, 698f)
                quadToRelative(-19f, 8f, -37.5f, -2f)
                reflectiveQuadTo(183f, 666f)
                lineToRelative(-70f, -226f)
