...
val MaterialSymbols.RoundedFilled.Variable_add: ImageVector
    get() {
        ...
        _Variable_add = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-49f, -1f, -94f, 17f)
                reflectiveQuadToRelative(-80f, 53f)
                quadToRelative(-35f, 35f, -53f, 79.5f)
                reflectiveQuadTo(560f, 644f)
                quadToRelative(0f, 14f, -9.5f, 25f)
                reflectiveQuadTo(527f, 680f)
