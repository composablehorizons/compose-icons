...
val MaterialSymbols.RoundedFilled.Skateboarding: ImageVector
    get() {
        ...
        _Skateboarding = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(17f, 39f, 50f, 67f)
                ...
                quadToRelative(-58f, -8f, -105.5f, -39.5f)
                reflectiveQuadTo(539f, 358f)
                lineToRelative(-72f, 115f)
                lineToRelative(154f, 95f)
                quadToRelative(9f, 5f, 14f, 14f)
                ...
                lineToRelative(34f, 111f)
                quadToRelative(3f, 10f, 1f, 20f)
