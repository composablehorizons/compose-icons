...
val MaterialSymbols.RoundedFilled.Match_word: ImageVector
    get() {
        ...
        _Match_word = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(40f, 681f)
                verticalLineToRelative(-80f)
                quadToRelative(0f, -17f, 11.5f, -28.5f)
                reflectiveQuadTo(80f, 561f)
                quadToRelative(17f, 0f, 28.5f, 11.5f)
                reflectiveQuadTo(120f, 601f)
                verticalLineToRelative(80f)
                ...
                reflectiveQuadTo(840f, 761f)
                horizontalLineTo(120f)
                close()
                moveToRelative(174f, -152f)
                ...
                quadToRelative(-15f, 0f, -28.5f, 4.5f)
                reflectiveQuadTo(259f, 378f)
                quadToRelative(-9f, 7f, -19.5f, 8f)
                reflectiveQuadToRelative(-19.5f, -6f)
                quadToRelative(-9f, -7f, -11f, -17.5f)
                reflectiveQuadToRelative(6f, -18.5f)
                quadToRelative(18f, -17f, 42.5f, -26f)
                ...
                reflectiveQuadTo(412f, 600f)
                quadToRelative(-13f, 0f, -21.5f, -8.5f)
                reflectiveQuadTo(382f, 570f)
                verticalLineToRelative(-4f)
                horizontalLineToRelative(-3f)
                quadToRelative(-13f, 20f, -35f, 31.5f)
                reflectiveQuadTo(294f, 609f)
                close()
                moveToRelative(22f, -143f)
