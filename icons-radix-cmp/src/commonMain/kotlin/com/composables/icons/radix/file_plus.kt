...
val Radix.FilePlus: ImageVector
    get() {
        ...
        _FilePlus = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(7.5f, 4.75f)
                curveTo(7.77614f, 4.75f, 8f, 4.97386f, 8f, 5.25f)
                verticalLineTo(7f)
                ...
                curveTo(8f, 10.0261f, 7.77614f, 10.25f, 7.5f, 10.25f)
                curveTo(7.22386f, 10.25f, 7f, 10.0261f, 7f, 9.75f)
                verticalLineTo(8f)
                ...
                curveTo(7f, 4.97386f, 7.22386f, 4.75f, 7.5f, 4.75f)
                close()
            }
        }.build()
