...
val Radix.MinusCircled: ImageVector
    get() {
        if (_MinusCircled != null) return _MinusCircled!!
        
        _MinusCircled = ImageVector.Builder(
            name = "minus-circled",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 15f,
        ...
        return _MinusCircled!!
    }

private var _MinusCircled: ImageVector? = null
