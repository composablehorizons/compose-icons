...
val publishArtifactId = "icons-radix-cmp"
...
android {
    namespace = "com.composables.icons.radix"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Radix")
        description.set("Compose Icons Radix for Compose Multiplatform.")
        url.set(projectUrl)
