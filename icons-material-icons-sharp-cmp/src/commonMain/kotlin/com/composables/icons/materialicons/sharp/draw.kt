...
val MaterialIcons.Sharp.Draw: ImageVector
    get() {
        ...
        _Draw = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(-0.48f, 0f, -1f, -0.07f, -1f, -0.07f)
                curveToRelative(0f, -0.34f, 0f, -2.03f, 0f, -2.03f)
                reflectiveCurveTo(13.46f, 19f, 14f, 19f)
                ...
                curveTo(5.76f, 5f, 5f, 5.61f, 5f, 6f)
                horizontalLineTo(3f)
                curveToRelative(0f, -1.65f, 1.7f, -3f, 4f, -3f)
