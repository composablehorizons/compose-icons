...
val MaterialIcons.Sharp.Settings: ImageVector
    get() {
        ...
        _Settings = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(0f, -0.34f, -0.03f, -0.66f, -0.07f, -0.99f)
                lineToRelative(0.01f, 0.02f)
                lineToRelative(2.44f, -1.92f)
                lineToRelative(-2.43f, -4.22f)
                lineToRelative(-2.87f, 1.16f)
                lineToRelative(0.01f, 0.01f)
                curveToRelative(-0.52f, -0.4f, -1.09f, -0.74f, -1.71f, -1f)
                horizontalLineToRelative(0.01f)
                lineTo(14.44f, 2f)
                horizontalLineTo(9.57f)
                lineToRelative(-0.44f, 3.07f)
                horizontalLineToRelative(0.01f)
                curveToRelative(-0.62f, 0.26f, -1.19f, 0.6f, -1.71f, 1f)
                lineToRelative(0.01f, -0.01f)
                ...
                curveToRelative(0f, 0.34f, 0.03f, 0.68f, 0.08f, 1.01f)
                lineToRelative(-0.01f, -0.02f)
