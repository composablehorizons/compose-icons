...
val MaterialIcons.Sharp.Crisis_alert: ImageVector
    get() {
        ...
        _Crisis_alert = ImageVector.Builder(
            ...
            group {
                path(
                    ...
                    moveTo(14.5f, 2.5f)
                    curveToRelative(0f, 1.06f, -0.75f, 3.64f, -1.19f, 5.04f)
                    curveTo(13.13f, 8.11f, 12.6f, 8.5f, 12f, 8.5f)
                    horizontalLineToRelative(0f)
                    curveToRelative(-0.6f, 0f, -1.13f, -0.39f, -1.31f, -0.96f)
