...
val publishArtifactId = "icons-bootstrap-cmp"
...
android {
    namespace = "com.composables.icons.bootstrap"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Bootstrap")
        description.set("Compose Icons Bootstrap for Compose Multiplatform.")
        url.set(projectUrl)
