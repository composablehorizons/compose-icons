...
val publishArtifactId = "icons-material-symbols-sharp-filled-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Symbols sharp-filled Android")
        description.set("Compose Icons Material Symbols sharp-filled for Android.")
        url.set(projectUrl)
