...
val publishArtifactId = "icons-heroicons-micro-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesHeroicons micro"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.heroicons.micro"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Heroicons micro")
        description.set("Compose Icons Heroicons micro for Compose Multiplatform.")
        url.set(projectUrl)
