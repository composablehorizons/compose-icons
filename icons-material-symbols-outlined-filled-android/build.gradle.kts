...
android {
    namespace = "com.composables.icons.materialsymbols.outlinedfilled"
    compileSdk = 36
    defaultConfig {
...
val publishArtifactId = "icons-material-symbols-outlined-filled-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Symbols outlined-filled Android")
        description.set("Compose Icons Material Symbols outlined-filled for Android.")
        url.set(projectUrl)
