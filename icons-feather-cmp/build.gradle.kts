...
val publishArtifactId = "icons-feather-cmp"
...
android {
    namespace = "com.composables.icons.feather"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Feather")
        description.set("Compose Icons Feather for Compose Multiplatform.")
        url.set(projectUrl)
