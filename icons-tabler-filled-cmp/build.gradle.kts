...
val publishArtifactId = "icons-tabler-filled-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesTabler filled"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.tabler.filled"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Tabler filled")
        description.set("Compose Icons Tabler filled for Compose Multiplatform.")
        url.set(projectUrl)
