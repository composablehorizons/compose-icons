...
val Tabler.Filled.Diamond: ImageVector
    get() {
        ...
        _Diamond = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(-8.886f, 3.943f)
                arcToRelative(1f, 1f, 0f, false, false, -1.371f, 0.343f)
                lineToRelative(-0.6f, 1f)
                lineToRelative(-0.06f, 0.116f)
                arcToRelative(1f, 1f, 0f, false, false, 0.177f, 1.07f)
                lineToRelative(2f, 2.2f)
                lineToRelative(0.09f, 0.088f)
                arcToRelative(1f, 1f, 0f, false, false, 1.323f, -0.02f)
                lineToRelative(0.087f, -0.09f)
                arcToRelative(1f, 1f, 0f, false, false, -0.02f, -1.323f)
                lineToRelative(-1.501f, -1.65f)
                lineToRelative(0.218f, -0.363f)
                lineToRelative(0.055f, -0.103f)
                arcToRelative(1f, 1f, 0f, false, false, -0.398f, -1.268f)
                close()
            }
        }.build()
