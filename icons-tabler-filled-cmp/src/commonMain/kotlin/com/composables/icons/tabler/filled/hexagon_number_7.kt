...
val Tabler.Filled.HexagonNumber7: ImageVector
    get() {
        ...
        _HexagonNumber7 = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(3.33f, 3.33f, 0f, false, true, 3.216f, 0f)
                ...
                arcToRelative(3.223f, 3.223f, 0f, false, true, 1.284f, 2.39f)
                ...
                arcToRelative(3.226f, 3.226f, 0f, false, true, -1.678f, -2.826f)
                verticalLineToRelative(-7.285f)
                arcToRelative(3.21f, 3.21f, 0f, false, true, 1.65f, -2.808f)
                close()
                moveToRelative(3.575f, 5.586f)
                ...
                arcToRelative(1f, 1f, 0f, false, false, 1.927f, 0.482f)
                lineToRelative(0.035f, -0.111f)
                lineToRelative(2f, -8f)
                lineToRelative(0.021f, -0.112f)
                arcToRelative(1f, 1f, 0f, false, false, -0.878f, -1.125f)
