...
val Tabler.Filled.FileSad: ImageVector
    get() {
        ...
        _FileSad = ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(0.176f, -0.005f)
                close()
                moveToRelative(2.571f, 15.18f)
                arcToRelative(4.5f, 4.5f, 0f, false, false, -5.142f, 0f)
                arcToRelative(1f, 1f, 0f, true, false, 1.142f, 1.64f)
                arcToRelative(2.5f, 2.5f, 0f, false, true, 2.858f, 0f)
                arcToRelative(1f, 1f, 0f, false, false, 1.142f, -1.64f)
