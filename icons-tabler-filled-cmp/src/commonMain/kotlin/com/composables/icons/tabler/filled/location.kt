...
val Tabler.Filled.Location: ImageVector
    get() {
        ...
        _Location = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(1.55f, 1.55f, 0f, false, true, -1.409f, 0.903f)
                arcToRelative(1.547f, 1.547f, 0f, false, true, -1.329f, -0.747f)
                lineToRelative(-0.065f, -0.127f)
                lineToRelative(-3.352f, -6.702f)
                lineToRelative(-6.67f, -3.336f)
                arcToRelative(1.55f, 1.55f, 0f, false, true, -0.898f, -1.259f)
