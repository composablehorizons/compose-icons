...
val Tabler.Filled.ReceiptRupee: ImageVector
    get() {
        ...
        _ReceiptRupee = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(1f, 1f, 0f, false, true, -0.034f, -0.108f)
                ...
                arcToRelative(2f, 2f, 0f, false, true, -1.732f, 0.999f)
                horizontalLineToRelative(-1f)
                ...
                arcToRelative(4.01f, 4.01f, 0f, false, false, 2.538f, -2.77f)
                lineToRelative(1.126f, -0.001f)
                arcToRelative(1f, 1f, 0f, false, false, 0f, -2f)
                horizontalLineToRelative(-1.126f)
                arcToRelative(4f, 4f, 0f, false, false, -0.33f, -0.855f)
