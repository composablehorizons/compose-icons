...
val Tabler.Filled.BellRinging: ImageVector
    get() {
        ...
        _BellRinging = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(1f, 1f, 0f, false, true, 1.41f, -0.099f)
                arcToRelative(12.05f, 12.05f, 0f, false, true, 3.048f, 4.064f)
                arcToRelative(1f, 1f, 0f, true, true, -1.818f, 0.836f)
                arcToRelative(10.05f, 10.05f, 0f, false, false, -2.54f, -3.39f)
                arcToRelative(1f, 1f, 0f, false, true, -0.1f, -1.41f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
                ...
                arcToRelative(1f, 1f, 0f, false, true, 1.312f, 1.51f)
                arcToRelative(10.05f, 10.05f, 0f, false, false, -2.54f, 3.39f)
                arcToRelative(1f, 1f, 0f, true, true, -1.817f, -0.835f)
                arcToRelative(12.05f, 12.05f, 0f, false, true, 3.045f, -4.065f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
                ...
                arcToRelative(3.992f, 3.992f, 0f, false, true, -2.98f, 1.332f)
                arcToRelative(3.992f, 3.992f, 0f, false, true, -2.98f, -1.332f)
            ...
            path(
                ...
                arcToRelative(3f, 3f, 0f, false, false, 1.472f, -2.063f)
                lineToRelative(0.021f, -0.143f)
                lineToRelative(0.001f, -2.97f)
                arcToRelative(8f, 8f, 0f, false, true, 3.821f, -6.454f)
                lineToRelative(0.248f, -0.146f)
                lineToRelative(0.01f, -0.043f)
                arcToRelative(3.003f, 3.003f, 0f, false, true, 2.562f, -2.29f)
