...
val Tabler.Filled.Blade: ImageVector
    get() {
        ...
        _Blade = ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(0.586f, -0.585f)
                arcToRelative(2f, 2f, 0f, false, true, 2.7f, -0.117f)
                ...
                arcToRelative(2f, 2f, 0f, false, true, -0.117f, -2.7f)
                lineToRelative(0.117f, -0.129f)
                close()
                moveToRelative(3.027f, 4.21f)
                ...
                arcToRelative(2.003f, 2.003f, 0f, false, false, 2.449f, -2.45f)
                lineToRelative(1.067f, -1.068f)
                lineToRelative(0.293f, 0.292f)
                lineToRelative(0.094f, 0.083f)
                arcToRelative(1f, 1f, 0f, false, false, 1.32f, -1.497f)
