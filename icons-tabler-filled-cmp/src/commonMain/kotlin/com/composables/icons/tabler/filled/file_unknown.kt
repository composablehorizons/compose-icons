...
val Tabler.Filled.FileUnknown: ImageVector
    get() {
        ...
        _FileUnknown = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(2.5f, 2.5f, 0f, false, false, -3.037f, 0.604f)
                arcToRelative(1f, 1f, 0f, false, false, 1.434f, 1.389f)
                ...
                arcToRelative(2.5f, 2.5f, 0f, false, false, 1.137f, -4.727f)
            }
            path(
                fill = SolidColor(Color(0xFF000000))
            ) {
