...
val publishArtifactId = "icons-material-icons-outlined-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Icons Outlined Android")
        description.set("Compose Icons Material Icons Outlined for Android.")
        url.set(projectUrl)
