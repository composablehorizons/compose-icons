...
val publishArtifactId = "icons-font-awesome-solid-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Font Awesome Solid Android")
        description.set("Compose Icons Font Awesome Solid for Android.")
        url.set(projectUrl)
