...
val MaterialSymbols.Outlined.Face_3: ImageVector
    get() {
        ...
        _Face_3 = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-68f, 8f, -125f, 43f)
                reflectiveQuadToRelative(-95f, 89f)
                quadToRelative(18f, 12f, 38f, 19f)
                reflectiveQuadToRelative(42f, 7f)
                close()
                moveToRelative(360f, 0f)
                quadToRelative(22f, 0f, 42f, -6.5f)
                reflectiveQuadToRelative(38f, -19.5f)
                quadToRelative(-38f, -54f, -94.5f, -89f)
                ...
                close()
                moveToRelative(392f, -80f)
                quadToRelative(-125f, 0f, -225f, -69.5f)
                reflectiveQuadTo(110f, 552f)
                lineTo(88f, 800f)
                horizontalLineToRelative(784f)
                lineToRelative(-22f, -248f)
                quadToRelative(-45f, 109f, -144.5f, 178.5f)
