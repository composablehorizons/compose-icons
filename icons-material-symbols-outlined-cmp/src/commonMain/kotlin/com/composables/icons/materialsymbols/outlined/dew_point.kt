...
val MaterialSymbols.Outlined.Dew_point: ImageVector
    get() {
        ...
        _Dew_point = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(0f, -17f, 9.5f, -34.5f)
                reflectiveQuadToRelative(20.5f, -32f)
                quadToRelative(11f, -14.5f, 20.5f, -24f)
                lineToRelative(9.5f, -9.5f)
                lineToRelative(9.5f, 9.5f)
                quadToRelative(9.5f, 9.5f, 20.5f, 24f)
                reflectiveQuadToRelative(20.5f, 32f)
                quadTo(680f, 363f, 680f, 380f)
