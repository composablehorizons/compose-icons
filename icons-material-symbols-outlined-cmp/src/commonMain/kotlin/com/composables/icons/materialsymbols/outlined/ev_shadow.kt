...
val MaterialSymbols.Outlined.Ev_shadow: ImageVector
    get() {
        ...
        _Ev_shadow = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(200f, 480f)
                quadToRelative(0f, 83f, 44.5f, 152f)
                reflectiveQuadTo(365f, 735f)
                quadToRelative(-42f, -51f, -63.5f, -120f)
                reflectiveQuadTo(280f, 468f)
                quadToRelative(0f, -66f, 16f, -125f)
                reflectiveQuadToRelative(46f, -107f)
                quadToRelative(-66f, 38f, -104f, 103f)
                reflectiveQuadToRelative(-38f, 141f)
                close()
                moveToRelative(348f, 272f)
