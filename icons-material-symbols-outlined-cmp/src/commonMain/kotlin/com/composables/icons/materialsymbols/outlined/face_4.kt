...
val MaterialSymbols.Outlined.Face_4: ImageVector
    get() {
        ...
        _Face_4 = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(-54f, -635f)
                quadToRelative(42f, 70f, 114f, 112.5f)
                reflectiveQuadTo(700f, 400f)
                quadToRelative(14f, 0f, 27f, -1.5f)
                ...
                close()
                moveTo(177f, 459f)
                quadToRelative(51f, -29f, 89f, -75f)
                reflectiveQuadToRelative(57f, -103f)
                quadToRelative(-51f, 29f, -89f, 75f)
                reflectiveQuadToRelative(-57f, 103f)
                close()
                moveToRelative(249f, -214f)
                close()
                moveToRelative(-103f, 36f)
                close()
                moveToRelative(-196f, 92f)
                quadToRelative(28f, -53f, 70.5f, -95.5f)
                reflectiveQuadTo(293f, 207f)
                quadToRelative(-17f, -21f, -41f, -34f)
                reflectiveQuadToRelative(-53f, -13f)
                quadToRelative(-50f, 0f, -84.5f, 34.5f)
                reflectiveQuadTo(80f, 279f)
                quadToRelative(0f, 29f, 13f, 53f)
                reflectiveQuadToRelative(34f, 41f)
                close()
                moveTo(480f, 960f)
