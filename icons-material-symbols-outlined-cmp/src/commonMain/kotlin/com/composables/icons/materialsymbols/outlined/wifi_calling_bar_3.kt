...
val MaterialSymbols.Outlined.Wifi_calling_bar_3: ImageVector
    get() {
        ...
        _Wifi_calling_bar_3 = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(660f, 239f)
                quadToRelative(40f, 0f, 76.5f, 15.5f)
                reflectiveQuadTo(802f, 299f)
                lineToRelative(-42f, 42f)
                quadToRelative(-20f, -20f, -45.5f, -31f)
                reflectiveQuadTo(660f, 299f)
                quadToRelative(-29f, 0f, -54.5f, 11f)
                reflectiveQuadTo(560f, 341f)
                close()
                moveToRelative(-84f, -86f)
                lineToRelative(-42f, -42f)
                quadToRelative(45f, -45f, 103.5f, -69.5f)
                reflectiveQuadTo(660f, 119f)
                quadToRelative(64f, 0f, 122.5f, 24.5f)
                reflectiveQuadTo(886f, 213f)
                lineToRelative(-42f, 42f)
                quadToRelative(-37f, -37f, -84.5f, -56.5f)
                reflectiveQuadTo(660f, 179f)
                quadToRelative(-52f, 0f, -99f, 20f)
                reflectiveQuadToRelative(-85f, 56f)
                close()
                moveToRelative(322f, 585f)
