...
val MaterialSymbols.Outlined.Dentistry: ImageVector
    get() {
        ...
        _Dentistry = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-23f, 0f, -40.5f, 9.5f)
                reflectiveQuadTo(601f, 195f)
                quadToRelative(-21f, 11f, -49f, 20.5f)
                reflectiveQuadToRelative(-72f, 9.5f)
                quadToRelative(-44f, 0f, -72f, -9.5f)
                reflectiveQuadTo(359f, 195f)
                quadToRelative(-21f, -11f, -38.5f, -20.5f)
                reflectiveQuadTo(280f, 165f)
                quadToRelative(-33f, 0f, -56.5f, 23.5f)
                reflectiveQuadTo(200f, 245f)
                quadToRelative(0f, 8f, 1f, 23f)
                reflectiveQuadToRelative(4f, 35f)
                lineToRelative(55f, 405f)
                quadToRelative(1f, 8f, 7f, 12.5f)
                reflectiveQuadToRelative(14f, 4.5f)
                quadToRelative(5f, 0f, 9f, -2f)
                reflectiveQuadToRelative(6f, -6f)
                lineToRelative(101f, -148f)
                quadToRelative(14f, -20f, 36f, -32f)
                reflectiveQuadToRelative(47f, -12f)
                quadToRelative(25f, 0f, 47f, 12f)
                reflectiveQuadToRelative(36f, 32f)
                lineToRelative(103f, 151f)
                quadToRelative(2f, 3f, 5f, 4.5f)
                reflectiveQuadToRelative(7f, 1.5f)
                quadToRelative(8f, 0f, 14.5f, -4.5f)
                reflectiveQuadTo(700f, 709f)
                lineToRelative(55f, -406f)
                quadToRelative(3f, -20f, 4f, -35f)
                reflectiveQuadToRelative(1f, -23f)
                quadToRelative(0f, -33f, -23.5f, -56.5f)
                reflectiveQuadTo(680f, 165f)
                close()
                moveTo(480f, 445f)
                close()
            }
