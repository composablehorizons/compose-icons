...
val MaterialSymbols.Outlined.Handheld_controller: ImageVector
    get() {
        ...
        _Handheld_controller = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(47f, -240f)
                horizontalLineTo(120f)
                quadToRelative(0f, 66f, 47f, 113f)
                reflectiveQuadToRelative(113f, 47f)
                horizontalLineToRelative(193f)
                lineToRelative(262f, 262f)
                quadToRelative(18f, 18f, 43.5f, 18f)
                reflectiveQuadToRelative(43.5f, -18f)
                quadToRelative(18f, -18f, 18f, -43.5f)
                reflectiveQuadTo(822f, 655f)
                lineTo(487f, 320f)
                close()
