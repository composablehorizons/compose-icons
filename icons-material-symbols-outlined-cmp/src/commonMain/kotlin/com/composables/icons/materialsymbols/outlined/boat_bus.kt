...
val MaterialSymbols.Outlined.Boat_bus: ImageVector
    get() {
        ...
        _Boat_bus = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(341f, 756f)
                quadToRelative(17f, 8f, 31f, 15f)
                reflectiveQuadToRelative(28f, 13f)
                verticalLineToRelative(84f)
                quadToRelative(-14f, -5f, -29f, -10.5f)
                ...
                close()
                moveToRelative(97f, -362f)
                close()
                moveToRelative(-58f, -314f)
                ...
                verticalLineToRelative(84f)
                quadToRelative(-18f, -2f, -37.5f, -3f)
                reflectiveQuadToRelative(-42.5f, -1f)
                verticalLineToRelative(-80f)
                horizontalLineTo(280f)
                verticalLineToRelative(113f)
                lineToRelative(200f, -53f)
                lineToRelative(101f, 27f)
                quadToRelative(-37f, 6f, -75f, 20.5f)
                reflectiveQuadTo(438f, 394f)
                lineToRelative(-236f, 62f)
                lineToRelative(46f, 149f)
                quadToRelative(11f, -10f, 22.5f, -19.5f)
                reflectiveQuadTo(293f, 565f)
                lineToRelative(41f, -42f)
                quadToRelative(17f, 19f, 33f, 37.5f)
                reflectiveQuadToRelative(33f, 36.5f)
                verticalLineToRelative(99f)
                quadToRelative(-31f, -18f, -50.5f, -37f)
                lineTo(330f, 640f)
