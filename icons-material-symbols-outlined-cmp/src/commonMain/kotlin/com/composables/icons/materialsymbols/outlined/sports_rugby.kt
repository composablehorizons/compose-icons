...
val MaterialSymbols.Outlined.Sports_rugby: ImageVector
    get() {
        ...
        _Sports_rugby = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-33f, 72f, -79.5f, 140.5f)
                reflectiveQuadTo(594f, 594f)
                quadToRelative(-57f, 57f, -125.5f, 104f)
                reflectiveQuadTo(328f, 778f)
                close()
                moveToRelative(-100f, -46f)
                quadToRelative(80f, -27f, 163f, -80f)
                reflectiveQuadToRelative(145f, -116f)
                quadToRelative(66f, -65f, 119f, -148f)
                reflectiveQuadToRelative(77f, -160f)
                quadToRelative(-80f, 27f, -163f, 80f)
                reflectiveQuadTo(424f, 424f)
                quadToRelative(-66f, 65f, -119f, 148f)
                reflectiveQuadToRelative(-77f, 160f)
                close()
                moveToRelative(252f, -252f)
                close()
            }
        }.build()
