...
val MaterialSymbols.Outlined.Settings_cinematic_blur: ImageVector
    get() {
        if (_Settings_cinematic_blur != null) return _Settings_cinematic_blur!!
        
        _Settings_cinematic_blur = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(440f, 614f)
                quadToRelative(-43f, -14f, -70.5f, -50f)
                ...
                reflectiveQuadTo(541f, 486f)
                verticalLineToRelative(-7f)
                quadToRelative(0f, -25f, -17f, -42f)
                reflectiveQuadToRelative(-42f, -17f)
                quadToRelative(-25f, 0f, -42.5f, 17.5f)
                reflectiveQuadTo(422f, 480f)
                quadToRelative(0f, 21f, 12.5f, 36.5f)
                reflectiveQuadTo(467f, 537f)
                quadToRelative(-12f, 17f, -19f, 36f)
                reflectiveQuadToRelative(-8f, 41f)
                close()
                moveToRelative(42f, -134f)
                close()
                moveTo(370f, 880f)
                ...
                verticalLineToRelative(140f)
                close()
                moveToRelative(-98f, -340f)
                close()
            }
        }.build()
        
        return _Settings_cinematic_blur!!
    }

private var _Settings_cinematic_blur: ImageVector? = null
