...
val MaterialSymbols.Outlined.Percent_discount: ImageVector
    get() {
        ...
        _Percent_discount = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(508f, 788f)
                quadToRelative(41f, -41f, 77f, -55.5f)
                reflectiveQuadToRelative(93f, -14.5f)
                quadToRelative(17f, 0f, 28.5f, -11.5f)
                reflectiveQuadTo(718f, 678f)
                quadToRelative(0f, -58f, 14.5f, -93.5f)
                reflectiveQuadTo(788f, 508f)
                quadToRelative(12f, -12f, 12f, -28f)
                reflectiveQuadToRelative(-12f, -28f)
                quadToRelative(-41f, -41f, -55.5f, -77f)
                reflectiveQuadTo(718f, 282f)
                quadToRelative(0f, -17f, -11.5f, -28.5f)
                reflectiveQuadTo(678f, 242f)
                quadToRelative(-58f, 0f, -93.5f, -14.5f)
                reflectiveQuadTo(508f, 172f)
                quadToRelative(-5f, -5f, -12.5f, -8.5f)
                reflectiveQuadTo(480f, 160f)
                quadToRelative(-8f, 0f, -15.5f, 3.5f)
                reflectiveQuadTo(452f, 172f)
                quadToRelative(-41f, 41f, -77f, 55.5f)
                reflectiveQuadTo(282f, 242f)
                quadToRelative(-17f, 0f, -28.5f, 11.5f)
                reflectiveQuadTo(242f, 282f)
                quadToRelative(0f, 58f, -14.5f, 93.5f)
                reflectiveQuadTo(172f, 452f)
                quadToRelative(-12f, 12f, -12f, 28f)
                reflectiveQuadToRelative(12f, 28f)
                quadToRelative(41f, 41f, 55.5f, 77f)
                reflectiveQuadToRelative(14.5f, 93f)
                quadToRelative(0f, 17f, 11.5f, 28.5f)
                reflectiveQuadTo(282f, 718f)
                quadToRelative(58f, 0f, 93.5f, 14.5f)
                reflectiveQuadTo(452f, 788f)
                quadToRelative(5f, 5f, 12.5f, 8.5f)
