...
val MaterialSymbols.Outlined.Subway_walk: ImageVector
    get() {
        ...
        _Subway_walk = ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(-1f, 82f)
                quadToRelative(-34f, -10f, -79.5f, -14f)
                reflectiveQuadTo(360f, 160f)
                quadToRelative(-86f, 0f, -142.5f, 10f)
                reflectiveQuadTo(137f, 200f)
                horizontalLineToRelative(369f)
                lineToRelative(-186f, 80f)
