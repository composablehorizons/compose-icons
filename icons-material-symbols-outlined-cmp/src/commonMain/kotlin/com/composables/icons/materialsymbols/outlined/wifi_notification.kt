...
val MaterialSymbols.Outlined.Wifi_notification: ImageVector
    get() {
        ...
        _Wifi_notification = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-26f, 8f, -51.5f, 17.5f)
                reflectiveQuadTo(522f, 246f)
                ...
                close()
                moveToRelative(330f, -300f)
                close()
                moveToRelative(20f, -44f)
