...
val MaterialSymbols.Outlined.Workspaces_outline: ImageVector
    get() {
        ...
        _Workspaces_outline = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(12f, 9f)
                quadTo(12.825f, 9f, 13.413f, 8.412f)
                quadTo(14f, 7.825f, 14f, 7f)
                quadTo(14f, 6.175f, 13.413f, 5.588f)
                quadTo(12.825f, 5f, 12f, 5f)
                quadTo(11.175f, 5f, 10.588f, 5.588f)
                quadTo(10f, 6.175f, 10f, 7f)
                quadTo(10f, 7.825f, 10.588f, 8.412f)
                quadTo(11.175f, 9f, 12f, 9f)
                close()
                moveTo(6f, 19f)
                quadTo(6.825f, 19f, 7.412f, 18.413f)
                quadTo(8f, 17.825f, 8f, 17f)
                quadTo(8f, 16.175f, 7.412f, 15.588f)
                quadTo(6.825f, 15f, 6f, 15f)
                quadTo(5.175f, 15f, 4.588f, 15.588f)
                quadTo(4f, 16.175f, 4f, 17f)
                quadTo(4f, 17.825f, 4.588f, 18.413f)
                quadTo(5.175f, 19f, 6f, 19f)
                close()
                moveTo(18f, 19f)
                quadTo(18.825f, 19f, 19.413f, 18.413f)
                quadTo(20f, 17.825f, 20f, 17f)
                quadTo(20f, 16.175f, 19.413f, 15.588f)
                quadTo(18.825f, 15f, 18f, 15f)
                quadTo(17.175f, 15f, 16.587f, 15.588f)
                quadTo(16f, 16.175f, 16f, 17f)
                quadTo(16f, 17.825f, 16.587f, 18.413f)
