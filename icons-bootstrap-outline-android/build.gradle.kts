...
val publishArtifactId = "icons-bootstrap-outline-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Bootstrap Outline Android")
        description.set("Compose Icons Bootstrap Outline for Android.")
        url.set(projectUrl)
