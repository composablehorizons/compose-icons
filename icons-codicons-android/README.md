# Codicons icons for Android

An Android icon library with all available Codicons icons as XML drawables.
...
```kotlin
dependencies {
    implementation("com.composables:icons-codicons-android:1.0.0")
}
```
