...
val publishArtifactId = "icons-material-icons-filled-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Icons Filled Android")
        description.set("Compose Icons Material Icons Filled for Android.")
        url.set(projectUrl)
