...
val FontAwesome.Regular.ThumbsUp: ImageVector
    get() {
        ...
        _ThumbsUp = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(475.04f, 271.84f, 480f, 256f, 480f, 236.85f)
                curveToRelative(0f, -44.015f, -37.218f, -85.58f, -85.82f, -85.58f)
                horizontalLineTo(357.7f)
                curveToRelative(4.92f, -12.81f, 8.85f, -28.13f, 8.85f, -46.54f)
                curveTo(366.55f, 31.936f, 328.86f, 0f, 271.28f, 0f)
                curveToRelative(-61.607f, 0f, -58.093f, 94.933f, -71.76f, 108.6f)
                ...
                curveToRelative(14.893f, 0f, 27.408f, -10.174f, 30.978f, -23.95f)
                curveToRelative(44.509f, 1.001f, 75.06f, 39.94f, 177.802f, 39.94f)
                curveToRelative(7.22f, 0f, 15.22f, 0.01f, 22.22f, 0.01f)
                curveToRelative(77.117f, 0f, 111.986f, -39.423f, 112.94f, -95.33f)
                curveToRelative(13.319f, -18.425f, 20.299f, -43.122f, 17.34f, -66.99f)
                curveToRelative(9.854f, -18.452f, 13.664f, -40.343f, 8.99f, -62.99f)
                close()
                moveToRelative(-61.75f, 53.83f)
                ...
                curveToRelative(-71.639f, 0f, -118.029f, -37.82f, -171.64f, -37.82f)
                verticalLineTo(240f)
                horizontalLineToRelative(10.92f)
                curveToRelative(28.36f, 0f, 67.98f, -70.89f, 94.54f, -97.46f)
                curveToRelative(28.36f, -28.36f, 18.91f, -75.63f, 37.82f, -94.54f)
                curveToRelative(47.27f, 0f, 47.27f, 32.98f, 47.27f, 56.73f)
                curveToRelative(0f, 39.17f, -28.36f, 56.72f, -28.36f, 94.54f)
                horizontalLineToRelative(103.99f)
                curveToRelative(21.11f, 0f, 37.73f, 18.91f, 37.82f, 37.82f)
