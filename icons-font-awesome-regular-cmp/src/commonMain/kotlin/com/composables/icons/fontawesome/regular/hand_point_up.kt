...
val FontAwesome.Regular.HandPointUp: ImageVector
    get() {
        ...
        _HandPointUp = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(115.52f, 115.52f, 0f, false, false, -22.4f, -2.176f)
                curveToRelative(-47.914f, 0f, -83.2f, 35.072f, -83.2f, 92f)
                curveToRelative(0f, 45.314f, 48.537f, 57.002f, 78.784f, 75.707f)
                curveToRelative(12.413f, 7.735f, 23.317f, 16.994f, 33.253f, 25.851f)
                lineToRelative(0.146f, 0.131f)
                lineToRelative(0.148f, 0.129f)
                curveTo(129.807f, 376.338f, 136f, 384.236f, 136f, 391.2f)
                ...
                curveToRelative(15.906f, 0f, 28.8f, -14.327f, 28.8f, -32f)
                verticalLineToRelative(-64f)
                curveToRelative(0f, -8.584f, -3.048f, -16.373f, -8f, -22.12f)
                verticalLineTo(391.2f)
                curveToRelative(0f, -28.688f, 40f, -67.137f, 40f, -127.2f)
                verticalLineToRelative(-21.299f)
                curveToRelative(0f, -62.542f, -38.658f, -98.8f, -91.145f, -99.94f)
                curveToRelative(-17.813f, -12.482f, -40.785f, -18.491f, -62.791f, -15.985f)
                arcTo(93.148f, 93.148f, 0f, false, false, 272f, 118.847f)
                verticalLineTo(83.2f)
                curveTo(272f, 37.765f, 234.416f, 0f, 188.8f, 0f)
                curveToRelative(-45.099f, 0f, -83.2f, 38.101f, -83.2f, 83.2f)
                close()
                moveToRelative(118.4f, 0f)
                ...
                verticalLineTo(264f)
                curveToRelative(0f, 45.491f, -35.913f, 77.21f, -39.676f, 120f)
                horizontalLineTo(183.571f)
                ...
                curveTo(80.712f, 279.645f, 48f, 267.994f, 48f, 259.2f)
                curveToRelative(0f, -23.375f, 8.8f, -44f, 35.2f, -44f)
                curveToRelative(35.2f, 0f, 53.075f, 26.4f, 70.4f, 26.4f)
                verticalLineTo(83.2f)
                curveToRelative(0f, -18.425f, 16.5f, -35.2f, 35.2f, -35.2f)
                curveToRelative(18.975f, 0f, 35.2f, 16.225f, 35.2f, 35.2f)
                close()
                moveTo(352f, 424f)
