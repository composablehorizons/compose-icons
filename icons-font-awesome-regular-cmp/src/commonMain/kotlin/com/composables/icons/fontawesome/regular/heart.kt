...
val FontAwesome.Regular.Heart: ImageVector
    get() {
        ...
        _Heart = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(458.4f, 64.3f)
                curveTo(400.6f, 15.7f, 311.3f, 23f, 256f, 79.3f)
                curveTo(200.7f, 23f, 111.4f, 15.6f, 53.6f, 64.3f)
                curveTo(-21.6f, 127.6f, -10.6f, 230.8f, 43f, 285.5f)
                lineToRelative(175.4f, 178.7f)
                curveToRelative(10f, 10.2f, 23.4f, 15.9f, 37.6f, 15.9f)
                curveToRelative(14.3f, 0f, 27.6f, -5.6f, 37.6f, -15.8f)
                lineTo(469f, 285.6f)
                curveToRelative(53.5f, -54.7f, 64.7f, -157.9f, -10.6f, -221.3f)
                close()
                moveToRelative(-23.6f, 187.5f)
                lineTo(259.4f, 430.5f)
                curveToRelative(-2.4f, 2.4f, -4.4f, 2.4f, -6.8f, 0f)
                lineTo(77.2f, 251.8f)
                curveToRelative(-36.5f, -37.2f, -43.9f, -107.6f, 7.3f, -150.7f)
                curveToRelative(38.9f, -32.7f, 98.9f, -27.8f, 136.5f, 10.5f)
                lineToRelative(35f, 35.7f)
                lineToRelative(35f, -35.7f)
