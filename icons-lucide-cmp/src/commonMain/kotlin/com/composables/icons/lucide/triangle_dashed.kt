...
val Lucide.TriangleDashed: ImageVector
    get() {
        ...
        _TriangleDashed = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(2f, 2f, 0f, false, true, 3.666f, 0.013f)
            }
            path(
                fill = SolidColor(Color.Transparent),
                stroke = SolidColor(Color(0xFF000000)),
