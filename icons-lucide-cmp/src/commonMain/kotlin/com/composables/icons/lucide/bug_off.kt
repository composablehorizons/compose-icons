    ...
    get() {
        ...
        _BugOff = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(15f, 7.13f)
                verticalLineTo(6f)
                arcToRelative(3f, 3f, 0f, false, false, -5.14f, -2.1f)
                lineTo(8f, 2f)
            }
            path(
                fill = SolidColor(Color.Transparent),
            ...
            path(
                ...
                moveTo(7.7f, 7.7f)
                arcTo(4f, 4f, 0f, false, false, 6f, 11f)
                verticalLineToRelative(3f)
                arcToRelative(6f, 6f, 0f, false, false, 11.13f, 3.13f)
            }
        }.build()
