...
val Bootstrap.Fill.Badge3d: ImageVector
    get() {
        ...
        _Badge3d = ImageVector.Builder(
            ...
            path(
                ...
                horizontalLineToRelative(0.844f)
                curveToRelative(1.116f, 0f, 1.621f, -0.667f, 1.621f, -2.02f)
                curveToRelative(0f, -1.354f, -0.51f, -2.04f, -1.621f, -2.04f)
            }
            path(
                fill = SolidColor(Color(0xFF000000))
            ) {
