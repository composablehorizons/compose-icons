...
val publishArtifactId = "icons-bootstrap-fill-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesBootstrap fill"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.bootstrap.fill"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Bootstrap fill")
        description.set("Compose Icons Bootstrap fill for Compose Multiplatform.")
        url.set(projectUrl)
