...
android {
    namespace = "com.composables.icons.tabler.outline"
    compileSdk = 36
    defaultConfig {
...
val publishArtifactId = "icons-tabler-outline-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Tabler Outline Android")
        description.set("Compose Icons Tabler Outline for Android.")
        url.set(projectUrl)
