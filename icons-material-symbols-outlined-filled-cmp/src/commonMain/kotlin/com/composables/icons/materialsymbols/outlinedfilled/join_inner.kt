...
val MaterialSymbols.OutlinedFilled.Join_inner: ImageVector
    get() {
        ...
        _Join_inner = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadTo(362f, 284f)
                quadToRelative(-10f, -2f, -20.5f, -3f)
                reflectiveQuadToRelative(-21.5f, -1f)
                quadToRelative(-83f, 0f, -141.5f, 58.5f)
                reflectiveQuadTo(120f, 480f)
                quadToRelative(0f, 83f, 58.5f, 141.5f)
                reflectiveQuadTo(320f, 680f)
                quadToRelative(11f, 0f, 21.5f, -1f)
                reflectiveQuadToRelative(20.5f, -3f)
                quadToRelative(13f, 18f, 28f, 34.5f)
                reflectiveQuadToRelative(32f, 30.5f)
