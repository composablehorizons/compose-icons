...
val MaterialSymbols.OutlinedFilled.Nest_mini: ImageVector
    get() {
        if (_Nest_mini != null) return _Nest_mini!!
        
        _Nest_mini = ImageVector.Builder(
            name = "nest_mini",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            ...
            path(
                ...
                quadToRelative(0f, -138f, 91.5f, -240.5f)
                reflectiveQuadTo(440f, 162f)
                ...
                verticalLineToRelative(122f)
                quadToRelative(137f, 15f, 228.5f, 117.5f)
...
private var _Nest_mini: ImageVector? = null
