...
val MaterialSymbols.OutlinedFilled.Water_lock: ImageVector
    get() {
        ...
        _Water_lock = ImageVector.Builder(
            ...
            path(
                ...
                reflectiveQuadToRelative(-58f, 141f)
                quadToRelative(0f, 33f, 10f, 64f)
                reflectiveQuadToRelative(31f, 57f)
