...
val MaterialSymbols.OutlinedFilled.Graph_4: ImageVector
    get() {
        if (_Graph_4 != null) return _Graph_4!!
        
        _Graph_4 = ImageVector.Builder(
            name = "graph_4",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            ...
            path(
                ...
                lineTo(303f, 558f)
                quadToRelative(8f, 14f, 12.5f, 29.5f)
                ...
                lineToRelative(172f, -208f)
                quadToRelative(-24f, -17f, -38.5f, -42.5f)
                ...
                reflectiveQuadTo(547f, 299f)
                lineToRelative(172f, 208f)
                quadToRelative(10f, -4f, 20f, -5.5f)
                ...
                quadToRelative(-50f, 0f, -85f, -35f)
                reflectiveQuadToRelative(-35f, -85f)
                quadToRelative(0f, -17f, 4.5f, -32.5f)
                reflectiveQuadTo(657f, 558f)
                lineTo(520f, 392f)
                ...
                reflectiveQuadTo(522f, 760f)
                quadToRelative(0f, -17f, -11.5f, -28.5f)
                reflectiveQuadTo(482f, 720f)
                quadToRelative(-17f, 0f, -28.5f, 11.5f)
                reflectiveQuadTo(442f, 760f)
                quadToRelative(0f, 17f, 11.5f, 28.5f)
...
private var _Graph_4: ImageVector? = null
