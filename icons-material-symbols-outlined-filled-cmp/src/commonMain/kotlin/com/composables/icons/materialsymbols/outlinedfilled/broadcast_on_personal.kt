...
val MaterialSymbols.OutlinedFilled.Broadcast_on_personal: ImageVector
    get() {
        ...
        _Broadcast_on_personal = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(-90f, 35f, -147f, 115f)
                reflectiveQuadToRelative(-57f, 183f)
                quadToRelative(0f, 57f, 18f, 106f)
