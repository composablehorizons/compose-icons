...
val MaterialSymbols.OutlinedFilled.Apps_outage: ImageVector
    get() {
        ...
        _Apps_outage = ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(0f, -35f, 24.5f, -57.5f)
                reflectiveQuadTo(483f, 160f)
                quadToRelative(-2f, 10f, -2.5f, 19.5f)
                reflectiveQuadTo(480f, 200f)
                quadToRelative(0f, 31f, 6.5f, 60.5f)
                reflectiveQuadTo(505f, 316f)
                ...
                quadToRelative(0f, -7f, 1f, -13f)
                reflectiveQuadToRelative(3f, -12f)
                quadToRelative(26f, 12f, 55.5f, 18.5f)
                reflectiveQuadTo(760f, 480f)
                quadToRelative(11f, 0f, 20.5f, -0.5f)
                reflectiveQuadTo(800f, 477f)
                quadToRelative(0f, 34f, -22.5f, 58.5f)
