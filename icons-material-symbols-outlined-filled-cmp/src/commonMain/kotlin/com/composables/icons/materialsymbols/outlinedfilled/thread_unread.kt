...
val MaterialSymbols.OutlinedFilled.Thread_unread: ImageVector
    get() {
        if (_Thread_unread != null) return _Thread_unread!!
        
        _Thread_unread = ImageVector.Builder(
            name = "thread_unread",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
        ...
        return _Thread_unread!!
    }

private var _Thread_unread: ImageVector? = null
