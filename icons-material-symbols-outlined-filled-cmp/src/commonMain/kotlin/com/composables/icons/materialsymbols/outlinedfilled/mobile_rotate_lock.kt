...
val MaterialSymbols.OutlinedFilled.Mobile_rotate_lock: ImageVector
    get() {
        ...
        _Mobile_rotate_lock = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(122.97f, 374f)
                lineTo(182.03f, 464f)
                quadTo(171f, 453f, 165.5f, 438.5f)
                quadTo(160f, 424f, 160f, 410f)
                quadToRelative(0f, -15f, 5.5f, -29f)
                reflectiveQuadToRelative(16.54f, -25.06f)
                lineToRelative(173.61f, -173.88f)
                quadTo(366.69f, 171f, 381.25f, 165f)
                quadToRelative(14.55f, -6f, 28.6f, -6f)
                quadToRelative(15.05f, 0f, 29.1f, 6f)
                reflectiveQuadToRelative(25.08f, 17.03f)
                lineToRelative(313.94f, 313.74f)
                quadTo(789f, 506.8f, 795f, 520.82996f)
                quadToRelative(6f, 14.03f, 6f, 29.07f)
                quadToRelative(0f, 14.03f, -6f, 28.57f)
                quadTo(789f, 593f, 777.96f, 604f)
                lineTo(604.35f, 778f)
                quadToRelative(-11.04f, 11f, -25.09f, 16.5f)
                reflectiveQuadToRelative(-29.11f, 5.5f)
                quadToRelative(-14.05f, 0f, -28.6f, -5.5f)
                reflectiveQuadTo(495.97f, 778f)
                close()
            }
        }.build()
