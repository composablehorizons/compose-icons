...
android {
    namespace = "com.composables.icons.fontawesome.regular"
    compileSdk = 36
    defaultConfig {
...
val publishArtifactId = "icons-font-awesome-regular-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Font Awesome Regular Android")
        description.set("Compose Icons Font Awesome Regular for Android.")
        url.set(projectUrl)
