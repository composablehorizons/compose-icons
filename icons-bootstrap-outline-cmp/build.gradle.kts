...
val publishArtifactId = "icons-bootstrap-outline-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesBootstrap outline"
            isStatic = true
        }
    }
    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                api(project(":icons-bootstrap-cmp"))
            }
        }
    }
}
...
android {
    namespace = "com.composables.icons.bootstrap.outline"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Bootstrap outline")
        description.set("Compose Icons Bootstrap outline for Compose Multiplatform.")
        url.set(projectUrl)
