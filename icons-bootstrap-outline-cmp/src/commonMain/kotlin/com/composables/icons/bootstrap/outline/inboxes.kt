...
val Bootstrap.Outline.Inboxes: ImageVector
    get() {
        ...
        _Inboxes = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(0.941f, 0.83f)
                lineToRelative(0.32f, 2.562f)
                arcToRelative(0.5f, 0.5f, 0f, false, false, 0.497f, 0.438f)
                horizontalLineToRelative(12.234f)
                arcToRelative(0.5f, 0.5f, 0f, false, false, 0.496f, -0.438f)
                lineToRelative(0.32f, -2.562f)
                horizontalLineTo(10.45f)
