...
val Bootstrap.Outline.Diagram2: ImageVector
    get() {
        if (_Diagram2 != null) return _Diagram2!!
        ...
        _Diagram2 = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(3f, 11.5f)
                arcTo(1.5f, 1.5f, 0f, false, true, 4.5f, 10f)
                horizontalLineToRelative(1f)
                arcTo(1.5f, 1.5f, 0f, false, true, 7f, 11.5f)
                verticalLineToRelative(1f)
                arcTo(1.5f, 1.5f, 0f, false, true, 5.5f, 14f)
                horizontalLineToRelative(-1f)
                arcTo(1.5f, 1.5f, 0f, false, true, 3f, 12.5f)
                close()
                ...
                arcToRelative(1.5f, 1.5f, 0f, false, true, -1.5f, 1.5f)
                horizontalLineToRelative(-1f)
                arcTo(1.5f, 1.5f, 0f, false, true, 9f, 12.5f)
                close()
                moveToRelative(1.5f, -0.5f)
                arcToRelative(0.5f, 0.5f, 0f, false, false, -0.5f, 0.5f)
                verticalLineToRelative(1f)
