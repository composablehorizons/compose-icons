...
val Bootstrap.Outline.ChevronBarContract: ImageVector
    get() {
        if (_ChevronBarContract != null) return _ChevronBarContract!!
        
        _ChevronBarContract = ImageVector.Builder(
