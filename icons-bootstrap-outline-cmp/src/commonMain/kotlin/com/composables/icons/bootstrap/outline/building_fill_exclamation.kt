...
val Bootstrap.Outline.BuildingFillExclamation: ImageVector
    get() {
        if (_BuildingFillExclamation != null) return _BuildingFillExclamation!!
        
        _BuildingFillExclamation = ImageVector.Builder(
