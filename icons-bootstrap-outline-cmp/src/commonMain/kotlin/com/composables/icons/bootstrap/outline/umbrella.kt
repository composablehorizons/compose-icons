...
val Bootstrap.Outline.Umbrella: ImageVector
    get() {
        ...
        _Umbrella = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(4.1f, 4.1f, 0f, false, true, 3f, 6.5f)
                curveToRelative(0.806f, 0f, 1.48f, 0.25f, 1.962f, 0.511f)
                arcToRelative(9.7f, 9.7f, 0f, false, true, 0.344f, -2.358f)
                curveToRelative(0.242f, -0.868f, 0.64f, -1.765f, 1.271f, -2.53f)
                moveToRelative(-0.615f, 4.93f)
                arcTo(4.16f, 4.16f, 0f, false, true, 8f, 6.5f)
                arcToRelative(4.16f, 4.16f, 0f, false, true, 2.038f, 0.553f)
                arcToRelative(8.7f, 8.7f, 0f, false, false, -0.307f, -2.13f)
                curveTo(9.434f, 3.858f, 8.898f, 2.83f, 8f, 2.117f)
                curveToRelative(-0.898f, 0.712f, -1.434f, 1.74f, -1.731f, 2.804f)
                arcToRelative(8.7f, 8.7f, 0f, false, false, -0.307f, 2.131f)
                close()
                ...
                arcTo(4.14f, 4.14f, 0f, false, true, 13f, 6.5f)
