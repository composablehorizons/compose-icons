...
val Bootstrap.Outline.SendArrowUp: ImageVector
    get() {
        if (_SendArrowUp != null) return _SendArrowUp!!
        
        _SendArrowUp = ImageVector.Builder(
            name = "send-arrow-up",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 16f,
            ...
            path(
                ...
                lineToRelative(-2.8f, 7f)
                arcToRelative(0.5f, 0.5f, 0f, true, true, -0.928f, -0.372f)
                lineToRelative(1.895f, -4.738f)
                lineToRelative(-7.494f, 7.494f)
                lineToRelative(1.376f, 2.162f)
                arcToRelative(0.5f, 0.5f, 0f, true, true, -0.844f, 0.537f)
            ...
            path(
                ...
                arcToRelative(0.5f, 0.5f, 0f, false, false, -0.722f, 0.016f)
                lineToRelative(-1.149f, 1.25f)
                arcToRelative(0.5f, 0.5f, 0f, true, false, 0.737f, 0.676f)
