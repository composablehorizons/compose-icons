...
val Bootstrap.Outline.DatabaseGear: ImageVector
    get() {
        if (_DatabaseGear != null) return _DatabaseGear!!
        
        _DatabaseGear = ImageVector.Builder(
            name = "database-gear",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 16f,
        ...
        return _DatabaseGear!!
    }

private var _DatabaseGear: ImageVector? = null
