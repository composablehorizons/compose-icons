...
val Bootstrap.Outline.Mailbox2Flag: ImageVector
    get() {
        if (_Mailbox2Flag != null) return _Mailbox2Flag!!
        
        _Mailbox2Flag = ImageVector.Builder(
            name = "mailbox2-flag",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 16f,
            ...
            path(
                ...
                curveTo(4.836f, 7.264f, 5f, 7.334f, 5f, 7f)
                arcToRelative(1f, 1f, 0f, false, false, -2f, 0f)
                curveToRelative(0f, 0.334f, 0.164f, 0.264f, 0.415f, 0.157f)
                curveTo(3.58f, 7.087f, 3.782f, 7f, 4f, 7f)
