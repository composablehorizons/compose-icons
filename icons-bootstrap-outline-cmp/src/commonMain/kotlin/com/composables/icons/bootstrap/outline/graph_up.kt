...
val Bootstrap.Outline.GraphUp: ImageVector
    get() {
        if (_GraphUp != null) return _GraphUp!!
        ...
        _GraphUp = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(0.5f, 0.5f, 0f, false, true, 0.07f, 0.704f)
                ...
                arcToRelative(0.5f, 0.5f, 0f, false, true, 0.704f, -0.07f)
            }
        }.build()
