...
val publishArtifactId = "icons-material-icons-rounded-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesMaterial Icons rounded"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.materialicons.rounded"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Icons rounded")
        description.set("Compose Icons Material Icons rounded for Compose Multiplatform.")
        url.set(projectUrl)
