...
val MaterialIcons.Rounded.Help_outline: ImageVector
    get() {
        if (_Help_outline != null) return _Help_outline!!
        ...
        _Help_outline = ImageVector.Builder(
            ...
            path(
                ...
                horizontalLineToRelative(2f)
                curveToRelative(0f, -0.42f, 0.11f, -0.77f, 0.28f, -1.07f)
