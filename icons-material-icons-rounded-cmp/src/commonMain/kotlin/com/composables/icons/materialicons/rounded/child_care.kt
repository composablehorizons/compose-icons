...
val MaterialIcons.Rounded.Child_care: ImageVector
    get() {
        ...
        _Child_care = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(-0.19f, 0f, -0.32f, 0.2f, -0.23f, 0.37f)
                curveTo(8.5f, 15.94f, 10.13f, 17f, 12f, 17f)
                reflectiveCurveToRelative(3.5f, -1.06f, 4.33f, -2.63f)
                curveToRelative(0.08f, -0.17f, -0.05f, -0.37f, -0.23f, -0.37f)
                close()
                moveToRelative(6.84f, -2.66f)
