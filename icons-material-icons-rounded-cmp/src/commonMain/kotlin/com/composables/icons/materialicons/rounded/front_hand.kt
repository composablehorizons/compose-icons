...
val MaterialIcons.Rounded.Front_hand: ImageVector
    get() {
        ...
        _Front_hand = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(-1.51f, 0f, -2.77f, 1.12f, -2.97f, 2.58f)
                curveTo(15f, 17.82f, 14.78f, 18f, 14.54f, 18f)
                ...
                curveToRelative(0f, 0.28f, -0.22f, 0.5f, -0.5f, 0.5f)
                reflectiveCurveTo(14f, 10.78f, 14f, 10.5f)
                ...
                curveTo(8f, 11.78f, 7.78f, 12f, 7.5f, 12f)
                reflectiveCurveTo(7f, 11.78f, 7f, 11.5f)
