...
val MaterialIcons.Rounded.Downhill_skiing: ImageVector
    get() {
        ...
        _Downhill_skiing = ImageVector.Builder(
            ...
            path(
                ...
                lineTo(7.55f, 10.4f)
                curveTo(6.65f, 9.46f, 6.87f, 7.93f, 8f, 7.28f)
