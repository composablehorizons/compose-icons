...
val MaterialIcons.Rounded.Hearing: ImageVector
    get() {
        ...
        _Hearing = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(17f, 20f)
                curveToRelative(-0.29f, 0f, -0.56f, -0.06f, -0.76f, -0.15f)
                curveToRelative(-0.71f, -0.37f, -1.21f, -0.88f, -1.71f, -2.38f)
                curveToRelative(-0.51f, -1.56f, -1.47f, -2.29f, -2.39f, -3f)
                curveToRelative(-0.79f, -0.61f, -1.61f, -1.24f, -2.32f, -2.53f)
                curveTo(9.29f, 10.98f, 9f, 9.93f, 9f, 9f)
                curveToRelative(0f, -2.8f, 2.2f, -5f, 5f, -5f)
                curveToRelative(2.56f, 0f, 4.63f, 1.85f, 4.95f, 4.31f)
                curveToRelative(0.06f, 0.4f, 0.41f, 0.69f, 0.82f, 0.69f)
                horizontalLineToRelative(0.34f)
                curveToRelative(0.5f, 0f, 0.89f, -0.44f, 0.83f, -0.94f)
                curveTo(20.49f, 4.59f, 17.61f, 2f, 14f, 2f)
                ...
                curveTo(5.77f, 13.16f, 5f, 11.17f, 5f, 9f)
