...
val MaterialIcons.Rounded.Rotate_right: ImageVector
    get() {
        ...
        _Rotate_right = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(0f, 3.64f, 2.43f, 6.71f, 5.77f, 7.68f)
                curveToRelative(0.62f, 0.18f, 1.23f, -0.32f, 1.23f, -0.96f)
                verticalLineToRelative(-0.03f)
                curveToRelative(0f, -0.43f, -0.27f, -0.82f, -0.68f, -0.94f)
                curveTo(7.82f, 17.03f, 6f, 14.73f, 6f, 12f)
                curveToRelative(0f, -2.97f, 2.16f, -5.43f, 5f, -5.91f)
                verticalLineToRelative(1.53f)
                curveToRelative(0f, 0.89f, 1.07f, 1.33f, 1.7f, 0.71f)
                lineToRelative(2.13f, -2.08f)
                curveToRelative(0.4f, -0.38f, 0.4f, -1.02f, 0f, -1.42f)
                close()
                moveToRelative(4.84f, 4.93f)
                ...
                curveToRelative(0.65f, 0f, 1.15f, -0.62f, 0.96f, -1.24f)
                close()
                moveTo(13f, 18.68f)
                verticalLineToRelative(0.02f)
                curveToRelative(0f, 0.65f, 0.62f, 1.14f, 1.24f, 0.96f)
                ...
                horizontalLineToRelative(-0.02f)
                curveToRelative(-0.44f, 0f, -0.82f, 0.28f, -0.94f, 0.7f)
