...
val MaterialIcons.Rounded.Swipe_vertical: ImageVector
    get() {
        ...
        _Swipe_vertical = ImageVector.Builder(
            ...
            group {
                path(
                    ...
                    moveTo(0f, 12f)
                    curveToRelative(0f, 3.22f, 1.13f, 6.18f, 3.02f, 8.5f)
                    horizontalLineTo(1.75f)
                    curveTo(1.34f, 20.5f, 1f, 20.84f, 1f, 21.25f)
                    reflectiveCurveTo(1.34f, 22f, 1.75f, 22f)
                    horizontalLineTo(5f)
                    curveToRelative(0.55f, 0f, 1f, -0.45f, 1f, -1f)
                    verticalLineToRelative(-3.25f)
                    curveTo(6f, 17.34f, 5.66f, 17f, 5.25f, 17f)
                    curveToRelative(-0.41f, 0f, -0.75f, 0.34f, -0.75f, 0.75f)
                    verticalLineToRelative(2.16f)
                    curveToRelative(-1.86f, -2.11f, -3f, -4.88f, -3f, -7.91f)
                    reflectiveCurveToRelative(1.14f, -5.79f, 3f, -7.91f)
                    verticalLineToRelative(2.16f)
                    curveTo(4.5f, 6.66f, 4.84f, 7f, 5.25f, 7f)
                    curveTo(5.66f, 7f, 6f, 6.66f, 6f, 6.25f)
                    verticalLineTo(3f)
                    curveToRelative(0f, -0.55f, -0.45f, -1f, -1f, -1f)
                    horizontalLineTo(1.75f)
                    curveTo(1.34f, 2f, 1f, 2.34f, 1f, 2.75f)
