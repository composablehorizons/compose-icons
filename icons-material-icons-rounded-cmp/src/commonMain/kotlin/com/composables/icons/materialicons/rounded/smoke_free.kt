...
val MaterialIcons.Rounded.Smoke_free: ImageVector
    get() {
        ...
        _Smoke_free = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(1.96f, -12.15f)
                horizontalLineTo(19f)
                horizontalLineToRelative(-0.04f)
                close()
                moveToRelative(-0.11f, 2.38f)
                ...
                reflectiveCurveTo(2.67f, 16f, 3.5f, 16f)
