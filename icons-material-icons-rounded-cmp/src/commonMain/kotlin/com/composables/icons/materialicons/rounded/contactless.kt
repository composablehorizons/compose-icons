...
val MaterialIcons.Rounded.Contactless: ImageVector
    get() {
        ...
        _Contactless = ImageVector.Builder(
            ...
            group {
                path(
                    ...
                    curveTo(9f, 12.53f, 8.92f, 13.11f, 8.75f, 13.68f)
                    close()
                    ...
                    curveToRelative(0f, -0.96f, -0.18f, -1.89f, -0.53f, -2.78f)
                    ...
                    curveToRelative(0f, -1.31f, -0.3f, -2.65f, -0.88f, -4.01f)
                    curveToRelative(-0.16f, -0.36f, 0.01f, -0.78f, 0.36f, -0.95f)
                    curveTo(14.37f, 6.82f, 14.83f, 7f, 15f, 7.4f)
                    curveToRelative(0.66f, 1.54f, 1f, 3.08f, 1f, 4.58f)
                    curveTo(16f, 13.48f, 15.66f, 15.04f, 15f, 16.6f)
                    close()
                }
            }
        }.build()
