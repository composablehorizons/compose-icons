...
val MaterialIcons.Rounded.Tsunami: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        curveTo(5.55f, 17.8f, 5.13f, 17.78f, 4.81f, 18f)
                        curveToRelative(-0.91f, 0.61f, -1.53f, 0.85f, -2f, 0.94f)
                        curveTo(2.34f, 19.03f, 2f, 19.44f, 2f, 19.91f)
                        verticalLineToRelative(0f)
                        curveToRelative(0f, 0.6f, 0.54f, 1.09f, 1.13f, 0.98f)
                        curveToRelative(0.77f, -0.14f, 1.51f, -0.42f, 2.2f, -0.83f)
                        curveToRelative(2.04f, 1.21f, 4.63f, 1.21f, 6.67f, 0f)
                        ...
                        curveToRelative(0f, -0.47f, -0.33f, -0.88f, -0.8f, -0.97f)
                    ...
                    path(
                        ...
                        curveToRelative(-1.86f, 0f, -3.4f, -1.5f, -3.39f, -3.36f)
                        curveToRelative(0f, -0.37f, 0.06f, -0.7f, 0.16f, -1.05f)
                        curveTo(16.53f, 4.3f, 15.6f, 3.03f, 14.27f, 3f)
                        curveTo(14.18f, 3f, 14.09f, 3f, 14f, 3f)
                        ...
                        verticalLineToRelative(-0.01f)
                        curveToRelative(0f, -0.46f, -0.32f, -0.88f, -0.78f, -0.97f)
