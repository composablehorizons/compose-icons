...
val MaterialIcons.Rounded.`7k_plus`: ImageVector
    get() {
        ...
        _7k_plus = ImageVector.Builder(
            ...
            group {
                path(
                    ...
                    curveToRelative(-0.5f, 0f, -0.86f, -0.49f, -0.72f, -0.97f)
                    lineToRelative(1.08f, -3.53f)
                    horizontalLineTo(6.25f)
                    curveToRelative(-0.41f, 0f, -0.75f, -0.34f, -0.75f, -0.75f)
                    verticalLineToRelative(0f)
                    curveTo(5.5f, 9.34f, 5.83f, 9f, 6.25f, 9f)
                    horizontalLineTo(9f)
                    curveToRelative(0.67f, 0f, 1.15f, 0.65f, 0.96f, 1.29f)
                    lineToRelative(-1.3f, 4.18f)
                    curveTo(8.56f, 14.79f, 8.27f, 15f, 7.95f, 15f)
                    close()
                    moveTo(14.59f, 15f)
                    lineTo(14.59f, 15f)
