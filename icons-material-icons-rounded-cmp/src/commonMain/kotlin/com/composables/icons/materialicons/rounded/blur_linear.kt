...
val MaterialIcons.Rounded.Blur_linear: ImageVector
    get() {
        ...
        _Blur_linear = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(5f, 9.5f)
                curveToRelative(0.83f, 0f, 1.5f, -0.67f, 1.5f, -1.5f)
                reflectiveCurveTo(5.83f, 6.5f, 5f, 6.5f)
                reflectiveCurveTo(3.5f, 7.17f, 3.5f, 8f)
                reflectiveCurveTo(4.17f, 9.5f, 5f, 9.5f)
                close()
                moveToRelative(0f, 4f)
                curveToRelative(0.83f, 0f, 1.5f, -0.67f, 1.5f, -1.5f)
                reflectiveCurveToRelative(-0.67f, -1.5f, -1.5f, -1.5f)
