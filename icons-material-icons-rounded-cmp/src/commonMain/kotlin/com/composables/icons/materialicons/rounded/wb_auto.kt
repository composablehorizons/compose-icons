...
val MaterialIcons.Rounded.Wb_auto: ImageVector
    get() {
        ...
        _Wb_auto = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(22.72f, 7f)
                curveToRelative(-0.42f, 0f, -0.77f, 0.3f, -0.85f, 0.7f)
                ...
                curveTo(6.87f, 7.38f, 7.4f, 7f, 8f, 7f)
