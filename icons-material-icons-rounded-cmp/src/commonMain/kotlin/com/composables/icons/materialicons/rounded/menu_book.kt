...
val MaterialIcons.Rounded.Menu_book: ImageVector
    get() {
        ...
        _Menu_book = ImageVector.Builder(
            ...
            group {
                path(
                    ...
                    lineToRelative(0f, 11.28f)
                    curveToRelative(0f, 1.3f, 1.22f, 2.26f, 2.48f, 1.94f)
                    curveTo(4.46f, 20.11f, 5.5f, 20f, 6.5f, 20f)
                ...
                path(
                    ...
                    curveToRelative(-0.32f, 0f, -0.61f, -0.2f, -0.71f, -0.52f)
