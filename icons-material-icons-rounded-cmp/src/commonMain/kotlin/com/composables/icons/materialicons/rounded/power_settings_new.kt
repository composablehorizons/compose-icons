...
val MaterialIcons.Rounded.Power_settings_new: ImageVector
    get() {
        ...
        _Power_settings_new = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(0f, -0.55f, -0.45f, -1f, -1f, -1f)
                close()
                moveToRelative(5.14f, 2.86f)
                curveToRelative(-0.39f, 0.39f, -0.38f, 1f, -0.01f, 1.39f)
                curveToRelative(1.13f, 1.2f, 1.83f, 2.8f, 1.87f, 4.57f)
                curveToRelative(0.09f, 3.83f, -3.08f, 7.13f, -6.91f, 7.17f)
                curveTo(8.18f, 19.05f, 5f, 15.9f, 5f, 12f)
                curveToRelative(0f, -1.84f, 0.71f, -3.51f, 1.87f, -4.76f)
                curveToRelative(0.37f, -0.39f, 0.37f, -1f, -0.01f, -1.38f)
                curveToRelative(-0.4f, -0.4f, -1.05f, -0.39f, -1.43f, 0.02f)
                curveTo(3.98f, 7.42f, 3.07f, 9.47f, 3f, 11.74f)
                curveToRelative(-0.14f, 4.88f, 3.83f, 9.1f, 8.71f, 9.25f)
                curveToRelative(5.1f, 0.16f, 9.29f, -3.93f, 9.29f, -9f)
                curveToRelative(0f, -2.37f, -0.92f, -4.51f, -2.42f, -6.11f)
