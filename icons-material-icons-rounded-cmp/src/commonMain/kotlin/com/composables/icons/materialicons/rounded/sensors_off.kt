...
val MaterialIcons.Rounded.Sensors_off: ImageVector
    get() {
        ...
        _Sensors_off = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(2.82f, 16.53f, 2f, 14.36f, 2f, 12f)
                ...
                curveToRelative(0f, 1.89f, 0.66f, 3.63f, 1.76f, 5f)
                ...
                curveToRelative(0f, -2.36f, -0.82f, -4.53f, -2.18f, -6.24f)
