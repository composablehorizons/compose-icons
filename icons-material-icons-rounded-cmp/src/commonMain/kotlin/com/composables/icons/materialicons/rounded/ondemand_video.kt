...
val MaterialIcons.Rounded.Ondemand_video: ImageVector
    get() {
        ...
        _Ondemand_video = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(0f, 0.55f, -0.45f, 1f, -1f, 1f)
                close()
                moveToRelative(-5.52f, -5.13f)
                lineToRelative(-3.98f, 2.28f)
                curveToRelative(-0.67f, 0.38f, -1.5f, -0.11f, -1.5f, -0.87f)
                verticalLineTo(8.72f)
                curveToRelative(0f, -0.77f, 0.83f, -1.25f, 1.5f, -0.87f)
                lineToRelative(3.98f, 2.28f)
                curveToRelative(0.67f, 0.39f, 0.67f, 1.35f, 0f, 1.74f)
                close()
            }
        }.build()
