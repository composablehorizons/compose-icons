...
val MaterialIcons.Rounded.Thermostat_auto: ImageVector
    get() {
        ...
        _Thermostat_auto = ImageVector.Builder(
            ...
            group {
                path(
                    ...
                    moveTo(17.81f, 4f)
                    lineTo(17.81f, 4f)
                    curveToRelative(-0.48f, 0f, -0.92f, 0.3f, -1.09f, 0.75f)
                    lineTo(14f, 12.02f)
                    curveTo(13.82f, 12.49f, 14.17f, 13f, 14.67f, 13f)
                    horizontalLineToRelative(0f)
                    curveToRelative(0.31f, 0f, 0.58f, -0.19f, 0.68f, -0.48f)
                    lineTo(16f, 10.7f)
                    horizontalLineToRelative(3.63f)
                    lineToRelative(0.64f, 1.82f)
                    curveToRelative(0.1f, 0.29f, 0.38f, 0.48f, 0.68f, 0.48f)
                    lineToRelative(0f, 0f)
                    curveToRelative(0.51f, 0f, 0.86f, -0.51f, 0.68f, -0.98f)
                    lineTo(18.9f, 4.75f)
                    curveTo(18.73f, 4.3f, 18.3f, 4f, 17.81f, 4f)
                    close()
                    moveTo(16.47f, 9.39f)
