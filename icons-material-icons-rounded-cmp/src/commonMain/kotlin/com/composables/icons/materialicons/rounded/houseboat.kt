...
val MaterialIcons.Rounded.Houseboat: ImageVector
    get() {
        ...
        _Houseboat = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(20.62f, 16.62f, 20.21f, 16f, 18.67f, 16f)
                curveToRelative(-1.91f, 0f, -2.14f, 1f, -3.33f, 1f)
                curveToRelative(-1.24f, 0f, -1.39f, -1f, -3.34f, -1f)
                reflectiveCurveToRelative(-2.1f, 1f, -3.34f, 1f)
                curveToRelative(-1.19f, 0f, -1.42f, -1f, -3.33f, -1f)
                curveToRelative(-1.54f, 0f, -1.95f, 0.62f, -2.66f, 0.88f)
                curveTo(2.27f, 17.03f, 2f, 17.4f, 2f, 17.83f)
                ...
                curveToRelative(1.91f, 0f, 2.14f, -1f, 3.33f, -1f)
                curveToRelative(0.83f, 0f, 1.21f, 0.49f, 2f, 0.78f)
                curveTo(21.31f, 19.02f, 22f, 18.52f, 22f, 17.83f)
                close()
                moveTo(18.91f, 9.81f)
                curveToRelative(0.33f, -0.45f, 0.23f, -1.07f, -0.22f, -1.4f)
                lineToRelative(-6.1f, -4.47f)
                curveToRelative(-0.35f, -0.26f, -0.83f, -0.26f, -1.18f, 0f)
                lineToRelative(-6.1f, 4.47f)
