...
val MaterialIcons.Rounded.Kayaking: ImageVector
    get() {
        ...
        _Kayaking = ImageVector.Builder(
            ...
            path(
                ...
                horizontalLineToRelative(0f)
                curveTo(2.45f, 23f, 2f, 22.55f, 2f, 22f)
                close()
                moveTo(12f, 5.5f)
                ...
                curveToRelative(-0.92f, -0.3f, -0.92f, -1.6f, 0f, -1.9f)
                ...
                curveToRelative(-0.58f, 0.31f, -1.28f, 0.31f, -1.86f, 0f)
