...
val MaterialIcons.Rounded.Yard: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        close()
                        moveTo(12f, 19f)
                        curveToRelative(-2.83f, 0f, -5.21f, -1.97f, -5.84f, -4.61f)
                        curveToRelative(-0.18f, -0.74f, 0.49f, -1.4f, 1.23f, -1.23f)
                        curveTo(10.03f, 13.79f, 12f, 16.17f, 12f, 19f)
                        curveToRelative(0f, -2.83f, 1.97f, -5.21f, 4.61f, -5.84f)
                        curveToRelative(0.74f, -0.18f, 1.4f, 0.49f, 1.23f, 1.23f)
                        curveTo(17.21f, 17.03f, 14.83f, 19f, 12f, 19f)
                        close()
                    }
                    path(
                        fill = SolidColor(Color(0xFF000000))
