...
val MaterialIcons.Rounded.Transfer_within_a_station: ImageVector
    get() {
        ...
        _Transfer_within_a_station = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(0f, -0.36f, -0.44f, -0.54f, -0.69f, -0.29f)
                ...
                lineTo(3.24f, 7.79f)
                curveTo(2.49f, 8.1f, 2f, 8.83f, 2f, 9.64f)
                verticalLineTo(12f)
                curveToRelative(0f, 0.55f, 0.45f, 1f, 1f, 1f)
                reflectiveCurveToRelative(1f, -0.45f, 1f, -1f)
