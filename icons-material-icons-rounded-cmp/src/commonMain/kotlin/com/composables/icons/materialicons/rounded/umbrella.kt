...
val MaterialIcons.Rounded.Umbrella: ImageVector
    get() {
        ...
        _Umbrella = ImageVector.Builder(
            ...
            group {
                ...
                path(
                    ...
                    curveToRelative(0.23f, 0f, 0.43f, 0.16f, 0.49f, 0.36f)
                    curveTo(14.1f, 3.7f, 14.49f, 4f, 14.94f, 4f)
                    curveToRelative(0.55f, 0f, 1f, -0.45f, 1f, -1f)
                    curveToRelative(0f, -0.1f, -0.02f, -0.2f, -0.05f, -0.3f)
                    curveTo(15.59f, 1.72f, 14.63f, 1f, 13.5f, 1f)
