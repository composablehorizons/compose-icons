...
val MaterialIcons.Rounded.Downloading: ImageVector
    get() {
            ...
            group {
                group {
                    path(
                        ...
                        curveTo(19.9f, 10.7f, 20.31f, 11f, 20.77f, 11f)
                        close()
                        moveTo(18.9f, 17.49f)
                        lineTo(18.9f, 17.49f)
                        ...
                        curveTo(13.3f, 19.9f, 13f, 20.31f, 13f, 20.77f)
                        close()
                        moveTo(13f, 12f)
                        verticalLineTo(8f)
                        ...
                        curveTo(5.33f, 20.75f, 2f, 16.77f, 2f, 12f)
                        reflectiveCurveToRelative(3.33f, -8.75f, 7.79f, -9.75f)
                        curveTo(10.41f, 2.11f, 11f, 2.59f, 11f, 3.23f)
                        verticalLineToRelative(0f)
                        curveToRelative(0f, 0.46f, -0.31f, 0.87f, -0.76f, 0.97f)
                        curveTo(6.67f, 5f, 4f, 8.19f, 4f, 12f)
                        reflectiveCurveToRelative(2.67f, 7f, 6.24f, 7.8f)
                        curveTo(10.69f, 19.9f, 11f, 20.31f, 11f, 20.77f)
                        close()
                    }
                }
            }
