...
val MaterialIcons.Rounded.Local_florist: ImageVector
    get() {
        ...
        _Local_florist = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(12f, 22f)
                curveToRelative(4.56f, 0f, 8.33f, -3.4f, 8.92f, -7.8f)
                ...
                reflectiveCurveToRelative(1.12f, -2.5f, 2.5f, -2.5f)
                close()
                moveToRelative(-8.92f, 8.7f)
                curveTo(3.67f, 18.6f, 7.44f, 22f, 12f, 22f)
                curveToRelative(0f, -4.56f, -3.4f, -8.33f, -7.8f, -8.92f)
