...
val publishArtifactId = "icons-font-awesome-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesFont Awesome"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.fontawesome"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Font Awesome")
        description.set("Compose Icons Font Awesome for Compose Multiplatform.")
        url.set(projectUrl)
