...
val publishArtifactId = "icons-material-icons-cmp"
...
kotlin {
    ...
    listOf(iosX64(), iosArm64(), iosSimulatorArm64()).forEach { iosTarget ->
        iosTarget.binaries.framework {
            baseName = "ComposablesMaterial Icons"
            isStatic = true
        }
    }
...
android {
    namespace = "com.composables.icons.materialicons"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Icons")
        description.set("Compose Icons Material Icons for Compose Multiplatform.")
        url.set(projectUrl)
