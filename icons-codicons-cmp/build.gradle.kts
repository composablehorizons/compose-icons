...
val publishArtifactId = "icons-codicons-cmp"
...
android {
    namespace = "com.composables.icons.codicons"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Codicons")
        description.set("Compose Icons Codicons for Compose Multiplatform.")
        url.set(projectUrl)
