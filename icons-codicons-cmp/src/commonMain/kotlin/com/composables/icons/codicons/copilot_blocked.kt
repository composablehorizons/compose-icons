...
val Codicons.CopilotBlocked: ImageVector
    get() {
        if (_CopilotBlocked != null) return _CopilotBlocked!!
        
        _CopilotBlocked = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(14f, 12f)
                lineTo(9.24996f, 12.067f)
                curveTo(8.97396f, 12.067f, 8.74996f, 11.843f, 8.74996f, 11.567f)
                curveTo(8.74996f, 11.291f, 8.97396f, 11.067f, 9.24996f, 11.067f)
                lineTo(14f, 11f)
        ...
        return _CopilotBlocked!!
    }

private var _CopilotBlocked: ImageVector? = null
