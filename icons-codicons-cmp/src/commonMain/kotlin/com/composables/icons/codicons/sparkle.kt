...
val Codicons.Sparkle: ImageVector
    get() {
        ...
        _Sparkle = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(4.00746f, 6.26448f)
                lineTo(3.15246f, 5.99948f)
                lineTo(4.01646f, 5.71848f)
                curveTo(4.41071f, 5.58184f, 4.76826f, 5.35637f, 5.06146f, 5.05948f)
                curveTo(5.35281f, 4.76039f, 5.57294f, 4.39943f, 5.70546f, 4.00348f)
                lineTo(5.97046f, 3.14448f)
                lineTo(6.25046f, 4.00648f)
                curveTo(6.38349f, 4.40638f, 6.60809f, 4.76969f, 6.90636f, 5.06744f)
                curveTo(7.20463f, 5.36519f, 7.56833f, 5.58915f, 7.96846f, 5.72148f)
                lineTo(8.84846f, 5.99048f)
                lineTo(7.98746f, 6.27048f)
                curveTo(7.58707f, 6.40272f, 7.22321f, 6.62691f, 6.92505f, 6.92507f)
                curveTo(6.62689f, 7.22324f, 6.4027f, 7.58709f, 6.27046f, 7.98748f)
                lineTo(6.00546f, 8.84448f)
                lineTo(5.72646f, 7.98548f)
                curveTo(5.63026f, 7.69329f, 5.48483f, 7.41968f, 5.29646f, 7.17648f)
                curveTo(5.22699f, 7.08766f, 5.15254f, 7.00286f, 5.07346f, 6.92248f)
                curveTo(4.7738f, 6.62366f, 4.4089f, 6.39842f, 4.00746f, 6.26448f)
                close()
                ...
                close()
                moveTo(9.62035f, 11.0585f)
                lineTo(9.44235f, 10.9995f)
                lineTo(9.62635f, 10.9355f)
                curveTo(9.92811f, 10.8305f, 10.2018f, 10.6578f, 10.4264f, 10.4305f)
                curveTo(10.6528f, 10.2015f, 10.8238f, 9.92374f, 10.9264f, 9.61848f)
                lineTo(10.9844f, 9.44048f)
                lineTo(11.0434f, 9.62148f)
                curveTo(11.1453f, 9.92819f, 11.3175f, 10.2069f, 11.5461f, 10.4353f)
                curveTo(11.7748f, 10.6638f, 12.0536f, 10.8357f, 12.3604f, 10.9375f)
                lineTo(12.5554f, 11.0005f)
                lineTo(12.3754f, 11.0595f)
                curveTo(12.068f, 11.1617f, 11.7888f, 11.3344f, 11.5601f, 11.5637f)
                curveTo(11.3314f, 11.7931f, 11.1596f, 12.0728f, 11.0584f, 12.3805f)
                lineTo(10.9994f, 12.5615f)
                lineTo(10.9414f, 12.3805f)
                curveTo(10.84f, 12.0721f, 10.6676f, 11.7919f, 10.4382f, 11.5623f)
                curveTo(10.2088f, 11.3326f, 9.92863f, 11.1601f, 9.62035f, 11.0585f)
                close()
            }
        }.build()
