...
val Codicons.Unlock: ImageVector
    get() {
        ...
        _Unlock = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(13f, 1f)
                curveTo(14.654f, 1f, 16f, 2.346f, 16f, 4f)
                verticalLineTo(4.5f)
                curveTo(16f, 4.776f, 15.776f, 5f, 15.5f, 5f)
                curveTo(15.224f, 5f, 15f, 4.776f, 15f, 4.5f)
                verticalLineTo(4f)
                curveTo(15f, 2.897f, 14.103f, 2f, 13f, 2f)
                curveTo(11.897f, 2f, 11f, 2.897f, 11f, 4f)
                verticalLineTo(6f)
                ...
                verticalLineTo(4f)
                curveTo(10f, 2.346f, 11.346f, 1f, 13f, 1f)
                close()
                moveTo(4f, 7f)
