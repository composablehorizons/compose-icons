...
val Codicons.SymbolEnum: ImageVector
    get() {
        if (_SymbolEnum != null) return _SymbolEnum!!
        
        _SymbolEnum = ImageVector.Builder(
            name = "symbol-enum",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 16f,
            ...
            path(
                ...
                curveTo(8f, 11.224f, 7.776f, 11f, 7.5f, 11f)
                close()
                moveTo(10f, 8.5f)
                ...
                close()
                moveTo(9f, 8.5f)
                curveTo(9f, 8.225f, 8.775f, 8f, 8.5f, 8f)
                horizontalLineTo(2.5f)
                curveTo(2.225f, 8f, 2f, 8.225f, 2f, 8.5f)
                verticalLineTo(12.5f)
                curveTo(2f, 12.775f, 2.225f, 13f, 2.5f, 13f)
                horizontalLineTo(8.5f)
                curveTo(8.775f, 13f, 9f, 12.775f, 9f, 12.5f)
                verticalLineTo(8.5f)
                close()
            }
        }.build()
...
private var _SymbolEnum: ImageVector? = null
