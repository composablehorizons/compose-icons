...
val Codicons.LayersDot: ImageVector
    get() {
        if (_LayersDot != null) return _LayersDot!!
        
        _LayersDot = ImageVector.Builder(
            name = "layers-dot",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 16f,
            ...
            path(
                ...
                moveTo(13f, 16f)
                curveTo(14.6569f, 16f, 16f, 14.6569f, 16f, 13f)
                curveTo(16f, 11.3431f, 14.6569f, 10f, 13f, 10f)
                curveTo(11.3431f, 10f, 10f, 11.3431f, 10f, 13f)
                curveTo(10f, 14.6569f, 11.3431f, 16f, 13f, 16f)
                close()
            }
        }.build()
...
private var _LayersDot: ImageVector? = null
