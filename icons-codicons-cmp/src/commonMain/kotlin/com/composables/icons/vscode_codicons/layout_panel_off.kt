...
val Codicons.LayoutPanelOff: ImageVector
    get() {
        if (_LayoutPanelOff != null) return _LayoutPanelOff!!
        
        _LayoutPanelOff = ImageVector.Builder(
            ...
            path(
                ...
                verticalLineTo(3.5f)
                curveTo(15f, 2.121f, 13.878f, 1f, 12.5f, 1f)
                close()
                moveTo(14f, 12.5f)
        ...
        return _LayoutPanelOff!!
    }

private var _LayoutPanelOff: ImageVector? = null
