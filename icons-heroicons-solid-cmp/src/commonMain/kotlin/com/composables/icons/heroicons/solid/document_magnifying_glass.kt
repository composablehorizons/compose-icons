...
val Heroicons.Solid.DocumentMagnifyingGlass: ImageVector
    get() {
        ...
        _DocumentMagnifyingGlass = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(1.875f, 1.875f, 0f, false, false, 0f, 3.75f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF000000))
