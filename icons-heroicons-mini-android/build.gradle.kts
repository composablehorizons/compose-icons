...
val publishArtifactId = "icons-heroicons-mini-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Heroicons Mini Android")
        description.set("Compose Icons Heroicons Mini for Android.")
        url.set(projectUrl)
