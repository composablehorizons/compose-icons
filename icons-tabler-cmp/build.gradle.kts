...
val publishArtifactId = "icons-tabler-cmp"
...
android {
    namespace = "com.composables.icons.tabler"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Tabler")
        description.set("Compose Icons Tabler for Compose Multiplatform.")
        url.set(projectUrl)
