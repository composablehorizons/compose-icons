...
val publishArtifactId = "icons-bootstrap-fill-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Bootstrap Fill Android")
        description.set("Compose Icons Bootstrap Fill for Android.")
        url.set(projectUrl)
