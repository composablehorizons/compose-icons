...
android {
    namespace = "com.composables.icons.heroicons.solid"
    compileSdk = 36
    defaultConfig {
...
val publishArtifactId = "icons-heroicons-solid-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Heroicons Solid Android")
        description.set("Compose Icons Heroicons Solid for Android.")
        url.set(projectUrl)
