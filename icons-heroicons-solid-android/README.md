# Heroicons solid icons for Android

An Android icon library with all available Heroicons solid icons as XML drawables.
...
```kotlin
dependencies {
    implementation("com.composables:icons-heroicons-solid-android:1.0.0")
}
```
