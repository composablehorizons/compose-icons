...
android {
    namespace = "com.composables.icons.materialsymbols.sharp"
    compileSdk = 36
    defaultConfig {
...
val publishArtifactId = "icons-material-symbols-sharp-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Symbols Sharp Android")
        description.set("Compose Icons Material Symbols Sharp for Android.")
        url.set(projectUrl)
