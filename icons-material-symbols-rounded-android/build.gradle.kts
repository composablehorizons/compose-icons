...
val publishArtifactId = "icons-material-symbols-rounded-android"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose Icons Material Symbols rounded Android")
        description.set("Compose Icons Material Symbols rounded for Android.")
        url.set(projectUrl)
